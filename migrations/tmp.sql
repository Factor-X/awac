CREATE INDEX idx_answer_value_comment on answer using btree(comment);
CREATE INDEX idx_answer_value_stringdata1 on answer using btree(stringdata1);
CREATE INDEX idx_answer_value_stringdata2 on answer using btree(stringdata2);
CREATE INDEX idx_answer_value_answertype on answer using btree(answertype);
CREATE INDEX idx_awaccalculator_code on awaccalculator using btree(code);
CREATE INDEX idx_code_label_codelist on code using btree(codelist);
CREATE INDEX idx_code_label_key on code using btree(key);
CREATE INDEX idx_code_label_topic on code using btree(topic);
...
CREATE INDEX idx_person_email on person using btree(email);
CREATE INDEX idx_person_firstname on person using btree(firstname);
CREATE INDEX idx_person_lastname on person using btree(lastname);
CREATE INDEX idx_person_default_language on person using btree(default_language);
...
CREATE INDEX idx_reducingactionadvice_baseindicator_baseindicatorkey on reducingactionadvice using btree(baseindicatorkey);
...
CREATE INDEX idx_unit_category_name on unit using btree(name);
CREATE INDEX idx_unit_category_ref on unit using btree(ref);
CREATE INDEX idx_unit_category_symbol on unit using btree(symbol);
...
CREATE INDEX idx_question_set_code on question using btree(code);
