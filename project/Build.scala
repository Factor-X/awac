...
object ApplicationBuild extends Build {
    ...
    val appDependencies = Seq(
        ...
        "org.springframework.security" % "spring-security-core" % "4.1.5.RELEASE",
        ...
        "org.jadira.usertype" % "usertype.core" % "4.0.0.GA" excludeAll ExclusionRule(organization = "org.hibernate"),
        "xalan" % "xalan" % "2.7.1",
