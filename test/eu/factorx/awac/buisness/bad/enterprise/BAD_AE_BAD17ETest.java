...
/*
 * Test for bad AE_BAD17E
*/
@Component
public class BAD_AE_BAD17ETest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD17E baseActivityDataAE_BAD17E;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD17E.getBaseActivityData(questionSetAnswers);
