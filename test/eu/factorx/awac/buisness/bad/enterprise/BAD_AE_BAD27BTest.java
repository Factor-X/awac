...
import eu.factorx.awac.service.knowledge.activity.contributor.enterprise.BaseActivityDataAE_BAD27B;
...
/*
 * Test for bad AE_BAD27B
*/
@Component
public class BAD_AE_BAD27BTest {
    ...
    @Autowired
    private BaseActivityDataAE_BAD27B baseActivityDataAE_BAD27B;
    ...
    public void test(long siteId) {
        ...
        //add answers
        answerLineDTOList.addAll(buildAnswerA210());
        answerLineDTOList.addAll(buildAnswerA211());
        answerLineDTOList.addAll(buildAnswerA212());
        answerLineDTOList.addAll(buildAnswerA220());
        answerLineDTOList.addAll(buildAnswerA221());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD27B.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
        mapResult.put(2600.0, false);
     ...
     * question : A210
     */
    private List<AnswerLineDTO> buildAnswerA210() {

        List<AnswerLineDTO> list = new ArrayList<>();

        //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
        mapRepetition1.put("A209", 1);
        list.add(new AnswerLineDTO("A210", "acier", identifier, mapRepetition1));
        //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
        mapRepetition2.put("A209", 2);
        list.add(new AnswerLineDTO("A210", "informatique", identifier, mapRepetition2));
     ...
     * question : A211
     */
    private List<AnswerLineDTO> buildAnswerA211() {
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
        mapRepetition1.put("A209", 1);
        list.add(new AnswerLineDTO("A211", "AT_61", identifier, mapRepetition1));
        //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
        mapRepetition2.put("A209", 2);
        list.add(new AnswerLineDTO("A211", "AT_68", identifier, mapRepetition2));
     ...
     * question : A212
     */
    private List<AnswerLineDTO> buildAnswerA212() {
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
        mapRepetition1.put("A209", 1);
        list.add(new AnswerLineDTO("A212", "AS_209", identifier, mapRepetition1));
     ...
     * question : A220
     */
    private List<AnswerLineDTO> buildAnswerA220() {
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
        mapRepetition1.put("A209", 1);
        list.add(new AnswerLineDTO("A220", 0.65, identifier, mapRepetition1));
     ...
     * question : A221
     */
    private List<AnswerLineDTO> buildAnswerA221() {
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
        mapRepetition1.put("A209", 1);
        list.add(new AnswerLineDTO("A221", 4000.0, identifier, mapRepetition1, UnitCode.U5135.getKey()));
