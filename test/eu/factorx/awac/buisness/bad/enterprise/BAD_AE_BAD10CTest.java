...
/*
 * Test for bad AE_BAD10C
*/
@Component
public class BAD_AE_BAD10CTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD10C baseActivityDataAE_BAD10C;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD10C.getBaseActivityData(questionSetAnswers);
