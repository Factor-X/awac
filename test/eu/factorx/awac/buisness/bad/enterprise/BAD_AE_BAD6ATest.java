...
import eu.factorx.awac.service.knowledge.activity.contributor.enterprise.BaseActivityDataAE_BAD6A;

/*
 * Test for bad AE_BAD6A
*/
@Component
public class BAD_AE_BAD6ATest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD6A baseActivityDataAE_BAD6A;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA23());
                answerLineDTOList.addAll(buildAnswerA49());
                answerLineDTOList.addAll(buildAnswerA48());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD6A.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(1.0, false);
     ...
     * question : A23
     */
    private List<AnswerLineDTO> buildAnswerA23(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A23",2500.0,  mapRepetition1  , UnitCode.U5156.getKey()  ));
     ...
     * question : A49
     */
    private List<AnswerLineDTO> buildAnswerA49(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A49",5000.0,  mapRepetition1  , UnitCode.U5147.getKey()  ));
     ...
     * question : A48
     */
    private List<AnswerLineDTO> buildAnswerA48(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A48","1",  mapRepetition1 ));
