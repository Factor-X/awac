...
/*
 * Test for bad AE_BAD11C
*/
@Component
public class BAD_AE_BAD11CTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD11C baseActivityDataAE_BAD11C;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD11C.getBaseActivityData(questionSetAnswers);
