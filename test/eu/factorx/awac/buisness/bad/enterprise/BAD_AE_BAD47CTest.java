...
/*
 * Test for bad AE_BAD47C
*/
@Component
public class BAD_AE_BAD47CTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD47C baseActivityDataAE_BAD47C;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD47C.getBaseActivityData(questionSetAnswers);
