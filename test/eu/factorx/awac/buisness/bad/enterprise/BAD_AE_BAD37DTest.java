...
/*
 * Test for bad AE_BAD37D
*/
@Component
public class BAD_AE_BAD37DTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD37D baseActivityDataAE_BAD37D;
    ...
    public void test(long siteId){
        ...
        //add answers
                ...
                answerLineDTOList.addAll(buildAnswerA1013());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD37D.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(1000000.0, false);
     ...
     * question : A1013
     */
    private List<AnswerLineDTO> buildAnswerA1013(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                ...
                list.add(new AnswerLineDTO("A1013","AS_5",  mapRepetition1 ));
