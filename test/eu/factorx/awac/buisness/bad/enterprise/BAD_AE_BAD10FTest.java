...
/*
 * Test for bad AE_BAD10F
*/
@Component
public class BAD_AE_BAD10FTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD10F baseActivityDataAE_BAD10F;
    ...
    public void test(long siteId){
        ...
        //add answers
                ...
                answerLineDTOList.addAll(buildAnswerA74());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD10F.getBaseActivityData(questionSetAnswers);
     ...
     * question : A74
     */
    private List<AnswerLineDTO> buildAnswerA74(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A67",2);
                list.add(new AnswerLineDTO("A74",12.0,  mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A67",5);
                list.add(new AnswerLineDTO("A74",12.0,  mapRepetition2 ));
