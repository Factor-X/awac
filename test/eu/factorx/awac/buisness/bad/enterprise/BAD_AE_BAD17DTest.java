...
/*
 * Test for bad AE_BAD17D
*/
@Component
public class BAD_AE_BAD17DTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD17D baseActivityDataAE_BAD17D;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD17D.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(504.0, false);
                mapResult.put(26.25, false);
    ...
    private List<AnswerLineDTO> buildAnswerA145(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                ...
                list.add(new AnswerLineDTO("A145",12.0,  mapRepetition1  , UnitCode.U5135.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A142",2);
                list.add(new AnswerLineDTO("A145",1500.0,  mapRepetition2  , UnitCode.U5133.getKey()  ));
    ...
    private List<AnswerLineDTO> buildAnswerA146(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A142",1);
                list.add(new AnswerLineDTO("A146",210.0,  mapRepetition1  , UnitCode.U5106.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A142",2);
                list.add(new AnswerLineDTO("A146",350.0,  mapRepetition2  , UnitCode.U5106.getKey()  ));
     ...
     * question : A150
     */
    private List<AnswerLineDTO> buildAnswerA150(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A142",1);
                list.add(new AnswerLineDTO("A150",0.2,  mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A142",2);
