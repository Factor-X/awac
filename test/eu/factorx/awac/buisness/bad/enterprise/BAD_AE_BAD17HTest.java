...
/*
 * Test for bad AE_BAD17H
*/
@Component
public class BAD_AE_BAD17HTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD17H baseActivityDataAE_BAD17H;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD17H.getBaseActivityData(questionSetAnswers);
