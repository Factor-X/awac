...
import eu.factorx.awac.service.knowledge.activity.contributor.enterprise.BaseActivityDataAE_BAD2B;

/*
 * Test for bad AE_BAD2B
*/
@Component
public class BAD_AE_BAD2BTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD2B baseActivityDataAE_BAD2B;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD2B.getBaseActivityData(questionSetAnswers);
