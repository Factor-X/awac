...
/*
 * Test for bad AE_BAD10A
*/
@Component
public class BAD_AE_BAD10ATest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD10A baseActivityDataAE_BAD10A;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD10A.getBaseActivityData(questionSetAnswers);
    ...
    private List<AnswerLineDTO> buildAnswerA73(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A67",1);
                list.add(new AnswerLineDTO("A73",6.0,  mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A67",4);
                list.add(new AnswerLineDTO("A73",6.0,  mapRepetition2 ));
