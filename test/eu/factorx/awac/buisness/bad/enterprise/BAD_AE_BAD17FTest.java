...
/*
 * Test for bad AE_BAD17F
*/
@Component
public class BAD_AE_BAD17FTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD17F baseActivityDataAE_BAD17F;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD17F.getBaseActivityData(questionSetAnswers);
