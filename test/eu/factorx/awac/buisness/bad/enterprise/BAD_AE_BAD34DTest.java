...
/*
 * Test for bad AE_BAD34D
*/
@Component
public class BAD_AE_BAD34DTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD34D baseActivityDataAE_BAD34D;
    ...
    public void test(long siteId){
        ...
        //add answers
                ...
                answerLineDTOList.addAll(buildAnswerA1031());
                answerLineDTOList.addAll(buildAnswerA1032());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD34D.getBaseActivityData(questionSetAnswers);
     ...
     * question : A1031
     */
    private List<AnswerLineDTO> buildAnswerA1031(){
     ...
     * question : A1032
     */
    private List<AnswerLineDTO> buildAnswerA1032(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A244",1);
                mapRepetition1.put("A1030",1);
                list.add(new AnswerLineDTO("A1032",1000.0,  mapRepetition1  , UnitCode.U5122.getKey()  ));
