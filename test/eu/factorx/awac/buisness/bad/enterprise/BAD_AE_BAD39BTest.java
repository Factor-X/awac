...
/*
 * Test for bad AE_BAD39B
*/
@Component
public class BAD_AE_BAD39BTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD39B baseActivityDataAE_BAD39B;
    ...
    public void test(long siteId){
        ...
        //add answers
                ...
                answerLineDTOList.addAll(buildAnswerA338());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD39B.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(8.0, false);
                mapResult.put(6.4, false);
    ...
    private List<AnswerLineDTO> buildAnswerA335(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                ...
                list.add(new AnswerLineDTO("A335","invest1",  mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A334",2);
                list.add(new AnswerLineDTO("A335","invest2",  mapRepetition2 ));
    ...
    private List<AnswerLineDTO> buildAnswerA336(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A334",1);
                list.add(new AnswerLineDTO("A336",1.0,  mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A334",2);
                list.add(new AnswerLineDTO("A336",0.4,  mapRepetition2 ));
     ...
     * question : A338
     */
    private List<AnswerLineDTO> buildAnswerA338(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A334",1);
                list.add(new AnswerLineDTO("A338",8.0,  mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A334",2);
                list.add(new AnswerLineDTO("A338",16.0,  mapRepetition2 ));
