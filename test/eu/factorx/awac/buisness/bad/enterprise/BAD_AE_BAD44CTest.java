...
/*
 * Test for bad AE_BAD44C
*/
@Component
public class BAD_AE_BAD44CTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD44C baseActivityDataAE_BAD44C;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD44C.getBaseActivityData(questionSetAnswers);
