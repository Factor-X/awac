...
/*
 * Test for bad AE_BAD41C
*/
@Component
public class BAD_AE_BAD41CTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD41C baseActivityDataAE_BAD41C;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD41C.getBaseActivityData(questionSetAnswers);
