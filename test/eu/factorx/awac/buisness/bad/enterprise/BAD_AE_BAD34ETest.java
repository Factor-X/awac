...
/*
 * Test for bad AE_BAD34E
*/
@Component
public class BAD_AE_BAD34ETest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD34E baseActivityDataAE_BAD34E;
    ...
    public void test(long siteId){
        ...
        //add answers
                ...
                answerLineDTOList.addAll(buildAnswerA1034());
                answerLineDTOList.addAll(buildAnswerA1035());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD34E.getBaseActivityData(questionSetAnswers);
     ...
     * question : A1034
     */
    private List<AnswerLineDTO> buildAnswerA1034(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A1033",1);
                mapRepetition1.put("A244",1);
                list.add(new AnswerLineDTO("A1034","AS_35",  mapRepetition1 ));
     ...
     * question : A1035
     */
    private List<AnswerLineDTO> buildAnswerA1035(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A1033",1);
                mapRepetition1.put("A244",1);
                list.add(new AnswerLineDTO("A1035",1000.0,  mapRepetition1  , UnitCode.U5133.getKey()  ));
