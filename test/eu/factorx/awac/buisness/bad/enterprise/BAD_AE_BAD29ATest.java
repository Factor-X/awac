...
/*
 * Test for bad AE_BAD29A
*/
@Component
public class BAD_AE_BAD29ATest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD29A baseActivityDataAE_BAD29A;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD29A.getBaseActivityData(questionSetAnswers);
     ...
     * question : A234
     */
    private List<AnswerLineDTO> buildAnswerA234(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A231",1);
                list.add(new AnswerLineDTO("A234",0.5,  mapRepetition1  , UnitCode.U5116.getKey()  ));
