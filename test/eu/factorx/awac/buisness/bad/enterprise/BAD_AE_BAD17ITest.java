...
/*
 * Test for bad AE_BAD17I
*/
@Component
public class BAD_AE_BAD17ITest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD17I baseActivityDataAE_BAD17I;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD17I.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(252.0, false);
                mapResult.put(78.75, false);
