...
/*
 * Test for bad AE_BAD27A
*/
@Component
public class BAD_AE_BAD27ATest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD27A baseActivityDataAE_BAD27A;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD27A.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(1400.0, false);
