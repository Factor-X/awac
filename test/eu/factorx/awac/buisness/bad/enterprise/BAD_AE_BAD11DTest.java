...
/*
 * Test for bad AE_BAD11D
*/
@Component
public class BAD_AE_BAD11DTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD11D baseActivityDataAE_BAD11D;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD11D.getBaseActivityData(questionSetAnswers);
