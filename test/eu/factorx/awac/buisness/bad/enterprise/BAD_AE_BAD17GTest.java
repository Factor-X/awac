...
/*
 * Test for bad AE_BAD17G
*/
@Component
public class BAD_AE_BAD17GTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD17G baseActivityDataAE_BAD17G;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD17G.getBaseActivityData(questionSetAnswers);
