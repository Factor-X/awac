...
import eu.factorx.awac.service.knowledge.activity.contributor.enterprise.BaseActivityDataAE_BAD6B;

/*
 * Test for bad AE_BAD6B
*/
@Component
public class BAD_AE_BAD6BTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD6B baseActivityDataAE_BAD6B;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA24());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD6B.getBaseActivityData(questionSetAnswers);
     ...
     * question : A24
     */
    private List<AnswerLineDTO> buildAnswerA24(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A24",16.2,  mapRepetition1  , UnitCode.U5337.getKey()  ));
