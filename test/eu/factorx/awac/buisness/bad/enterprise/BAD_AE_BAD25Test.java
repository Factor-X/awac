...
public class BAD_AE_BAD25Test{
    ...
    private List<AnswerLineDTO> buildAnswerA200(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A200","AT_60",  mapRepetition1 ));
    ...
    private List<AnswerLineDTO> buildAnswerA198(){
        ...
        List<AnswerLineDTO> list = new ArrayList<>();
                 ...
                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A198","AS_192",  mapRepetition1 ));
    ...
    private List<AnswerLineDTO> buildAnswerA195(){
        ...
        List<AnswerLineDTO> list = new ArrayList<>();
                 ...
                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A195","1",  mapRepetition1 ));
    ...
    private List<AnswerLineDTO> buildAnswerA199(){
        ...
        List<AnswerLineDTO> list = new ArrayList<>();
                 ...
                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A199",45622.0,  mapRepetition1  , UnitCode.U5126.getKey()  ));
