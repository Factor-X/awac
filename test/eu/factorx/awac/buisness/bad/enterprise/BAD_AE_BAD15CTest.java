...
public class BAD_AE_BAD15CTest{
    ...
    private List<AnswerLineDTO> buildAnswerA12(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A12",24.0,  mapRepetition1 ));
    ...
    private List<AnswerLineDTO> buildAnswerA122(){
        ...
        List<AnswerLineDTO> list = new ArrayList<>();
                 ...
                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A122",0.25,  mapRepetition1 ));
    ...
    private List<AnswerLineDTO> buildAnswerA123(){
        ...
        List<AnswerLineDTO> list = new ArrayList<>();
                 ...
                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A123","0",  mapRepetition1 ));
    ...
    private List<AnswerLineDTO> buildAnswerA124(){
        ...
        List<AnswerLineDTO> list = new ArrayList<>();
                 ...
                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A124","0",  mapRepetition1 ));
