...
/*
 * Test for bad AE_BAD17C
*/
@Component
public class BAD_AE_BAD17CTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD17C baseActivityDataAE_BAD17C;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD17C.getBaseActivityData(questionSetAnswers);
