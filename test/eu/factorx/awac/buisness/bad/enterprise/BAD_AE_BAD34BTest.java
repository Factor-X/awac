...
public class BAD_AE_BAD34BTest{
    ...
    private List<AnswerLineDTO> buildAnswerA287(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A244",1);
                list.add(new AnswerLineDTO("A287",2500.0,  mapRepetition1  , UnitCode.U5156.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A244",2);
                list.add(new AnswerLineDTO("A287",6000.0,  mapRepetition2  , UnitCode.U5156.getKey()  ));
