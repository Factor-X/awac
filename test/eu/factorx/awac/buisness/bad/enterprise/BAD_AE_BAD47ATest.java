...
/*
 * Test for bad AE_BAD47A
*/
@Component
public class BAD_AE_BAD47ATest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD47A baseActivityDataAE_BAD47A;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD47A.getBaseActivityData(questionSetAnswers);
