...
/*
 * Test for bad AE_BAD31G
*/
@Component
public class BAD_AE_BAD31GTest{
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD31G.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(0.0, false);
