...
import eu.factorx.awac.service.knowledge.activity.contributor.enterprise.BaseActivityDataAE_BAD2A;

/*
 * Test for bad AE_BAD2A
*/
@Component
public class BAD_AE_BAD2ATest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD2A baseActivityDataAE_BAD2A;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD2A.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(16200.0, false);
