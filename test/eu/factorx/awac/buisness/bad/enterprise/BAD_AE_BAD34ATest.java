...
public class BAD_AE_BAD34ATest{
    ...
    private List<AnswerLineDTO> buildAnswerA285(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                ...
                list.add(new AnswerLineDTO("A285","AS_35",  mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A244",1);
                mapRepetition2.put("A284",2);
                list.add(new AnswerLineDTO("A285","AS_34",  mapRepetition2 ));
                //add repetition
        Map<String, Integer> mapRepetition3 = new HashMap<>();
                mapRepetition3.put("A244",2);
                mapRepetition3.put("A284",1);
                list.add(new AnswerLineDTO("A285","AS_33",  mapRepetition3 ));
    ...
    private List<AnswerLineDTO> buildAnswerA286(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A244",1);
                mapRepetition1.put("A284",1);
                list.add(new AnswerLineDTO("A286",1000.0,  mapRepetition1  , UnitCode.U5156.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A244",1);
                mapRepetition2.put("A284",2);
                list.add(new AnswerLineDTO("A286",500.0,  mapRepetition2  , UnitCode.U5156.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition3 = new HashMap<>();
                mapRepetition3.put("A244",2);
                mapRepetition3.put("A284",1);
                list.add(new AnswerLineDTO("A286",1500.0,  mapRepetition3  , UnitCode.U5156.getKey()  ));
