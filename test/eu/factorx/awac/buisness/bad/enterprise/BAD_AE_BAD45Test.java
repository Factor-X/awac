...
/*
 * Test for bad AE_BAD45
*/
@Component
public class BAD_AE_BAD45Test{
    ...
    @Autowired
    private BaseActivityDataAE_BAD45 baseActivityDataAE_BAD45;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA509());
                answerLineDTOList.addAll(buildAnswerA510());
                answerLineDTOList.addAll(buildAnswerA511());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD45.getBaseActivityData(questionSetAnswers);
     ...
     * question : A509
     */
    private List<AnswerLineDTO> buildAnswerA509(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A507",1);
                list.add(new AnswerLineDTO("A509","AS_5",  mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A507",2);
                list.add(new AnswerLineDTO("A509","AS_163",  mapRepetition2 ));
     ...
     * question : A510
     */
    private List<AnswerLineDTO> buildAnswerA510(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A507",1);
                list.add(new AnswerLineDTO("A510",4.5,  mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A507",2);
                list.add(new AnswerLineDTO("A510",12.0,  mapRepetition2 ));
     ...
     * question : A511
     */
    private List<AnswerLineDTO> buildAnswerA511(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A507",1);
                list.add(new AnswerLineDTO("A511",245000.0,  mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A507",2);
                list.add(new AnswerLineDTO("A511",120000.0,  mapRepetition2 ));
