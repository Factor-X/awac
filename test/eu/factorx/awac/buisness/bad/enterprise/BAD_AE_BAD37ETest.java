...
/*
 * Test for bad AE_BAD37E
*/
@Component
public class BAD_AE_BAD37ETest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD37E baseActivityDataAE_BAD37E;
    ...
    public void test(long siteId){
        ...
        //add answers
                ...
                answerLineDTOList.addAll(buildAnswerA1014());
                answerLineDTOList.addAll(buildAnswerA1017());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD37E.getBaseActivityData(questionSetAnswers);
    ...
    private List<AnswerLineDTO> buildAnswerA312(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                ...
                list.add(new AnswerLineDTO("A312","machines",  mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A311",2);
                list.add(new AnswerLineDTO("A312","locaux",  mapRepetition2 ));
     ...
     * question : A1014
     */
    private List<AnswerLineDTO> buildAnswerA1014(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A311",1);
                mapRepetition1.put("A1012",1);
                list.add(new AnswerLineDTO("A1014",1000.0,  mapRepetition1  , UnitCode.U5122.getKey()  ));
     ...
     * question : A1017
     */
    private List<AnswerLineDTO> buildAnswerA1017(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A311",1);
                mapRepetition1.put("A1015",1);
                list.add(new AnswerLineDTO("A1017",1000.0,  mapRepetition1  , UnitCode.U5133.getKey()  ));
