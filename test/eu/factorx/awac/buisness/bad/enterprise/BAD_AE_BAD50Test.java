...
import eu.factorx.awac.service.knowledge.activity.contributor.enterprise.BaseActivityDataAE_BAD50;

/*
 * Test for bad AE_BAD50
*/
@Component
public class BAD_AE_BAD50Test{
    ...
    @Autowired
    private BaseActivityDataAE_BAD50 baseActivityDataAE_BAD50;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA1001());
                answerLineDTOList.addAll(buildAnswerA1002());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD50.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(6500.0, false);
     ...
     * question : A1001
     */
    private List<AnswerLineDTO> buildAnswerA1001(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A1000",1);
                list.add(new AnswerLineDTO("A1001","AS_1",  mapRepetition1 ));
     ...
     * question : A1002
     */
    private List<AnswerLineDTO> buildAnswerA1002(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A1000",1);
                list.add(new AnswerLineDTO("A1002",6.5,  mapRepetition1  , UnitCode.U5122.getKey()  ));
