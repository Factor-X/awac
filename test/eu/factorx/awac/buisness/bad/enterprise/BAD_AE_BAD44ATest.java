...
/*
 * Test for bad AE_BAD44A
*/
@Component
public class BAD_AE_BAD44ATest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD44A baseActivityDataAE_BAD44A;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD44A.getBaseActivityData(questionSetAnswers);
