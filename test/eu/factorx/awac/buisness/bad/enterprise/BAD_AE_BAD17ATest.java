...
/*
 * Test for bad AE_BAD17A
*/
@Component
public class BAD_AE_BAD17ATest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD17A baseActivityDataAE_BAD17A;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD17A.getBaseActivityData(questionSetAnswers);
