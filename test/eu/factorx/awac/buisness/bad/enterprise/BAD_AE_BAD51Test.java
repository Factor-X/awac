...
import eu.factorx.awac.service.knowledge.activity.contributor.enterprise.BaseActivityDataAE_BAD51;

/*
 * Test for bad AE_BAD51
*/
@Component
public class BAD_AE_BAD51Test{
    ...
    @Autowired
    private BaseActivityDataAE_BAD51 baseActivityDataAE_BAD51;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA1004());
                answerLineDTOList.addAll(buildAnswerA1005());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD51.getBaseActivityData(questionSetAnswers);
     ...
     * question : A1004
     */
    private List<AnswerLineDTO> buildAnswerA1004(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A1003",1);
                list.add(new AnswerLineDTO("A1004","AS_1",  mapRepetition1 ));
     ...
     * question : A1005
     */
    private List<AnswerLineDTO> buildAnswerA1005(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A1003",1);
                list.add(new AnswerLineDTO("A1005",6500.0,  mapRepetition1  , UnitCode.U5133.getKey()  ));
