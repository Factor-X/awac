...
/*
 * Test for bad AE_BAD11E
*/
@Component
public class BAD_AE_BAD11ETest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD11E baseActivityDataAE_BAD11E;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD11E.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(50000.0, false);
    ...
    private List<AnswerLineDTO> buildAnswerA89(){
        ...
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A78",4);
                list.add(new AnswerLineDTO("A89",1.6, identifier, mapRepetition2  , UnitCode.U5170.getKey()  ));
