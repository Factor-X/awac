...
/*
 * Test for bad AE_BAD10B
*/
@Component
public class BAD_AE_BAD10BTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD10B baseActivityDataAE_BAD10B;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD10B.getBaseActivityData(questionSetAnswers);
