...
/*
 * Test for bad AE_BAD27L
*/
@Component
public class BAD_AE_BAD27LTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD27L baseActivityDataAE_BAD27L;
    ...
    public void test(long siteId){
        ...
        //add answers
                ...
                answerLineDTOList.addAll(buildAnswerA219());
                answerLineDTOList.addAll(buildAnswerA222());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD27L.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(87.0, false);
     ...
     * question : A219
     */
    private List<AnswerLineDTO> buildAnswerA219(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A209",2);
                list.add(new AnswerLineDTO("A219","AS_343", identifier, mapRepetition1 ));
     ...
     * question : A222
     */
    private List<AnswerLineDTO> buildAnswerA222(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A209",2);
                list.add(new AnswerLineDTO("A222",87.0, identifier, mapRepetition1  , UnitCode.U5325.getKey()  ));
