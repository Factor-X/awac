...
/*
 * Test for bad AE_BAD49
*/
@Component
public class BAD_AE_BAD49Test{
    ...
    @Autowired
    private BaseActivityDataAE_BAD49 baseActivityDataAE_BAD49;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA615());
                answerLineDTOList.addAll(buildAnswerA617());
                answerLineDTOList.addAll(buildAnswerA616());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD49.getBaseActivityData(questionSetAnswers);
     ...
     * question : A615
     */
    private List<AnswerLineDTO> buildAnswerA615(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A613",1);
                list.add(new AnswerLineDTO("A615","AS_5",  mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A613",2);
                list.add(new AnswerLineDTO("A615","AS_162",  mapRepetition2 ));
     ...
     * question : A617
     */
    private List<AnswerLineDTO> buildAnswerA617(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A613",1);
                list.add(new AnswerLineDTO("A617",80000.0,  mapRepetition1  , UnitCode.U5170.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A613",2);
                list.add(new AnswerLineDTO("A617",150000.0,  mapRepetition2  , UnitCode.U5170.getKey()  ));
     ...
     * question : A616
     */
    private List<AnswerLineDTO> buildAnswerA616(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A613",1);
                list.add(new AnswerLineDTO("A616",1.4,  mapRepetition1  , UnitCode.U5170.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A613",2);
                list.add(new AnswerLineDTO("A616",1.6,  mapRepetition2  , UnitCode.U5170.getKey()  ));
