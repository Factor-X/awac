...
/*
 * Test for bad AE_BAD41A
*/
@Component
public class BAD_AE_BAD41ATest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD41A baseActivityDataAE_BAD41A;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD41A.getBaseActivityData(questionSetAnswers);
