...
import eu.factorx.awac.service.knowledge.activity.contributor.enterprise.BaseActivityDataAE_BAD40;

/*
 * Test for bad AE_BAD40
*/
@Component
public class BAD_AE_BAD40Test{
    ...
    @Autowired
    private BaseActivityDataAE_BAD40 baseActivityDataAE_BAD40;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA46());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD40.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(18.326, false);
     ...
     * question : A46
     */
    private List<AnswerLineDTO> buildAnswerA46(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A46",18326.0,  mapRepetition1  , UnitCode.U5159.getKey()  ));
