...
/*
 * Test for bad AE_BAD19E
*/
@Component
public class BAD_AE_BAD19ETest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD19E baseActivityDataAE_BAD19E;
    ...
    public void test(long siteId){
        ...
        //add answers
                ...
                answerLineDTOList.addAll(buildAnswerA1010());
                answerLineDTOList.addAll(buildAnswerA1011());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD19E.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(2.2, false);
     ...
     * question : A1010
     */
    private List<AnswerLineDTO> buildAnswerA1010(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A1009",1);
                mapRepetition1.put("A164",1);
                list.add(new AnswerLineDTO("A1010","AS_15",  mapRepetition1 ));
     ...
     * question : A1011
     */
    private List<AnswerLineDTO> buildAnswerA1011(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A1009",1);
                mapRepetition1.put("A164",1);
                list.add(new AnswerLineDTO("A1011",2200.0,  mapRepetition1  , UnitCode.U5133.getKey()  ));
