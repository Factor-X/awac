...
/*
 * Test for bad AE_BAD33E
*/
@Component
public class BAD_AE_BAD33ETest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD33E baseActivityDataAE_BAD33E;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA1028());
                answerLineDTOList.addAll(buildAnswerA1029());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD33E.getBaseActivityData(questionSetAnswers);
     ...
     * question : A1028
     */
    private List<AnswerLineDTO> buildAnswerA1028(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                ...
                mapRepetition1.put("A1027",1);
                list.add(new AnswerLineDTO("A1028","AS_38",  mapRepetition1 ));
     ...
     * question : A1029
     */
    private List<AnswerLineDTO> buildAnswerA1029(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                ...
                mapRepetition1.put("A273",1);
                mapRepetition1.put("A1027",1);
                list.add(new AnswerLineDTO("A1029",1000.0,  mapRepetition1  , UnitCode.U5133.getKey()  ));
