...
/*
 * Test for bad AE_BAD29B
*/
@Component
public class BAD_AE_BAD29BTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD29B baseActivityDataAE_BAD29B;
    ...
    public void test(long siteId){
        ...
        //add answers
                ...
                answerLineDTOList.addAll(buildAnswerA235());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD29B.getBaseActivityData(questionSetAnswers);
    ...
    private List<AnswerLineDTO> buildAnswerA232(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                ...
                list.add(new AnswerLineDTO("A232","voirie",  mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A231",2);
                list.add(new AnswerLineDTO("A232","imprimante",  mapRepetition2 ));
                //add repetition
        Map<String, Integer> mapRepetition3 = new HashMap<>();
                mapRepetition3.put("A231",3);
                list.add(new AnswerLineDTO("A232","voiture",  mapRepetition3 ));
    ...
    private List<AnswerLineDTO> buildAnswerA233(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A231",1);
                list.add(new AnswerLineDTO("A233","23",  mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A231",2);
                list.add(new AnswerLineDTO("A233","19",  mapRepetition2 ));
                //add repetition
        Map<String, Integer> mapRepetition3 = new HashMap<>();
                mapRepetition3.put("A231",3);
                list.add(new AnswerLineDTO("A233","20",  mapRepetition3 ));
     ...
     * question : A235
     */
    private List<AnswerLineDTO> buildAnswerA235(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A231",3);
                list.add(new AnswerLineDTO("A235",12.0,  mapRepetition1  , UnitCode.U5135.getKey()  ));
