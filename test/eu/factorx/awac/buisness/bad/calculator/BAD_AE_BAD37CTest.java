...
/*
 * Test for bad AE_BAD37C
*/
@Component
public class BAD_AE_BAD37CTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD37C baseActivityDataAE_BAD37C;
    ...
    public void test(long siteId){
        ...
        //add answers
                ...
                answerLineDTOList.addAll(buildAnswerA318());
                answerLineDTOList.addAll(buildAnswerA319());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD37C.getBaseActivityData(questionSetAnswers);
     ...
     * question : A318
     */
    private List<AnswerLineDTO> buildAnswerA318(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A311",2);
                mapRepetition1.put("A317",1);
                list.add(new AnswerLineDTO("A318","AS_73",  mapRepetition1 ));
     ...
     * question : A319
     */
    private List<AnswerLineDTO> buildAnswerA319(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A311",2);
                mapRepetition1.put("A317",1);
                list.add(new AnswerLineDTO("A319",4.0,  mapRepetition1  , UnitCode.U5133.getKey()  ));
