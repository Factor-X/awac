...
/*
 * Test for bad AE_BAD38D
*/
@Component
public class BAD_AE_BAD38DTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD38D baseActivityDataAE_BAD38D;
    ...
    public void test(long siteId){
        ...
        //add answers
                ...
                answerLineDTOList.addAll(buildAnswerA1019());
                answerLineDTOList.addAll(buildAnswerA1020());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD38D.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(2.0E7, false);
     ...
     * question : A1019
     */
    private List<AnswerLineDTO> buildAnswerA1019(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A322",1);
                mapRepetition1.put("A1018",1);
                list.add(new AnswerLineDTO("A1019","AS_5",  mapRepetition1 ));
     ...
     * question : A1020
     */
    private List<AnswerLineDTO> buildAnswerA1020(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A322",1);
                mapRepetition1.put("A1018",1);
                list.add(new AnswerLineDTO("A1020",1000.0,  mapRepetition1  , UnitCode.U5122.getKey()  ));
