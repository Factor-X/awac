...
/*
 * Test for bad AE_BAD42
*/
@Component
public class BAD_AE_BAD42Test{
    ...
    @Autowired
    private BaseActivityDataAE_BAD42 baseActivityDataAE_BAD42;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA409());
                answerLineDTOList.addAll(buildAnswerA410());
                answerLineDTOList.addAll(buildAnswerA411());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD42.getBaseActivityData(questionSetAnswers);
     ...
     * question : A409
     */
    private List<AnswerLineDTO> buildAnswerA409(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A407",1);
                list.add(new AnswerLineDTO("A409","AS_5",  mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A407",2);
                list.add(new AnswerLineDTO("A409","AS_163",  mapRepetition2 ));
     ...
     * question : A410
     */
    private List<AnswerLineDTO> buildAnswerA410(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A407",1);
                list.add(new AnswerLineDTO("A410",4.5,  mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A407",2);
                list.add(new AnswerLineDTO("A410",12.0,  mapRepetition2 ));
     ...
     * question : A411
     */
    private List<AnswerLineDTO> buildAnswerA411(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A407",1);
                list.add(new AnswerLineDTO("A411",245000.0,  mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A407",2);
                list.add(new AnswerLineDTO("A411",120000.0,  mapRepetition2 ));
