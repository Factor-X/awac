...
/*
 * Test for bad AE_BAD38E
*/
@Component
public class BAD_AE_BAD38ETest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD38E baseActivityDataAE_BAD38E;
    ...
    public void test(long siteId){
        ...
        //add answers
                ...
                answerLineDTOList.addAll(buildAnswerA1022());
                answerLineDTOList.addAll(buildAnswerA1023());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD38E.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(20.0, false);
     ...
     * question : A1022
     */
    private List<AnswerLineDTO> buildAnswerA1022(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A1021",1);
                mapRepetition1.put("A322",1);
                list.add(new AnswerLineDTO("A1022","AS_5",  mapRepetition1 ));
     ...
     * question : A1023
     */
    private List<AnswerLineDTO> buildAnswerA1023(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A1021",1);
                mapRepetition1.put("A322",1);
                list.add(new AnswerLineDTO("A1023",1000.0,  mapRepetition1  , UnitCode.U5133.getKey()  ));
