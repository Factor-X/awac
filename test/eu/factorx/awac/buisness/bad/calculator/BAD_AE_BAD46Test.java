...
/*
 * Test for bad AE_BAD46
*/
@Component
public class BAD_AE_BAD46Test{
    ...
    @Autowired
    private BaseActivityDataAE_BAD46 baseActivityDataAE_BAD46;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA515());
                answerLineDTOList.addAll(buildAnswerA517());
                answerLineDTOList.addAll(buildAnswerA516());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD46.getBaseActivityData(questionSetAnswers);
     ...
     * question : A515
     */
    private List<AnswerLineDTO> buildAnswerA515(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A513",1);
                list.add(new AnswerLineDTO("A515","AS_5",  mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A513",2);
                list.add(new AnswerLineDTO("A515","AS_162",  mapRepetition2 ));
     ...
     * question : A517
     */
    private List<AnswerLineDTO> buildAnswerA517(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A513",1);
                list.add(new AnswerLineDTO("A517",80000.0,  mapRepetition1  , UnitCode.U5170.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A513",2);
                list.add(new AnswerLineDTO("A517",150000.0,  mapRepetition2  , UnitCode.U5170.getKey()  ));
     ...
     * question : A516
     */
    private List<AnswerLineDTO> buildAnswerA516(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A513",1);
                list.add(new AnswerLineDTO("A516",1.4,  mapRepetition1  , UnitCode.U5170.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A513",2);
                list.add(new AnswerLineDTO("A516",1.6,  mapRepetition2  , UnitCode.U5170.getKey()  ));
