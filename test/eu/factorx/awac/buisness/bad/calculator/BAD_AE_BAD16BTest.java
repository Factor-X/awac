...
/*
 * Test for bad AE_BAD16B
*/
@Component
public class BAD_AE_BAD16BTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD16B baseActivityDataAE_BAD16B;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA134());
     ...
     * question : A134
     */
    private List<AnswerLineDTO> buildAnswerA134(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A134",130000.0,  mapRepetition1  , UnitCode.U5126.getKey()  ));
