...
/*
 * Test for bad AE_BAD19D
*/
@Component
public class BAD_AE_BAD19DTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD19D baseActivityDataAE_BAD19D;
    ...
    public void test(long siteId){
        ...
        //add answers
                ...
                answerLineDTOList.addAll(buildAnswerA1007());
                answerLineDTOList.addAll(buildAnswerA1008());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD19D.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(2200000.0, false);
     ...
     * question : A1007
     */
    private List<AnswerLineDTO> buildAnswerA1007(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A1006",1);
                mapRepetition1.put("A164",1);
                list.add(new AnswerLineDTO("A1007","AS_15",  mapRepetition1 ));
     ...
     * question : A1008
     */
    private List<AnswerLineDTO> buildAnswerA1008(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A1006",1);
                mapRepetition1.put("A164",1);
                list.add(new AnswerLineDTO("A1008",2200.0,  mapRepetition1  , UnitCode.U5122.getKey()  ));
