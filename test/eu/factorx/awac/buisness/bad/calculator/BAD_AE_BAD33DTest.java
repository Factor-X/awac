...
/*
 * Test for bad AE_BAD33D
*/
@Component
public class BAD_AE_BAD33DTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD33D baseActivityDataAE_BAD33D;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA1025());
                answerLineDTOList.addAll(buildAnswerA1026());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD33D.getBaseActivityData(questionSetAnswers);
     ...
     * question : A1025
     */
    private List<AnswerLineDTO> buildAnswerA1025(){
     ...
     * question : A1026
     */
    private List<AnswerLineDTO> buildAnswerA1026(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                ...
                mapRepetition1.put("A273",1);
                mapRepetition1.put("A1024",1);
                list.add(new AnswerLineDTO("A1026",1000.0,  mapRepetition1  , UnitCode.U5122.getKey()  ));
