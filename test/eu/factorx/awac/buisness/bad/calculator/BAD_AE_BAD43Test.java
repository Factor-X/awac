...
/*
 * Test for bad AE_BAD43
*/
@Component
public class BAD_AE_BAD43Test{
    ...
    @Autowired
    private BaseActivityDataAE_BAD43 baseActivityDataAE_BAD43;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA415());
                answerLineDTOList.addAll(buildAnswerA417());
                answerLineDTOList.addAll(buildAnswerA416());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD43.getBaseActivityData(questionSetAnswers);
     ...
     * question : A415
     */
    private List<AnswerLineDTO> buildAnswerA415(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A413",1);
                list.add(new AnswerLineDTO("A415","AS_5",  mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A413",2);
                list.add(new AnswerLineDTO("A415","AS_162",  mapRepetition2 ));
     ...
     * question : A417
     */
    private List<AnswerLineDTO> buildAnswerA417(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A413",1);
                list.add(new AnswerLineDTO("A417",80000.0,  mapRepetition1  , UnitCode.U5170.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A413",2);
                list.add(new AnswerLineDTO("A417",150000.0,  mapRepetition2  , UnitCode.U5170.getKey()  ));
     ...
     * question : A416
     */
    private List<AnswerLineDTO> buildAnswerA416(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A413",1);
                list.add(new AnswerLineDTO("A416",1.4,  mapRepetition1  , UnitCode.U5170.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A413",2);
                list.add(new AnswerLineDTO("A416",1.6,  mapRepetition2  , UnitCode.U5170.getKey()  ));
