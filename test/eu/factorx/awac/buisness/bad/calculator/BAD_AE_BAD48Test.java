...
/*
 * Test for bad AE_BAD48
*/
@Component
public class BAD_AE_BAD48Test{
    ...
    @Autowired
    private BaseActivityDataAE_BAD48 baseActivityDataAE_BAD48;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA609());
                answerLineDTOList.addAll(buildAnswerA610());
                answerLineDTOList.addAll(buildAnswerA611());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD48.getBaseActivityData(questionSetAnswers);
     ...
     * question : A609
     */
    private List<AnswerLineDTO> buildAnswerA609(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A607",1);
                list.add(new AnswerLineDTO("A609","AS_5",  mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A607",2);
                list.add(new AnswerLineDTO("A609","AS_163",  mapRepetition2 ));
     ...
     * question : A610
     */
    private List<AnswerLineDTO> buildAnswerA610(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A607",1);
                list.add(new AnswerLineDTO("A610",4.5,  mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A607",2);
                list.add(new AnswerLineDTO("A610",12.0,  mapRepetition2 ));
     ...
     * question : A611
     */
    private List<AnswerLineDTO> buildAnswerA611(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A607",1);
                list.add(new AnswerLineDTO("A611",245000.0,  mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A607",2);
                list.add(new AnswerLineDTO("A611",120000.0,  mapRepetition2 ));
