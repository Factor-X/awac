...
/*
 * Test for bad AE_BAD33B
*/
@Component
public class BAD_AE_BAD33BTest{
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA278());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD33B.getBaseActivityData(questionSetAnswers);
     ...
     * question : A278
     */
    private List<AnswerLineDTO> buildAnswerA278(){
    ...
    private void controlBad3(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 600.0, founded : "+bad.getValue(),bad.getValue().equals(600.0));
    }
