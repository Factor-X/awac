...
/*
 * Test for bad AE_BAD35C
*/
@Component
public class BAD_AE_BAD35CTest{
    ...
    public void test(long siteId){
        ...
        //add answers
                ...
                answerLineDTOList.addAll(buildAnswerA296());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD35C.getBaseActivityData(questionSetAnswers);
     ...
     * question : A296
     */
    private List<AnswerLineDTO> buildAnswerA296(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A244",1);
                list.add(new AnswerLineDTO("A296",360.0, identifier, mapRepetition1  , UnitCode.U5155.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A244",2);
                list.add(new AnswerLineDTO("A296",0.0, identifier, mapRepetition2  , UnitCode.U5156.getKey()  ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 100.0, founded : "+bad.getValue(),bad.getValue().equals(100.0));
    }
        /**
     * control the content and the value of the bad
     * @param bad
