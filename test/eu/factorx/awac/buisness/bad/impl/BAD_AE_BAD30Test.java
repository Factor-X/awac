...
/*
 * Test for bad AE_BAD30
*/
@Component
public class BAD_AE_BAD30Test{
    ...
    @Autowired
    private BaseActivityDataAE_BAD30 baseActivityDataAE_BAD30;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA239());
                answerLineDTOList.addAll(buildAnswerA240());
                answerLineDTOList.addAll(buildAnswerA242());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD30.getBaseActivityData(questionSetAnswers);
     ...
     * question : A239
     */
    private List<AnswerLineDTO> buildAnswerA239(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A238",1);
                list.add(new AnswerLineDTO("A239","infrastructure", identifier, mapRepetition1 ));
     ...
     * question : A240
     */
    private List<AnswerLineDTO> buildAnswerA240(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A238",1);
                list.add(new AnswerLineDTO("A240",1.0, identifier, mapRepetition1 ));
     ...
     * question : A242
     */
    private List<AnswerLineDTO> buildAnswerA242(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A238",1);
                list.add(new AnswerLineDTO("A242",45.0, identifier, mapRepetition1 ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 45.0, founded : "+bad.getValue(),bad.getValue().equals(45.0));
    }
