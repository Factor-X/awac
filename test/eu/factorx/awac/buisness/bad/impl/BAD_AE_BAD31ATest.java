...
public class BAD_AE_BAD31ATest{
    ...
    private List<AnswerLineDTO> buildAnswerA256(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A244",1);
                list.add(new AnswerLineDTO("A256",0.15, identifier, mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A244",2);
                list.add(new AnswerLineDTO("A256",0.1, identifier, mapRepetition2 ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 24000.0, founded : "+bad.getValue(),bad.getValue().equals(24000.0));
    }
        /**
     * control the content and the value of the bad
     * @param bad
    ...
    private void controlBad2(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 90000.0, founded : "+bad.getValue(),bad.getValue().equals(90000.0));
    }
