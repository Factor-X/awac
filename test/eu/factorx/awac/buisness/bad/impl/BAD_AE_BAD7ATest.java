...
/*
 * Test for bad AE_BAD7A
*/
@Component
public class BAD_AE_BAD7ATest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD7A baseActivityDataAE_BAD7A;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA55());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD7A.getBaseActivityData(questionSetAnswers);
     ...
     * question : A55
     */
    private List<AnswerLineDTO> buildAnswerA55(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A55",32.0, identifier, mapRepetition1  , UnitCode.U5122.getKey()  ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 32000.0, founded : "+bad.getValue(),bad.getValue().equals(32000.0));
    }
