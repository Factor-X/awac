...
/*
 * Test for bad AE_BAD23
*/
@Component
public class BAD_AE_BAD23Test{
    ...
    @Autowired
    private BaseActivityDataAE_BAD23 baseActivityDataAE_BAD23;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA189());
                answerLineDTOList.addAll(buildAnswerA190());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD23.getBaseActivityData(questionSetAnswers);
     ...
     * question : A189
     */
    private List<AnswerLineDTO> buildAnswerA189(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A189",3.0, identifier, mapRepetition1 ));
     ...
     * question : A190
     */
    private List<AnswerLineDTO> buildAnswerA190(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A190",250.0, identifier, mapRepetition1 ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 2.05479452054795, founded : "+bad.getValue(),bad.getValue().equals(2.05479452054795));
    }
