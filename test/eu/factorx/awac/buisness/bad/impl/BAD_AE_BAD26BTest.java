...
/*
 * Test for bad AE_BAD26B
*/
@Component
public class BAD_AE_BAD26BTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD26B baseActivityDataAE_BAD26B;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD26B.getBaseActivityData(questionSetAnswers);
     ...
     * question : A203
     */
    private List<AnswerLineDTO> buildAnswerA203(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A203",12.0, identifier, mapRepetition1  , UnitCode.U5135.getKey()  ));
