...
public class BAD_AE_BAD17DTest{
    ...
    private List<AnswerLineDTO> buildAnswerA150(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A142",1);
                list.add(new AnswerLineDTO("A150",0.2, identifier, mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A142",2);
                list.add(new AnswerLineDTO("A150",0.05, identifier, mapRepetition2 ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 504.0, founded : "+bad.getValue(),bad.getValue().equals(504.0));
    }
        /**
     * control the content and the value of the bad
     * @param bad
    ...
    private void controlBad2(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 26.125, founded : "+bad.getValue(),bad.getValue().equals(26.125));
    }
