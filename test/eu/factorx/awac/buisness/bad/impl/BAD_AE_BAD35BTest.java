...
/*
 * Test for bad AE_BAD35B
*/
@Component
public class BAD_AE_BAD35BTest{
    ...
    public void test(long siteId){
        ...
        //add answers
                ...
                answerLineDTOList.addAll(buildAnswerA246());
                answerLineDTOList.addAll(buildAnswerA293());
                answerLineDTOList.addAll(buildAnswerA295());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD35B.getBaseActivityData(questionSetAnswers);
     ...
     * question : A246
     */
    private List<AnswerLineDTO> buildAnswerA246(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A244",1);
                list.add(new AnswerLineDTO("A246",1000.0, identifier, mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A244",2);
                list.add(new AnswerLineDTO("A246",10.0, identifier, mapRepetition2 ));
     ...
     * question : A293
     */
    private List<AnswerLineDTO> buildAnswerA293(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A244",1);
                list.add(new AnswerLineDTO("A293",1000.0, identifier, mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A244",2);
                list.add(new AnswerLineDTO("A293",20000.0, identifier, mapRepetition2 ));
     ...
     * question : A295
     */
    private List<AnswerLineDTO> buildAnswerA295(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A244",1);
                list.add(new AnswerLineDTO("A295",0.0, identifier, mapRepetition1  , UnitCode.U5126.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A244",2);
                list.add(new AnswerLineDTO("A295",0.2, identifier, mapRepetition2  , UnitCode.U5126.getKey()  ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 0.0, founded : "+bad.getValue(),bad.getValue().equals(0.0));
    }
        /**
     * control the content and the value of the bad
     * @param bad
    ...
    private void controlBad2(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 40000.0, founded : "+bad.getValue(),bad.getValue().equals(40000.0));
    }
    ...
    private void controlGlobalBad(BaseActivityData bad){
        /*
        assertTrue("BaseActivityDataCode error. Expected : ActivityCategoryCode.AC_12, founded : "+bad.getKey(),bad.getKey().equals(BaseActivityDataCode.ActivityCategoryCode.AC_12));
