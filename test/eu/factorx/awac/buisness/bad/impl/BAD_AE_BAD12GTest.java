...
/*
 * Test for bad AE_BAD12G
*/
@Component
public class BAD_AE_BAD12GTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD12G baseActivityDataAE_BAD12G;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA101());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD12G.getBaseActivityData(questionSetAnswers);
     ...
     * question : A101
     */
    private List<AnswerLineDTO> buildAnswerA101(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A101",100.0, identifier, mapRepetition1 ));
