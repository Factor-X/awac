...
/*
 * Test for bad AE_BAD32A
*/
@Component
public class BAD_AE_BAD32ATest{
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD32A.getBaseActivityData(questionSetAnswers);
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 6764.785438517215, founded : "+bad.getValue(),bad.getValue().equals(6764.785438517215));
    }
