...
/*
 * Test for bad AE_BAD11F
*/
@Component
public class BAD_AE_BAD11FTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD11F baseActivityDataAE_BAD11F;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD11F.getBaseActivityData(questionSetAnswers);
    ...
    private List<AnswerLineDTO> buildAnswerA90(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                ...
                list.add(new AnswerLineDTO("A90",1.4, identifier, mapRepetition1  , UnitCode.U5170.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A78",5);
                list.add(new AnswerLineDTO("A90",1.4, identifier, mapRepetition2  , UnitCode.U5170.getKey()  ));
