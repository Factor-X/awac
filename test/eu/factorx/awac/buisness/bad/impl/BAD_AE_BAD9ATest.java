...
/*
 * Test for bad AE_BAD9A
*/
@Component
public class BAD_AE_BAD9ATest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD9A baseActivityDataAE_BAD9A;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA63());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD9A.getBaseActivityData(questionSetAnswers);
     ...
     * question : A63
     */
    private List<AnswerLineDTO> buildAnswerA63(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A63",2.0, identifier, mapRepetition1  , UnitCode.U5122.getKey()  ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 2000.0, founded : "+bad.getValue(),bad.getValue().equals(2000.0));
    }
