...
/*
 * Test for bad AE_BAD4
*/
@Component
public class BAD_AE_BAD4Test{
    ...
    @Autowired
    private BaseActivityDataAE_BAD4 baseActivityDataAE_BAD4;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA35());
                answerLineDTOList.addAll(buildAnswerA36());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD4.getBaseActivityData(questionSetAnswers);
     ...
     * question : A35
     */
    private List<AnswerLineDTO> buildAnswerA35(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A34",1);
                list.add(new AnswerLineDTO("A35","AS_114", identifier, mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A34",2);
                list.add(new AnswerLineDTO("A35","AS_57", identifier, mapRepetition2 ));
     ...
     * question : A36
     */
    private List<AnswerLineDTO> buildAnswerA36(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A34",1);
                list.add(new AnswerLineDTO("A36",4000.0, identifier, mapRepetition1  , UnitCode.U5135.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A34",2);
                list.add(new AnswerLineDTO("A36",5.5, identifier, mapRepetition2  , UnitCode.U5133.getKey()  ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 4000.0, founded : "+bad.getValue(),bad.getValue().equals(4000.0));
    }
        /**
     * control the content and the value of the bad
     * @param bad
    ...
    private void controlBad2(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 0.0055, founded : "+bad.getValue(),bad.getValue().equals(0.0055));
    }
    ...
    private void controlGlobalBad(BaseActivityData bad){
        /*
        assertTrue("BaseActivityDataCode error. Expected : ActivityCategoryCode.AC_2, founded : "+bad.getKey(),bad.getKey().equals(BaseActivityDataCode.ActivityCategoryCode.AC_2));
