...
public class BAD_AE_BAD40Test{
    ...
    private List<AnswerLineDTO> buildAnswerA46(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A46",18326.0, identifier, mapRepetition1  , UnitCode.U5159.getKey()  ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 18.326, founded : "+bad.getValue(),bad.getValue().equals(18.326));
    }
