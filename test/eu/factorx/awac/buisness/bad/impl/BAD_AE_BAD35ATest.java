...
/*
 * Test for bad AE_BAD35A
*/
@Component
public class BAD_AE_BAD35ATest{
    ...
    public void test(long siteId){
        ...
        //add answers
                ...
                answerLineDTOList.addAll(buildAnswerA294());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD35A.getBaseActivityData(questionSetAnswers);
     ...
     * question : A294
     */
    private List<AnswerLineDTO> buildAnswerA294(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A244",1);
                list.add(new AnswerLineDTO("A294",0.0, identifier, mapRepetition1  , UnitCode.U5126.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A244",2);
                list.add(new AnswerLineDTO("A294",0.1, identifier, mapRepetition2  , UnitCode.U5126.getKey()  ));
    ...
    private void controlBad2(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 20000.0, founded : "+bad.getValue(),bad.getValue().equals(20000.0));
    }
