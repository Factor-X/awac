...
/*
 * Test for bad AE_BAD34C
*/
@Component
public class BAD_AE_BAD34CTest{
    ...
    public void test(long siteId){
        ...
        //add answers
                ...
                answerLineDTOList.addAll(buildAnswerA289());
                answerLineDTOList.addAll(buildAnswerA290());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD34C.getBaseActivityData(questionSetAnswers);
     ...
     * question : A289
     */
    private List<AnswerLineDTO> buildAnswerA289(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A244",1);
                mapRepetition1.put("A288",2);
                list.add(new AnswerLineDTO("A289","AS_140", identifier, mapRepetition1 ));
     ...
     * question : A290
     */
    private List<AnswerLineDTO> buildAnswerA290(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A244",1);
                mapRepetition1.put("A288",1);
                list.add(new AnswerLineDTO("A290",15.0, identifier, mapRepetition1  , UnitCode.U5133.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A244",1);
                mapRepetition2.put("A288",2);
                list.add(new AnswerLineDTO("A290",25.0, identifier, mapRepetition2  , UnitCode.U5133.getKey()  ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 0.015, founded : "+bad.getValue(),bad.getValue().equals(0.015));
    }
        /**
     * control the content and the value of the bad
     * @param bad
    ...
    private void controlBad2(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 0.025, founded : "+bad.getValue(),bad.getValue().equals(0.025));
    }
