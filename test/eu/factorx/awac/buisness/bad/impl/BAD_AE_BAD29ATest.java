...
public class BAD_AE_BAD29ATest{
    ...
    private List<AnswerLineDTO> buildAnswerA234(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A231",1);
                list.add(new AnswerLineDTO("A234",0.5, identifier, mapRepetition1  , UnitCode.U5116.getKey()  ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 5000.0, founded : "+bad.getValue(),bad.getValue().equals(5000.0));
    }
