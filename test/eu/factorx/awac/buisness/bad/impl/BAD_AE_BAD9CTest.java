...
/*
 * Test for bad AE_BAD9C
*/
@Component
public class BAD_AE_BAD9CTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD9C baseActivityDataAE_BAD9C;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA65());
     ...
     * question : A65
     */
    private List<AnswerLineDTO> buildAnswerA65(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A65",0.08, identifier, mapRepetition1  , UnitCode.U5122.getKey()  ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 80.0, founded : "+bad.getValue(),bad.getValue().equals(80.0));
    }
