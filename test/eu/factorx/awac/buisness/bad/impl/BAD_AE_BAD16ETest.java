...
/*
 * Test for bad AE_BAD16E
*/
@Component
public class BAD_AE_BAD16ETest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD16E baseActivityDataAE_BAD16E;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA137());
                answerLineDTOList.addAll(buildAnswerA136());
                answerLineDTOList.addAll(buildAnswerA138());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD16E.getBaseActivityData(questionSetAnswers);
     ...
     * question : A137
     */
    private List<AnswerLineDTO> buildAnswerA137(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A137","AS_139", identifier, mapRepetition1 ));
     ...
     * question : A136
     */
    private List<AnswerLineDTO> buildAnswerA136(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A136",true, identifier, mapRepetition1 ));
     ...
     * question : A138
     */
    private List<AnswerLineDTO> buildAnswerA138(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A138",false, identifier, mapRepetition1 ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 4.84E-4, founded : "+bad.getValue(),bad.getValue().equals(4.84E-4));
    }
