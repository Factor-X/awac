...
/*
 * Test for bad AE_BAD7C
*/
@Component
public class BAD_AE_BAD7CTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD7C baseActivityDataAE_BAD7C;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA57());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD7C.getBaseActivityData(questionSetAnswers);
     ...
     * question : A57
     */
    private List<AnswerLineDTO> buildAnswerA57(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A57",2500.0, identifier, mapRepetition1  , UnitCode.U5126.getKey()  ));
