...
/*
 * Test for bad AE_BAD12E
*/
@Component
public class BAD_AE_BAD12ETest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD12E baseActivityDataAE_BAD12E;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA99());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD12E.getBaseActivityData(questionSetAnswers);
     ...
     * question : A99
     */
    private List<AnswerLineDTO> buildAnswerA99(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A99",240000.0, identifier, mapRepetition1 ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 240000.0, founded : "+bad.getValue(),bad.getValue().equals(240000.0));
    }
