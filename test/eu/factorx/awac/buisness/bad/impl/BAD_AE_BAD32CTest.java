...
/*
 * Test for bad AE_BAD32C
*/
@Component
public class BAD_AE_BAD32CTest{
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD32C.getBaseActivityData(questionSetAnswers);
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 28962.232739553358, founded : "+bad.getValue(),bad.getValue().equals(28962.232739553358));
    }
