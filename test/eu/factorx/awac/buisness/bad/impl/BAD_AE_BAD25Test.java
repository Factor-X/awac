...
/*
 * Test for bad AE_BAD25
*/
@Component
public class BAD_AE_BAD25Test{
    ...
    @Autowired
    private BaseActivityDataAE_BAD25 baseActivityDataAE_BAD25;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA200());
                answerLineDTOList.addAll(buildAnswerA198());
                answerLineDTOList.addAll(buildAnswerA195());
                answerLineDTOList.addAll(buildAnswerA199());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD25.getBaseActivityData(questionSetAnswers);
     ...
     * question : A200
     */
    private List<AnswerLineDTO> buildAnswerA200(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A200","AT_60", identifier, mapRepetition1 ));
     ...
     * question : A198
     */
    private List<AnswerLineDTO> buildAnswerA198(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A198","AS_192", identifier, mapRepetition1 ));
     ...
     * question : A195
     */
    private List<AnswerLineDTO> buildAnswerA195(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A195","1", identifier, mapRepetition1 ));
     ...
     * question : A199
     */
    private List<AnswerLineDTO> buildAnswerA199(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A199",45622.0, identifier, mapRepetition1  , UnitCode.U5126.getKey()  ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 45.622, founded : "+bad.getValue(),bad.getValue().equals(45.622));
    }
