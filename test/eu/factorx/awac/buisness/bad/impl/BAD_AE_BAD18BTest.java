...
/*
 * Test for bad AE_BAD18B
*/
@Component
public class BAD_AE_BAD18BTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD18B baseActivityDataAE_BAD18B;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA158());
                answerLineDTOList.addAll(buildAnswerA159());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD18B.getBaseActivityData(questionSetAnswers);
     ...
     * question : A158
     */
    private List<AnswerLineDTO> buildAnswerA158(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A158",13.5, identifier, mapRepetition1  , UnitCode.U5135.getKey()  ));
     ...
     * question : A159
     */
    private List<AnswerLineDTO> buildAnswerA159(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A159","2", identifier, mapRepetition1 ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 479.547738245296, founded : "+bad.getValue(),bad.getValue().equals(479.547738245296));
    }
