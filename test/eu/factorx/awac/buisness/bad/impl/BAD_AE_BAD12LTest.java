...
/*
 * Test for bad AE_BAD12L
*/
@Component
public class BAD_AE_BAD12LTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD12L baseActivityDataAE_BAD12L;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA106());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD12L.getBaseActivityData(questionSetAnswers);
     ...
     * question : A106
     */
    private List<AnswerLineDTO> buildAnswerA106(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A106",2500.0, identifier, mapRepetition1 ));
