...
/*
 * Test for bad AE_BAD33C
*/
@Component
public class BAD_AE_BAD33CTest{
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA280());
                answerLineDTOList.addAll(buildAnswerA281());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD33C.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(5.0E-4, false);
                mapResult.put(3.0E-4, false);
     ...
     * question : A280
     */
    private List<AnswerLineDTO> buildAnswerA280(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                ...
                mapRepetition1.put("A279",1);
                list.add(new AnswerLineDTO("A280","AS_142", identifier, mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A244",1);
                mapRepetition2.put("A273",2);
                mapRepetition2.put("A279",1);
                list.add(new AnswerLineDTO("A280","AS_143", identifier, mapRepetition2 ));
     ...
     * question : A281
     */
    private List<AnswerLineDTO> buildAnswerA281(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                ...
                mapRepetition1.put("A273",1);
                mapRepetition1.put("A279",1);
                list.add(new AnswerLineDTO("A281",0.5, identifier, mapRepetition1  , UnitCode.U5133.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A244",1);
                mapRepetition2.put("A273",2);
                mapRepetition2.put("A279",1);
                list.add(new AnswerLineDTO("A281",0.3, identifier, mapRepetition2  , UnitCode.U5133.getKey()  ));
