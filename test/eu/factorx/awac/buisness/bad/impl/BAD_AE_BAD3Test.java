...
/*
 * Test for bad AE_BAD3
*/
@Component
public class BAD_AE_BAD3Test{
    ...
    @Autowired
    private BaseActivityDataAE_BAD3 baseActivityDataAE_BAD3;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA26());
                answerLineDTOList.addAll(buildAnswerA28());
                answerLineDTOList.addAll(buildAnswerA27());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD3.getBaseActivityData(questionSetAnswers);
     ...
     * question : A26
     */
    private List<AnswerLineDTO> buildAnswerA26(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A25",1);
                list.add(new AnswerLineDTO("A26","AS_29", identifier, mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A25",2);
                list.add(new AnswerLineDTO("A26","AS_15", identifier, mapRepetition2 ));
     ...
     * question : A28
     */
    private List<AnswerLineDTO> buildAnswerA28(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A25",1);
                list.add(new AnswerLineDTO("A28",2000.0, identifier, mapRepetition1  , UnitCode.U5337.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A25",2);
                list.add(new AnswerLineDTO("A28",4.5E9, identifier, mapRepetition2  , UnitCode.U5155.getKey()  ));
     ...
     * question : A27
     */
    private List<AnswerLineDTO> buildAnswerA27(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A25",1);
                list.add(new AnswerLineDTO("A27",0.8, identifier, mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A25",2);
                list.add(new AnswerLineDTO("A27",0.93, identifier, mapRepetition2 ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 9000.0, founded : "+bad.getValue(),bad.getValue().equals(9000.0));
    }
        /**
     * control the content and the value of the bad
     * @param bad
    ...
    private void controlBad2(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 4.83870968, founded : "+bad.getValue(),bad.getValue().equals(4.83870968));
    }
