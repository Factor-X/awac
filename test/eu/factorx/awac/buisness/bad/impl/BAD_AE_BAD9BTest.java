...
/*
 * Test for bad AE_BAD9B
*/
@Component
public class BAD_AE_BAD9BTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD9B baseActivityDataAE_BAD9B;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA64());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD9B.getBaseActivityData(questionSetAnswers);
     ...
     * question : A64
     */
    private List<AnswerLineDTO> buildAnswerA64(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A64",3.5, identifier, mapRepetition1  , UnitCode.U5122.getKey()  ));
