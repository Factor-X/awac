...
public class BAD_AE_BAD17CTest{
    ...
    private List<AnswerLineDTO> buildAnswerA149(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A142",1);
                list.add(new AnswerLineDTO("A149",0.1, identifier, mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A142",2);
                list.add(new AnswerLineDTO("A149",0.2, identifier, mapRepetition2 ));
    ...
    private void controlBad2(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 105.0, founded : "+bad.getValue(),bad.getValue().equals(105.0));
    }
