...
/*
 * Test for bad AE_BAD19A
*/
@Component
public class BAD_AE_BAD19ATest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD19A baseActivityDataAE_BAD19A;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA165());
                answerLineDTOList.addAll(buildAnswerA167());
                answerLineDTOList.addAll(buildAnswerA168());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD19A.getBaseActivityData(questionSetAnswers);
     ...
     * question : A165
     */
    private List<AnswerLineDTO> buildAnswerA165(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A164",1);
                list.add(new AnswerLineDTO("A165","stock1", identifier, mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A164",2);
                list.add(new AnswerLineDTO("A165","stock2", identifier, mapRepetition2 ));
     ...
     * question : A167
     */
    private List<AnswerLineDTO> buildAnswerA167(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A166",1);
                mapRepetition1.put("A164",1);
                list.add(new AnswerLineDTO("A167","AS_15", identifier, mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A166",2);
                mapRepetition2.put("A164",1);
                list.add(new AnswerLineDTO("A167","AS_10", identifier, mapRepetition2 ));
                //add repetition
        Map<String, Integer> mapRepetition3 = new HashMap<>();
                mapRepetition3.put("A166",1);
                mapRepetition3.put("A164",2);
                list.add(new AnswerLineDTO("A167","AS_15", identifier, mapRepetition3 ));
     ...
     * question : A168
     */
    private List<AnswerLineDTO> buildAnswerA168(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A166",1);
                mapRepetition1.put("A164",1);
                list.add(new AnswerLineDTO("A168",2200.0, identifier, mapRepetition1  , UnitCode.U5156.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A166",2);
                mapRepetition2.put("A164",1);
                list.add(new AnswerLineDTO("A168",1200.0, identifier, mapRepetition2  , UnitCode.U5156.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition3 = new HashMap<>();
                mapRepetition3.put("A166",1);
                mapRepetition3.put("A164",2);
                list.add(new AnswerLineDTO("A168",120000.0, identifier, mapRepetition3  , UnitCode.U5155.getKey()  ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 7.92, founded : "+bad.getValue(),bad.getValue().equals(7.92));
    }
        /**
     * control the content and the value of the bad
     * @param bad
    ...
    private void controlBad2(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 4.32, founded : "+bad.getValue(),bad.getValue().equals(4.32));
    }
        /**
     * control the content and the value of the bad
     * @param bad
    ...
    private void controlBad3(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 1.2E-4, founded : "+bad.getValue(),bad.getValue().equals(1.2E-4));
    }
    ...
    private void controlGlobalBad(BaseActivityData bad){
        /*
        assertTrue("BaseActivityDataCode error. Expected : ActivityCategoryCode.AC_6, founded : "+bad.getKey(),bad.getKey().equals(BaseActivityDataCode.ActivityCategoryCode.AC_6));
