...
/*
 * Test for bad AE_BAD12C
*/
@Component
public class BAD_AE_BAD12CTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD12C baseActivityDataAE_BAD12C;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA97());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD12C.getBaseActivityData(questionSetAnswers);
     ...
     * question : A97
     */
    private List<AnswerLineDTO> buildAnswerA97(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A97",90000.0, identifier, mapRepetition1 ));
