...
public class BAD_AE_BAD6BTest{
    ...
    private List<AnswerLineDTO> buildAnswerA24(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A24",16.2, identifier, mapRepetition1  , UnitCode.U5337.getKey()  ));
    ...
    private List<AnswerLineDTO> buildAnswerA48(){
        ...
        List<AnswerLineDTO> list = new ArrayList<>();
                 ...
                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A48",true, identifier, mapRepetition1 ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 3.24, founded : "+bad.getValue(),bad.getValue().equals(3.24));
    }
