...
/*
 * Test for bad AE_BAD37B
*/
@Component
public class BAD_AE_BAD37BTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD37B baseActivityDataAE_BAD37B;
    ...
    public void test(long siteId){
        ...
        //add answers
                ...
                answerLineDTOList.addAll(buildAnswerA316());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD37B.getBaseActivityData(questionSetAnswers);
    ...
    private List<AnswerLineDTO> buildAnswerA312(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                ...
                list.add(new AnswerLineDTO("A312","machines:(A311:2)locaux", identifier, mapRepetition1 ));
     ...
     * question : A316
     */
    private List<AnswerLineDTO> buildAnswerA316(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A311",1);
                list.add(new AnswerLineDTO("A316",0.0, identifier, mapRepetition1  , UnitCode.U5156.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A311",2);
                list.add(new AnswerLineDTO("A316",1.2, identifier, mapRepetition2  , UnitCode.U5337.getKey()  ));
    ...
    private void controlBad2(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 1200.0, founded : "+bad.getValue(),bad.getValue().equals(1200.0));
    }
