...
/*
 * Test for bad AE_BAD21
*/
@Component
public class BAD_AE_BAD21Test{
    ...
    @Autowired
    private BaseActivityDataAE_BAD21 baseActivityDataAE_BAD21;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA183());
                answerLineDTOList.addAll(buildAnswerA184());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD21.getBaseActivityData(questionSetAnswers);
     ...
     * question : A183
     */
    private List<AnswerLineDTO> buildAnswerA183(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A183",12.0, identifier, mapRepetition1 ));
     ...
     * question : A184
     */
    private List<AnswerLineDTO> buildAnswerA184(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A184",200.0, identifier, mapRepetition1 ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 3.28767123287671, founded : "+bad.getValue(),bad.getValue().equals(3.28767123287671));
    }
