...
/*
 * Test for bad AE_BAD22
*/
@Component
public class BAD_AE_BAD22Test{
    ...
    @Autowired
    private BaseActivityDataAE_BAD22 baseActivityDataAE_BAD22;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA186());
                answerLineDTOList.addAll(buildAnswerA187());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD22.getBaseActivityData(questionSetAnswers);
     ...
     * question : A186
     */
    private List<AnswerLineDTO> buildAnswerA186(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A186",12.0, identifier, mapRepetition1 ));
     ...
     * question : A187
     */
    private List<AnswerLineDTO> buildAnswerA187(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A187",220.0, identifier, mapRepetition1 ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 2.41095890410959, founded : "+bad.getValue(),bad.getValue().equals(2.41095890410959));
    }
