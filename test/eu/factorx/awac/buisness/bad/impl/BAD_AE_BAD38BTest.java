...
/*
 * Test for bad AE_BAD38B
*/
@Component
public class BAD_AE_BAD38BTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD38B baseActivityDataAE_BAD38B;
    ...
    public void test(long siteId){
        ...
        //add answers
                ...
                answerLineDTOList.addAll(buildAnswerA328());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD38B.getBaseActivityData(questionSetAnswers);
     ...
     * question : A328
     */
    private List<AnswerLineDTO> buildAnswerA328(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A322",1);
                list.add(new AnswerLineDTO("A328",4500.0, identifier, mapRepetition1  , UnitCode.U5156.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A322",2);
                list.add(new AnswerLineDTO("A328",8.0, identifier, mapRepetition2  , UnitCode.U5337.getKey()  ));
    ...
    private void controlBad2(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 8000.0, founded : "+bad.getValue(),bad.getValue().equals(8000.0));
    }
