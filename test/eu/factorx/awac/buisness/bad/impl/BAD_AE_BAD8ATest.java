...
/*
 * Test for bad AE_BAD8A
*/
@Component
public class BAD_AE_BAD8ATest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD8A baseActivityDataAE_BAD8A;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA59());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD8A.getBaseActivityData(questionSetAnswers);
     ...
     * question : A59
     */
    private List<AnswerLineDTO> buildAnswerA59(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A59",0.12, identifier, mapRepetition1  , UnitCode.U5122.getKey()  ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 120.0, founded : "+bad.getValue(),bad.getValue().equals(120.0));
    }
