...
/*
 * Test for bad AE_BAD7B
*/
@Component
public class BAD_AE_BAD7BTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD7B baseActivityDataAE_BAD7B;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA56());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD7B.getBaseActivityData(questionSetAnswers);
     ...
     * question : A56
     */
    private List<AnswerLineDTO> buildAnswerA56(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A56",23.0, identifier, mapRepetition1  , UnitCode.U5122.getKey()  ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 23000.0, founded : "+bad.getValue(),bad.getValue().equals(23000.0));
    }
