...
/*
 * Test for bad AE_BAD13C
*/
@Component
public class BAD_AE_BAD13CTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD13C baseActivityDataAE_BAD13C;
    ...
    public void test(long siteId){
        ...
        //add answers
                ...
                answerLineDTOList.addAll(buildAnswerA110());
                answerLineDTOList.addAll(buildAnswerA111());
                answerLineDTOList.addAll(buildAnswerA112());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD13C.getBaseActivityData(questionSetAnswers);
     ...
     * question : A110
     */
    private List<AnswerLineDTO> buildAnswerA110(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A110",true, identifier, mapRepetition1 ));
     ...
     * question : A111
     */
    private List<AnswerLineDTO> buildAnswerA111(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A111",false, identifier, mapRepetition1 ));
     ...
     * question : A112
     */
    private List<AnswerLineDTO> buildAnswerA112(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A112",true, identifier, mapRepetition1 ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 24.0, founded : "+bad.getValue(),bad.getValue().equals(24.0));
    }
