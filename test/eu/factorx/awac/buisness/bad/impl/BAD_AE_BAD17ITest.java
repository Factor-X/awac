...
public class BAD_AE_BAD17ITest{
    ...
    private List<AnswerLineDTO> buildAnswerA155(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A142",1);
                list.add(new AnswerLineDTO("A155",0.1, identifier, mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A142",2);
                list.add(new AnswerLineDTO("A155",0.15, identifier, mapRepetition2 ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 252.0, founded : "+bad.getValue(),bad.getValue().equals(252.0));
    }
        /**
     * control the content and the value of the bad
     * @param bad
    ...
    private void controlBad2(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 78.375, founded : "+bad.getValue(),bad.getValue().equals(78.375));
    }
