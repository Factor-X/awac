...
/*
 * Test for bad AE_BAD34A
*/
@Component
public class BAD_AE_BAD34ATest{
    ...
    public void test(long siteId){
        ...
        //add answers
                ...
                answerLineDTOList.addAll(buildAnswerA285());
                answerLineDTOList.addAll(buildAnswerA286());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD34A.getBaseActivityData(questionSetAnswers);
     ...
     * question : A285
     */
    private List<AnswerLineDTO> buildAnswerA285(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A244",1);
                mapRepetition1.put("A284",1);
                list.add(new AnswerLineDTO("A285","AS_35", identifier, mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A244",1);
                mapRepetition2.put("A284",2);
                list.add(new AnswerLineDTO("A285","AS_34", identifier, mapRepetition2 ));
                //add repetition
        Map<String, Integer> mapRepetition3 = new HashMap<>();
                mapRepetition3.put("A244",2);
                mapRepetition3.put("A284",1);
                list.add(new AnswerLineDTO("A285","AS_33", identifier, mapRepetition3 ));
     ...
     * question : A286
     */
    private List<AnswerLineDTO> buildAnswerA286(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A244",1);
                mapRepetition1.put("A284",1);
                list.add(new AnswerLineDTO("A286",1000.0, identifier, mapRepetition1  , UnitCode.U5156.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A244",1);
                mapRepetition2.put("A284",2);
                list.add(new AnswerLineDTO("A286",500.0, identifier, mapRepetition2  , UnitCode.U5156.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition3 = new HashMap<>();
                mapRepetition3.put("A244",2);
                mapRepetition3.put("A284",1);
                list.add(new AnswerLineDTO("A286",1500.0, identifier, mapRepetition3  , UnitCode.U5156.getKey()  ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 3.6, founded : "+bad.getValue(),bad.getValue().equals(3.6));
    }
        /**
     * control the content and the value of the bad
     * @param bad
    ...
    private void controlBad2(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 1.8, founded : "+bad.getValue(),bad.getValue().equals(1.8));
    }
        /**
     * control the content and the value of the bad
     * @param bad
    ...
    private void controlBad3(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 5.4, founded : "+bad.getValue(),bad.getValue().equals(5.4));
    }
    ...
    private void controlGlobalBad(BaseActivityData bad){
        /*
        assertTrue("BaseActivityDataCode error. Expected : ActivityCategoryCode.AC_11, founded : "+bad.getKey(),bad.getKey().equals(BaseActivityDataCode.ActivityCategoryCode.AC_11));
