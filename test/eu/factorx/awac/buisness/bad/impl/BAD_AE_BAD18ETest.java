...
/*
 * Test for bad AE_BAD18E
*/
@Component
public class BAD_AE_BAD18ETest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD18E baseActivityDataAE_BAD18E;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD18E.getBaseActivityData(questionSetAnswers);
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 33750.0, founded : "+bad.getValue(),bad.getValue().equals(33750.0));
    }
