...
public class BAD_AE_BAD31ITest{
    ...
    private List<AnswerLineDTO> buildAnswerA264(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A244",1);
                list.add(new AnswerLineDTO("A264",0.05, identifier, mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A244",2);
                list.add(new AnswerLineDTO("A264",0.2, identifier, mapRepetition2 ));
    ...
    private void controlBad2(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 180000.0, founded : "+bad.getValue(),bad.getValue().equals(180000.0));
    }
