...
/*
 * Test for bad AE_BAD12F
*/
@Component
public class BAD_AE_BAD12FTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD12F baseActivityDataAE_BAD12F;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA100());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD12F.getBaseActivityData(questionSetAnswers);
     ...
     * question : A100
     */
    private List<AnswerLineDTO> buildAnswerA100(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A100",24000.0, identifier, mapRepetition1 ));
