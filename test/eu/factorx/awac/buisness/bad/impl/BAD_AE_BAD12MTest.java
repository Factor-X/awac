...
/*
 * Test for bad AE_BAD12M
*/
@Component
public class BAD_AE_BAD12MTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD12M baseActivityDataAE_BAD12M;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA107());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD12M.getBaseActivityData(questionSetAnswers);
     ...
     * question : A107
     */
    private List<AnswerLineDTO> buildAnswerA107(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A107",600.0, identifier, mapRepetition1  , UnitCode.U5170.getKey()  ));
