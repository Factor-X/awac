...
/*
 * Test for bad AE_BAD12I
*/
@Component
public class BAD_AE_BAD12ITest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD12I baseActivityDataAE_BAD12I;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA103());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD12I.getBaseActivityData(questionSetAnswers);
     ...
     * question : A103
     */
    private List<AnswerLineDTO> buildAnswerA103(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A103",15000.0, identifier, mapRepetition1 ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 15000.0, founded : "+bad.getValue(),bad.getValue().equals(15000.0));
    }
