...
/*
 * Test for bad AE_BAD15C
*/
@Component
public class BAD_AE_BAD15CTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD15C baseActivityDataAE_BAD15C;
    ...
    public void test(long siteId){
        ...
        //add answers
                ...
                answerLineDTOList.addAll(buildAnswerA122());
                answerLineDTOList.addAll(buildAnswerA123());
                answerLineDTOList.addAll(buildAnswerA124());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD15C.getBaseActivityData(questionSetAnswers);
     ...
     * question : A122
     */
    private List<AnswerLineDTO> buildAnswerA122(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A122",0.25, identifier, mapRepetition1 ));
     ...
     * question : A123
     */
    private List<AnswerLineDTO> buildAnswerA123(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A123",false, identifier, mapRepetition1 ));
     ...
     * question : A124
     */
    private List<AnswerLineDTO> buildAnswerA124(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A124",false, identifier, mapRepetition1 ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 30000.0, founded : "+bad.getValue(),bad.getValue().equals(30000.0));
    }
