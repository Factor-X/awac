...
/*
 * Test for bad AE_BAD12N
*/
@Component
public class BAD_AE_BAD12NTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD12N baseActivityDataAE_BAD12N;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA108());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD12N.getBaseActivityData(questionSetAnswers);
     ...
     * question : A108
     */
    private List<AnswerLineDTO> buildAnswerA108(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A108",22.0, identifier, mapRepetition1  , UnitCode.U5325.getKey()  ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 22000.0, founded : "+bad.getValue(),bad.getValue().equals(22000.0));
    }
