...
/*
 * Test for bad AE_BAD33A
*/
@Component
public class BAD_AE_BAD33ATest{
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA276());
                answerLineDTOList.addAll(buildAnswerA277());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD33A.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(3.6, false);
                mapResult.put(7.2, false);
                mapResult.put(10.8, false);
     ...
     * question : A276
     */
    private List<AnswerLineDTO> buildAnswerA276(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A275",1);
                mapRepetition1.put("A244",1);
                mapRepetition1.put("A273",1);
                list.add(new AnswerLineDTO("A276","AS_38", identifier, mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A275",2);
                mapRepetition2.put("A244",1);
                mapRepetition2.put("A273",1);
                list.add(new AnswerLineDTO("A276","AS_37", identifier, mapRepetition2 ));
                //add repetition
        Map<String, Integer> mapRepetition3 = new HashMap<>();
                mapRepetition3.put("A275",1);
                mapRepetition3.put("A244",1);
                mapRepetition3.put("A273",2);
                list.add(new AnswerLineDTO("A276","AS_36", identifier, mapRepetition3 ));
     ...
     * question : A277
     */
    private List<AnswerLineDTO> buildAnswerA277(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                ...
                mapRepetition1.put("A244",1);
                mapRepetition1.put("A273",1);
                list.add(new AnswerLineDTO("A277",1000.0, identifier, mapRepetition1  , UnitCode.U5156.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A275",2);
                mapRepetition2.put("A244",1);
                mapRepetition2.put("A273",1);
                list.add(new AnswerLineDTO("A277",2000.0, identifier, mapRepetition2  , UnitCode.U5156.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition3 = new HashMap<>();
                mapRepetition3.put("A275",1);
                mapRepetition3.put("A244",1);
                mapRepetition3.put("A273",2);
                list.add(new AnswerLineDTO("A277",3000.0, identifier, mapRepetition3  , UnitCode.U5156.getKey()  ));
    ...
    private void controlGlobalBad(BaseActivityData bad){
        /*
        assertTrue("BaseActivityDataCode error. Expected : ActivityCategoryCode.AC_10, founded : "+bad.getKey(),bad.getKey().equals(BaseActivityDataCode.ActivityCategoryCode.AC_10));
