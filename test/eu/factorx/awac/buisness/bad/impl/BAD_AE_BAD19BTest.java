...
/*
 * Test for bad AE_BAD19B
*/
@Component
public class BAD_AE_BAD19BTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD19B baseActivityDataAE_BAD19B;
    ...
    public void test(long siteId){
        ...
        //add answers
                ...
                answerLineDTOList.addAll(buildAnswerA169());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD19B.getBaseActivityData(questionSetAnswers);
     ...
     * question : A169
     */
    private List<AnswerLineDTO> buildAnswerA169(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A164",1);
                list.add(new AnswerLineDTO("A169",4500.0, identifier, mapRepetition1  , UnitCode.U5156.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A164",2);
                list.add(new AnswerLineDTO("A169",1000.0, identifier, mapRepetition2  , UnitCode.U5156.getKey()  ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 4500.0, founded : "+bad.getValue(),bad.getValue().equals(4500.0));
    }
        /**
     * control the content and the value of the bad
     * @param bad
    ...
    private void controlBad2(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 1000.0, founded : "+bad.getValue(),bad.getValue().equals(1000.0));
    }
