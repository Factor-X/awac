...
/*
 * Test for bad AE_BAD12D
*/
@Component
public class BAD_AE_BAD12DTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD12D baseActivityDataAE_BAD12D;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA98());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD12D.getBaseActivityData(questionSetAnswers);
     ...
     * question : A98
     */
    private List<AnswerLineDTO> buildAnswerA98(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A98",9000.0, identifier, mapRepetition1 ));
