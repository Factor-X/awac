...
/*
 * Test for bad AE_BAD12H
*/
@Component
public class BAD_AE_BAD12HTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD12H baseActivityDataAE_BAD12H;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA102());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD12H.getBaseActivityData(questionSetAnswers);
     ...
     * question : A102
     */
    private List<AnswerLineDTO> buildAnswerA102(){
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 10000.0, founded : "+bad.getValue(),bad.getValue().equals(10000.0));
    }
