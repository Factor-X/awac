...
/*
 * Test for bad AE_BAD12K
*/
@Component
public class BAD_AE_BAD12KTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD12K baseActivityDataAE_BAD12K;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA105());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD12K.getBaseActivityData(questionSetAnswers);
     ...
     * question : A105
     */
    private List<AnswerLineDTO> buildAnswerA105(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A105",25.0, identifier, mapRepetition1 ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 25.0, founded : "+bad.getValue(),bad.getValue().equals(25.0));
    }
