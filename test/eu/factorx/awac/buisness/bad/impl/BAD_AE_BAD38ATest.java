...
/*
 * Test for bad AE_BAD38A
*/
@Component
public class BAD_AE_BAD38ATest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD38A baseActivityDataAE_BAD38A;
    ...
    public void test(long siteId){
        ...
        //add answers
                ...
                answerLineDTOList.addAll(buildAnswerA326());
                answerLineDTOList.addAll(buildAnswerA327());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD38A.getBaseActivityData(questionSetAnswers);
    ...
    private List<AnswerLineDTO> buildAnswerA323(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                ...
                list.add(new AnswerLineDTO("A323","mini", identifier, mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A322",2);
                list.add(new AnswerLineDTO("A323","hyper", identifier, mapRepetition2 ));
     ...
     * question : A326
     */
    private List<AnswerLineDTO> buildAnswerA326(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A324",1);
                mapRepetition1.put("A322",1);
                list.add(new AnswerLineDTO("A326","AS_5", identifier, mapRepetition1 ));
     ...
     * question : A327
     */
    private List<AnswerLineDTO> buildAnswerA327(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A324",1);
                mapRepetition1.put("A322",1);
                list.add(new AnswerLineDTO("A327",1000.0, identifier, mapRepetition1  , UnitCode.U5156.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A324",1);
                mapRepetition2.put("A322",2);
                list.add(new AnswerLineDTO("A327",10000.0, identifier, mapRepetition2  , UnitCode.U5156.getKey()  ));
    ...
    private List<AnswerLineDTO> buildAnswerA324(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A322",1);
                list.add(new AnswerLineDTO("A324",20.0, identifier, mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A322",2);
                list.add(new AnswerLineDTO("A324",3.0, identifier, mapRepetition2 ));
    ...
    private void controlBad2(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 36.0, founded : "+bad.getValue(),bad.getValue().equals(36.0));
    }
