...
public class BAD_AE_BAD6ATest{
    ...
    private List<AnswerLineDTO> buildAnswerA23(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A23",2500.0, identifier, mapRepetition1  , UnitCode.U5156.getKey()  ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 0.5, founded : "+bad.getValue(),bad.getValue().equals(0.5));
    }
