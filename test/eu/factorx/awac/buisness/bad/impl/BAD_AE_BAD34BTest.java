...
/*
 * Test for bad AE_BAD34B
*/
@Component
public class BAD_AE_BAD34BTest{
    ...
    public void test(long siteId){
        ...
        //add answers
                ...
                answerLineDTOList.addAll(buildAnswerA287());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD34B.getBaseActivityData(questionSetAnswers);
     ...
     * question : A287
     */
    private List<AnswerLineDTO> buildAnswerA287(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A244",1);
                list.add(new AnswerLineDTO("A287",2500.0, identifier, mapRepetition1  , UnitCode.U5156.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A244",2);
                list.add(new AnswerLineDTO("A287",6000.0, identifier, mapRepetition2  , UnitCode.U5156.getKey()  ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 2500.0, founded : "+bad.getValue(),bad.getValue().equals(2500.0));
    }
        /**
     * control the content and the value of the bad
     * @param bad
    ...
    private void controlBad2(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 6000.0, founded : "+bad.getValue(),bad.getValue().equals(6000.0));
    }
