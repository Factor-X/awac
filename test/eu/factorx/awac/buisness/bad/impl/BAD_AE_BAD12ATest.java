...
/*
 * Test for bad AE_BAD12A
*/
@Component
public class BAD_AE_BAD12ATest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD12A baseActivityDataAE_BAD12A;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA95());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD12A.getBaseActivityData(questionSetAnswers);
     ...
     * question : A95
     */
    private List<AnswerLineDTO> buildAnswerA95(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A95",120000.0, identifier, mapRepetition1 ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 120000.0, founded : "+bad.getValue(),bad.getValue().equals(120000.0));
    }
