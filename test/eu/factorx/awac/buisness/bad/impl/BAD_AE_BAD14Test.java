...
/*
 * Test for bad AE_BAD14
*/
@Component
public class BAD_AE_BAD14Test{
    ...
    @Autowired
    private BaseActivityDataAE_BAD14 baseActivityDataAE_BAD14;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA118());
                answerLineDTOList.addAll(buildAnswerA117());
                answerLineDTOList.addAll(buildAnswerA119());
                answerLineDTOList.addAll(buildAnswerA120());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD14.getBaseActivityData(questionSetAnswers);
     ...
     * question : A118
     */
    private List<AnswerLineDTO> buildAnswerA118(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A115",2);
                list.add(new AnswerLineDTO("A118","AT_19", identifier, mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A115",1);
                list.add(new AnswerLineDTO("A118","AT_18", identifier, mapRepetition2 ));
     ...
     * question : A117
     */
    private List<AnswerLineDTO> buildAnswerA117(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A115",1);
                list.add(new AnswerLineDTO("A117","AS_174", identifier, mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A115",2);
                list.add(new AnswerLineDTO("A117","AS_173", identifier, mapRepetition2 ));
     ...
     * question : A119
     */
    private List<AnswerLineDTO> buildAnswerA119(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A115",1);
                list.add(new AnswerLineDTO("A119",10.0, identifier, mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A115",2);
                list.add(new AnswerLineDTO("A119",48.0, identifier, mapRepetition2 ));
     ...
     * question : A120
     */
    private List<AnswerLineDTO> buildAnswerA120(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A115",1);
                list.add(new AnswerLineDTO("A120",9500.0, identifier, mapRepetition1  , UnitCode.U5106.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A115",2);
                list.add(new AnswerLineDTO("A120",900.0, identifier, mapRepetition2  , UnitCode.U5106.getKey()  ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 95000.0, founded : "+bad.getValue(),bad.getValue().equals(95000.0));
    }
        /**
     * control the content and the value of the bad
     * @param bad
    ...
    private void controlBad2(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 43200.0, founded : "+bad.getValue(),bad.getValue().equals(43200.0));
    }
