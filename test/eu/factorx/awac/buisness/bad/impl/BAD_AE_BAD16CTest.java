...
/*
 * Test for bad AE_BAD16C
*/
@Component
public class BAD_AE_BAD16CTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD16C baseActivityDataAE_BAD16C;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA135());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD16C.getBaseActivityData(questionSetAnswers);
     ...
     * question : A135
     */
    private List<AnswerLineDTO> buildAnswerA135(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A135",3.5, identifier, mapRepetition1  , UnitCode.U5122.getKey()  ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 3500.0, founded : "+bad.getValue(),bad.getValue().equals(3500.0));
    }
