...
/*
 * Test for bad AE_BAD12J
*/
@Component
public class BAD_AE_BAD12JTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD12J baseActivityDataAE_BAD12J;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA104());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD12J.getBaseActivityData(questionSetAnswers);
     ...
     * question : A104
     */
    private List<AnswerLineDTO> buildAnswerA104(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A104",1500.0, identifier, mapRepetition1 ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 1500.0, founded : "+bad.getValue(),bad.getValue().equals(1500.0));
    }
