...
/*
 * Test for bad AE_BAD32F
*/
@Component
public class BAD_AE_BAD32FTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD32F baseActivityDataAE_BAD32F;
    ...
    public void test(long siteId){
        ...
        //add answers
                ...
                answerLineDTOList.addAll(buildAnswerA267());
                answerLineDTOList.addAll(buildAnswerA268());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD32F.getBaseActivityData(questionSetAnswers);
     ...
     * question : A267
     */
    private List<AnswerLineDTO> buildAnswerA267(){
     ...
     * question : A268
     */
    private List<AnswerLineDTO> buildAnswerA268(){
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 1500000.0, founded : "+bad.getValue(),bad.getValue().equals(1500000.0));
    }
