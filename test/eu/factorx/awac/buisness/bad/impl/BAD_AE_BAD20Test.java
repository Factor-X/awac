...
/*
 * Test for bad AE_BAD20
*/
@Component
public class BAD_AE_BAD20Test{
    ...
    @Autowired
    private BaseActivityDataAE_BAD20 baseActivityDataAE_BAD20;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA176());
                answerLineDTOList.addAll(buildAnswerA178());
                answerLineDTOList.addAll(buildAnswerA177());
                answerLineDTOList.addAll(buildAnswerA179());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD20.getBaseActivityData(questionSetAnswers);
     ...
     * question : A176
     */
    private List<AnswerLineDTO> buildAnswerA176(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A175",1);
                list.add(new AnswerLineDTO("A176","plastique", identifier, mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A175",2);
                list.add(new AnswerLineDTO("A176","papier", identifier, mapRepetition2 ));
     ...
     * question : A178
     */
    private List<AnswerLineDTO> buildAnswerA178(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A175",1);
                list.add(new AnswerLineDTO("A178","AT_37", identifier, mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A175",2);
                list.add(new AnswerLineDTO("A178","AT_42", identifier, mapRepetition2 ));
     ...
     * question : A177
     */
    private List<AnswerLineDTO> buildAnswerA177(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A175",1);
                list.add(new AnswerLineDTO("A177","AS_187", identifier, mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A175",2);
                list.add(new AnswerLineDTO("A177","AS_186", identifier, mapRepetition2 ));
     ...
     * question : A179
     */
    private List<AnswerLineDTO> buildAnswerA179(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A175",1);
                list.add(new AnswerLineDTO("A179",2300.0, identifier, mapRepetition1  , UnitCode.U5133.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A175",2);
                list.add(new AnswerLineDTO("A179",12.0, identifier, mapRepetition2  , UnitCode.U5135.getKey()  ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 2.3, founded : "+bad.getValue(),bad.getValue().equals(2.3));
    }
        /**
     * control the content and the value of the bad
     * @param bad
    ...
    private void controlBad2(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 12.0, founded : "+bad.getValue(),bad.getValue().equals(12.0));
    }
