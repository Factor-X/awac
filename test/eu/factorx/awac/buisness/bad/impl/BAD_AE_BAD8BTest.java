...
/*
 * Test for bad AE_BAD8B
*/
@Component
public class BAD_AE_BAD8BTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD8B baseActivityDataAE_BAD8B;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA60());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD8B.getBaseActivityData(questionSetAnswers);
     ...
     * question : A60
     */
    private List<AnswerLineDTO> buildAnswerA60(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A60",4.5, identifier, mapRepetition1  , UnitCode.U5122.getKey()  ));
