...
/*
 * Test for bad AE_BAD8C
*/
@Component
public class BAD_AE_BAD8CTest{
    ...
    @Autowired
    private BaseActivityDataAE_BAD8C baseActivityDataAE_BAD8C;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA61());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD8C.getBaseActivityData(questionSetAnswers);
     ...
     * question : A61
     */
    private List<AnswerLineDTO> buildAnswerA61(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("A61",400.0, identifier, mapRepetition1  , UnitCode.U5126.getKey()  ));
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 400.0, founded : "+bad.getValue(),bad.getValue().equals(400.0));
    }
