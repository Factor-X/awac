...
/*
 * Test for bad AE_BAD5
*/
@Component
public class BAD_AE_BAD5Test{
    ...
    @Autowired
    private BaseActivityDataAE_BAD5 baseActivityDataAE_BAD5;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerA43());
                answerLineDTOList.addAll(buildAnswerA44());
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD5.getBaseActivityData(questionSetAnswers);
     ...
     * question : A43
     */
    private List<AnswerLineDTO> buildAnswerA43(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A42",1);
                list.add(new AnswerLineDTO("A43","AS_81", identifier, mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A42",2);
                list.add(new AnswerLineDTO("A43","AS_140", identifier, mapRepetition2 ));
     ...
     * question : A44
     */
    private List<AnswerLineDTO> buildAnswerA44(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("A42",1);
                list.add(new AnswerLineDTO("A44",2.3, identifier, mapRepetition1  , UnitCode.U5133.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("A42",2);
                list.add(new AnswerLineDTO("A44",0.05, identifier, mapRepetition2  , UnitCode.U5135.getKey()  ));
    ...
    private void controlBad2(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 50.0, founded : "+bad.getValue(),bad.getValue().equals(50.0));
    }
