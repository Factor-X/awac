...
/*
 * Test for bad AC_BAD11B
*/
@Component
public class BAD_AC_BAD11BTest{
    ...
    @Autowired
    private BaseActivityDataAC_BAD11B baseActivityDataAC_BAD11B;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerAC95());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD11B.getBaseActivityData(questionSetAnswers);
     ...
     * question : AC95
     */
    private List<AnswerLineDTO> buildAnswerAC95(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("AC95",122000.0, identifier, mapRepetition1 ));
