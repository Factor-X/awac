...
/*
 * Test for bad AE_BAD32D
*/
@Component
public class BAD_AE_BAD32DTest{
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAE_BAD32D.getBaseActivityData(questionSetAnswers);
    ...
    private void controlBad1(BaseActivityData bad){
        ...
        //control value
        assertTrue("Value error : expected : 160000.0, founded : "+bad.getValue(),bad.getValue().equals(160000.0));
    }
