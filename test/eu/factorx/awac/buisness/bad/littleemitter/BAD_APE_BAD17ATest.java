...
/*
 * Test for bad APE_BAD17A
*/
@Component
public class BAD_APE_BAD17ATest{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD17A baseActivityDataAPE_BAD17A;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD17A.getBaseActivityData(questionSetAnswers);
