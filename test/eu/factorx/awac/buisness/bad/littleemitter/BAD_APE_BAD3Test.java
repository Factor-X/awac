...
/*
 * Test for bad APE_BAD3
*/
@Component
public class BAD_APE_BAD3Test{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD3 baseActivityDataAPE_BAD3;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD3.getBaseActivityData(questionSetAnswers);
