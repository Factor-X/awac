...
/*
 * Test for bad APE_BAD16C
*/
@Component
public class BAD_APE_BAD16CTest{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD16C baseActivityDataAPE_BAD16C;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD16C.getBaseActivityData(questionSetAnswers);
    ...
    private List<AnswerLineDTO> buildAnswerAP150(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("AP144",1);
                list.add(new AnswerLineDTO("AP150",20.0,  mapRepetition1 ));
