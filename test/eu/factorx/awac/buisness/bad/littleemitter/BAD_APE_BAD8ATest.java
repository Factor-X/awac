...
/*
 * Test for bad APE_BAD8A
*/
@Component
public class BAD_APE_BAD8ATest{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD8A baseActivityDataAPE_BAD8A;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD8A.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(2112.0, false);
    ...
    private List<AnswerLineDTO> buildAnswerAP96(){
        ...
        List<AnswerLineDTO> list = new ArrayList<>();
                 ...
                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("AP96",80.0,  mapRepetition1 ));
