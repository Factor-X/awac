...
/*
 * Test for bad APE_BAD9
*/
@Component
public class BAD_APE_BAD9Test{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD9 baseActivityDataAPE_BAD9;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD9.getBaseActivityData(questionSetAnswers);
