...
/*
 * Test for bad APE_BAD11
*/
@Component
public class BAD_APE_BAD11Test{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD11 baseActivityDataAPE_BAD11;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD11.getBaseActivityData(questionSetAnswers);
