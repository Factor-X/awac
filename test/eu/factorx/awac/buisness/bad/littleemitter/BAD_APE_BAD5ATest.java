...
/*
 * Test for bad APE_BAD5A
*/
@Component
public class BAD_APE_BAD5ATest{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD5A baseActivityDataAPE_BAD5A;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD5A.getBaseActivityData(questionSetAnswers);
