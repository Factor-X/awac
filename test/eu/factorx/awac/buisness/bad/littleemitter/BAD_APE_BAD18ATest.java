...
/*
 * Test for bad APE_BAD18A
*/
@Component
public class BAD_APE_BAD18ATest{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD18A baseActivityDataAPE_BAD18A;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD18A.getBaseActivityData(questionSetAnswers);
