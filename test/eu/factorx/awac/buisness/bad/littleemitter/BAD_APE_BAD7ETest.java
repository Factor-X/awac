...
/*
 * Test for bad APE_BAD7E
*/
@Component
public class BAD_APE_BAD7ETest{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD7E baseActivityDataAPE_BAD7E;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD7E.getBaseActivityData(questionSetAnswers);
