...
/*
 * Test for bad APE_BAD8E
*/
@Component
public class BAD_APE_BAD8ETest{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD8E baseActivityDataAPE_BAD8E;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD8E.getBaseActivityData(questionSetAnswers);
    ...
    private List<AnswerLineDTO> buildAnswerAP100(){
        ...
        List<AnswerLineDTO> list = new ArrayList<>();
                 ...
                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("AP100",10.0,  mapRepetition1 ));
