...
/*
 * Test for bad APE_BAD16B
*/
@Component
public class BAD_APE_BAD16BTest{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD16B baseActivityDataAPE_BAD16B;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD16B.getBaseActivityData(questionSetAnswers);
    ...
    private List<AnswerLineDTO> buildAnswerAP148(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("AP144",1);
                list.add(new AnswerLineDTO("AP148",50.0,  mapRepetition1 ));
