...
/*
 * Test for bad APE_BAD6
*/
@Component
public class BAD_APE_BAD6Test{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD6 baseActivityDataAPE_BAD6;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD6.getBaseActivityData(questionSetAnswers);
