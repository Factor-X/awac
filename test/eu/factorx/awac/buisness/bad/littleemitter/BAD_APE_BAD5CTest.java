...
/*
 * Test for bad APE_BAD5C
*/
@Component
public class BAD_APE_BAD5CTest{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD5C baseActivityDataAPE_BAD5C;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD5C.getBaseActivityData(questionSetAnswers);
