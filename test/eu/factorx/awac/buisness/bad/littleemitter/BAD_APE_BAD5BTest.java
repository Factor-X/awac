...
/*
 * Test for bad APE_BAD5B
*/
@Component
public class BAD_APE_BAD5BTest{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD5B baseActivityDataAPE_BAD5B;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD5B.getBaseActivityData(questionSetAnswers);
