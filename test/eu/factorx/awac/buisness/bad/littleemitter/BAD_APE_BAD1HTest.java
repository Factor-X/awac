...
/*
 * Test for bad APE_BAD1H
*/
@Component
public class BAD_APE_BAD1HTest{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD1H baseActivityDataAPE_BAD1H;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD1H.getBaseActivityData(questionSetAnswers);
    ...
    private List<AnswerLineDTO> buildAnswerAP30(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("AP17",2);
                list.add(new AnswerLineDTO("AP30",1.0,  mapRepetition1  , UnitCode.U5169.getKey()  ));
