...
/*
 * Test for bad APE_BAD14
*/
@Component
public class BAD_APE_BAD14Test{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD14 baseActivityDataAPE_BAD14;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD14.getBaseActivityData(questionSetAnswers);
