...
/*
 * Test for bad APE_BAD19D
*/
@Component
public class BAD_APE_BAD19DTest{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD19D baseActivityDataAPE_BAD19D;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD19D.getBaseActivityData(questionSetAnswers);
