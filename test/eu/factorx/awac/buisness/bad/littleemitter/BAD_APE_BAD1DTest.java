...
/*
 * Test for bad APE_BAD1D
*/
@Component
public class BAD_APE_BAD1DTest{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD1D baseActivityDataAPE_BAD1D;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD1D.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(3846.153846, false);
