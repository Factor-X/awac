...
/*
 * Test for bad APE_BAD18B
*/
@Component
public class BAD_APE_BAD18BTest{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD18B baseActivityDataAPE_BAD18B;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD18B.getBaseActivityData(questionSetAnswers);
