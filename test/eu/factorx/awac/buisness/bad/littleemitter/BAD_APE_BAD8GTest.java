...
/*
 * Test for bad APE_BAD8G
*/
@Component
public class BAD_APE_BAD8GTest{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD8G baseActivityDataAPE_BAD8G;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD8G.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(2200.0, false);
