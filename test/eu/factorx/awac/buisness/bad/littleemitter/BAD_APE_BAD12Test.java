...
/*
 * Test for bad APE_BAD12
*/
@Component
public class BAD_APE_BAD12Test{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD12 baseActivityDataAPE_BAD12;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD12.getBaseActivityData(questionSetAnswers);
