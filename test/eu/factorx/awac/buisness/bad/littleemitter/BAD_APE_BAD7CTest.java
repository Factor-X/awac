...
/*
 * Test for bad APE_BAD7C
*/
@Component
public class BAD_APE_BAD7CTest{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD7C baseActivityDataAPE_BAD7C;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD7C.getBaseActivityData(questionSetAnswers);
