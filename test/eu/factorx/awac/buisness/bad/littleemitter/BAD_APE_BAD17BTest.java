...
/*
 * Test for bad APE_BAD17B
*/
@Component
public class BAD_APE_BAD17BTest{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD17B baseActivityDataAPE_BAD17B;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD17B.getBaseActivityData(questionSetAnswers);
    ...
    private List<AnswerLineDTO> buildAnswerAP156(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("AP152",1);
                list.add(new AnswerLineDTO("AP156",50.0,  mapRepetition1 ));
