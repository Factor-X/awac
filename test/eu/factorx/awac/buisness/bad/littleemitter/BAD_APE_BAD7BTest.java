...
/*
 * Test for bad APE_BAD7B
*/
@Component
public class BAD_APE_BAD7BTest{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD7B baseActivityDataAPE_BAD7B;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD7B.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(320.0, false);
