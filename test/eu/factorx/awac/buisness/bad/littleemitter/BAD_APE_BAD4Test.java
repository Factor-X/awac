...
/*
 * Test for bad APE_BAD4
*/
@Component
public class BAD_APE_BAD4Test{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD4 baseActivityDataAPE_BAD4;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD4.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(0.02, false);
