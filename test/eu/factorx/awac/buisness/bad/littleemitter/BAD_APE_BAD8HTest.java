...
/*
 * Test for bad APE_BAD8H
*/
@Component
public class BAD_APE_BAD8HTest{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD8H baseActivityDataAPE_BAD8H;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD8H.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(880.0, false);
    ...
    private List<AnswerLineDTO> buildAnswerAP102(){
        ...
        List<AnswerLineDTO> list = new ArrayList<>();
                 ...
                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("AP102",10.0,  mapRepetition1 ));
