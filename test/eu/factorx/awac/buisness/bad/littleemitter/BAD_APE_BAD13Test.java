...
/*
 * Test for bad APE_BAD13
*/
@Component
public class BAD_APE_BAD13Test{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD13 baseActivityDataAPE_BAD13;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD13.getBaseActivityData(questionSetAnswers);
