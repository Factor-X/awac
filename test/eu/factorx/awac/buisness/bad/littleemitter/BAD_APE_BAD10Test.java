...
/*
 * Test for bad APE_BAD10
*/
@Component
public class BAD_APE_BAD10Test{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD10 baseActivityDataAPE_BAD10;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD10.getBaseActivityData(questionSetAnswers);
