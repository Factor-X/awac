...
/*
 * Test for bad APE_BAD1J
*/
@Component
public class BAD_APE_BAD1JTest{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD1J baseActivityDataAPE_BAD1J;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD1J.getBaseActivityData(questionSetAnswers);
