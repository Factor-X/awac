...
/*
 * Test for bad APE_BAD19A
*/
@Component
public class BAD_APE_BAD19ATest{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD19A baseActivityDataAPE_BAD19A;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD19A.getBaseActivityData(questionSetAnswers);
