...
/*
 * Test for bad APE_BAD19F
*/
@Component
public class BAD_APE_BAD19FTest{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD19F baseActivityDataAPE_BAD19F;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD19F.getBaseActivityData(questionSetAnswers);
