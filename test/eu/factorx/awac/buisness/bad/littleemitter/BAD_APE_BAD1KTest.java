...
/*
 * Test for bad APE_BAD1K
*/
@Component
public class BAD_APE_BAD1KTest{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD1K baseActivityDataAPE_BAD1K;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD1K.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(27.0, false);
    ...
    private List<AnswerLineDTO> buildAnswerAP501(){
        ...
        List<AnswerLineDTO> list = new ArrayList<>();
                 ...
                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("AP18",3);
                list.add(new AnswerLineDTO("AP501",15000.0,  mapRepetition1  , UnitCode.U5155.getKey()  ));
