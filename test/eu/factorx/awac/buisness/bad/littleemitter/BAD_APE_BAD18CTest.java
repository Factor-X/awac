...
/*
 * Test for bad APE_BAD18C
*/
@Component
public class BAD_APE_BAD18CTest{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD18C baseActivityDataAPE_BAD18C;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD18C.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(40.0, false);
