...
/*
 * Test for bad APE_BAD2B
*/
@Component
public class BAD_APE_BAD2BTest{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD2B baseActivityDataAPE_BAD2B;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD2B.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(12.6, false);
    ...
    private List<AnswerLineDTO> buildAnswerAP46(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("AP46",7000.0,  mapRepetition1  , UnitCode.U5169.getKey()  ));
    ...
    private List<AnswerLineDTO> buildAnswerAP47(){
        ...
        List<AnswerLineDTO> list = new ArrayList<>();
                 ...
                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("AP47",2.0,  mapRepetition1  , UnitCode.U5169.getKey()  ));
