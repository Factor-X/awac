...
/*
 * Test for bad APE_BAD19B
*/
@Component
public class BAD_APE_BAD19BTest{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD19B baseActivityDataAPE_BAD19B;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD19B.getBaseActivityData(questionSetAnswers);
