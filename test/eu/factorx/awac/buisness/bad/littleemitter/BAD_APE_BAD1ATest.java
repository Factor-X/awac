...
/*
 * Test for bad APE_BAD1A
*/
@Component
public class BAD_APE_BAD1ATest{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD1A baseActivityDataAPE_BAD1A;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD1A.getBaseActivityData(questionSetAnswers);
