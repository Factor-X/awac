...
/*
 * Test for bad APE_BAD1I
*/
@Component
public class BAD_APE_BAD1ITest{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD1I baseActivityDataAPE_BAD1I;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD1I.getBaseActivityData(questionSetAnswers);
