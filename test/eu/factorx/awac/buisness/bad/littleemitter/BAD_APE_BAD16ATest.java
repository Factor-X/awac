...
/*
 * Test for bad APE_BAD16A
*/
@Component
public class BAD_APE_BAD16ATest{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD16A baseActivityDataAPE_BAD16A;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD16A.getBaseActivityData(questionSetAnswers);
    ...
    private List<AnswerLineDTO> buildAnswerAP149(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("AP144",1);
                list.add(new AnswerLineDTO("AP149",30.0,  mapRepetition1 ));
