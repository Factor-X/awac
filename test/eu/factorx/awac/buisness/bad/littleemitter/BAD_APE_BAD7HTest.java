...
/*
 * Test for bad APE_BAD7H
*/
@Component
public class BAD_APE_BAD7HTest{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD7H baseActivityDataAPE_BAD7H;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD7H.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(98000.0, false);
