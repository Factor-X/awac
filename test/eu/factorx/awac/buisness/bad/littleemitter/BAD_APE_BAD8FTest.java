...
/*
 * Test for bad APE_BAD8F
*/
@Component
public class BAD_APE_BAD8FTest{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD8F baseActivityDataAPE_BAD8F;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD8F.getBaseActivityData(questionSetAnswers);
    ...
    private List<AnswerLineDTO> buildAnswerAP101(){
        ...
        List<AnswerLineDTO> list = new ArrayList<>();
                 ...
                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("AP101",10.0,  mapRepetition1 ));
