...
/*
 * Test for bad APE_BAD17C
*/
@Component
public class BAD_APE_BAD17CTest{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD17C baseActivityDataAPE_BAD17C;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD17C.getBaseActivityData(questionSetAnswers);
    ...
    private List<AnswerLineDTO> buildAnswerAP158(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("AP152",1);
                list.add(new AnswerLineDTO("AP158",20.0,  mapRepetition1 ));
