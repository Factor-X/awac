...
/*
 * Test for bad APE_BAD7A
*/
@Component
public class BAD_APE_BAD7ATest{
    ...
    @Autowired
    private BaseActivityDataAPE_BAD7A baseActivityDataAPE_BAD7A;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAPE_BAD7A.getBaseActivityData(questionSetAnswers);
