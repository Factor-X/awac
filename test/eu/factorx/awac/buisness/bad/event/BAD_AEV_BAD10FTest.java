...
/*
 * Test for bad AEV_BAD10F
*/
@Component
public class BAD_AEV_BAD10FTest{
    ...
    @Autowired
    private BaseActivityDataAEV_BAD10F baseActivityDataAEV_BAD10F;
    ...
    public void test(long productId){
        ...
        List<BaseActivityData> bads = baseActivityDataAEV_BAD10F.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(0.04, false);
