...
/*
 * Test for bad AEV_BAD11C
*/
@Component
public class BAD_AEV_BAD11CTest{
    ...
    @Autowired
    private BaseActivityDataAEV_BAD11C baseActivityDataAEV_BAD11C;
    ...
    public void test(long productId){
        ...
        List<BaseActivityData> bads = baseActivityDataAEV_BAD11C.getBaseActivityData(questionSetAnswers);
