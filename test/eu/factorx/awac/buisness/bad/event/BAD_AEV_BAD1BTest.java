...
/*
 * Test for bad AEV_BAD1B
*/
@Component
public class BAD_AEV_BAD1BTest{
    ...
    @Autowired
    private BaseActivityDataAEV_BAD1B baseActivityDataAEV_BAD1B;
    ...
    public void test(long productId){
        ...
        List<BaseActivityData> bads = baseActivityDataAEV_BAD1B.getBaseActivityData(questionSetAnswers);
