...
/*
 * Test for bad AEV_BAD1A
*/
@Component
public class BAD_AEV_BAD1ATest{
    ...
    @Autowired
    private BaseActivityDataAEV_BAD1A baseActivityDataAEV_BAD1A;
    ...
    public void test(long productId){
        ...
        List<BaseActivityData> bads = baseActivityDataAEV_BAD1A.getBaseActivityData(questionSetAnswers);
