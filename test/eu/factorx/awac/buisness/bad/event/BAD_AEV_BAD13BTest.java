...
/*
 * Test for bad AEV_BAD13B
*/
@Component
public class BAD_AEV_BAD13BTest{
    ...
    @Autowired
    private BaseActivityDataAEV_BAD13B baseActivityDataAEV_BAD13B;
    ...
    public void test(long productId){
        ...
        List<BaseActivityData> bads = baseActivityDataAEV_BAD13B.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(158.0, false);
