...
/*
 * Test for bad AEV_BAD5
*/
@Component
public class BAD_AEV_BAD5Test{
    ...
    @Autowired
    private BaseActivityDataAEV_BAD5 baseActivityDataAEV_BAD5;
    ...
    public void test(long productId){
        ...
        List<BaseActivityData> bads = baseActivityDataAEV_BAD5.getBaseActivityData(questionSetAnswers);
