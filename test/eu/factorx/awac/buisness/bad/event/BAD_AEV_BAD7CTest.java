...
/*
 * Test for bad AEV_BAD7C
*/
@Component
public class BAD_AEV_BAD7CTest{
    ...
    @Autowired
    private BaseActivityDataAEV_BAD7C baseActivityDataAEV_BAD7C;
    ...
    public void test(long productId){
        ...
        List<BaseActivityData> bads = baseActivityDataAEV_BAD7C.getBaseActivityData(questionSetAnswers);
