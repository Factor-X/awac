...
/*
 * Test for bad AEV_BAD1D
*/
@Component
public class BAD_AEV_BAD1DTest{
    ...
    @Autowired
    private BaseActivityDataAEV_BAD1D baseActivityDataAEV_BAD1D;
    ...
    public void test(long productId){
        ...
        List<BaseActivityData> bads = baseActivityDataAEV_BAD1D.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(500000.0, false);
