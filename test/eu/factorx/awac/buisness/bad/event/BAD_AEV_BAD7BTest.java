...
/*
 * Test for bad AEV_BAD7B
*/
@Component
public class BAD_AEV_BAD7BTest{
    ...
    @Autowired
    private BaseActivityDataAEV_BAD7B baseActivityDataAEV_BAD7B;
    ...
    public void test(long productId){
        ...
        List<BaseActivityData> bads = baseActivityDataAEV_BAD7B.getBaseActivityData(questionSetAnswers);
