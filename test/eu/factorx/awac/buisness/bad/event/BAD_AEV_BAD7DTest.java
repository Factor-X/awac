...
/*
 * Test for bad AEV_BAD7D
*/
@Component
public class BAD_AEV_BAD7DTest{
    ...
    @Autowired
    private BaseActivityDataAEV_BAD7D baseActivityDataAEV_BAD7D;
    ...
    public void test(long productId){
        ...
        List<BaseActivityData> bads = baseActivityDataAEV_BAD7D.getBaseActivityData(questionSetAnswers);
