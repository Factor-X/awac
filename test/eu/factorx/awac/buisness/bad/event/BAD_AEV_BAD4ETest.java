...
/*
 * Test for bad AEV_BAD4E
*/
@Component
public class BAD_AEV_BAD4ETest{
    ...
    @Autowired
    private BaseActivityDataAEV_BAD4E baseActivityDataAEV_BAD4E;
    ...
    public void test(long productId){
        ...
        List<BaseActivityData> bads = baseActivityDataAEV_BAD4E.getBaseActivityData(questionSetAnswers);
    ...
    private List<AnswerLineDTO> buildAnswerAEV51(){
        ...
        List<AnswerLineDTO> list = new ArrayList<>();
                 ...
                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("AEV51",10.0,  mapRepetition1 ));
