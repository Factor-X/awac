...
/*
 * Test for bad AEV_BAD1C
*/
@Component
public class BAD_AEV_BAD1CTest{
    ...
    @Autowired
    private BaseActivityDataAEV_BAD1C baseActivityDataAEV_BAD1C;
    ...
    public void test(long productId){
        ...
        List<BaseActivityData> bads = baseActivityDataAEV_BAD1C.getBaseActivityData(questionSetAnswers);
