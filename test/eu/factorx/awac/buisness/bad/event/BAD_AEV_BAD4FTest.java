...
/*
 * Test for bad AEV_BAD4F
*/
@Component
public class BAD_AEV_BAD4FTest{
    ...
    @Autowired
    private BaseActivityDataAEV_BAD4F baseActivityDataAEV_BAD4F;
    ...
    public void test(long productId){
        ...
        List<BaseActivityData> bads = baseActivityDataAEV_BAD4F.getBaseActivityData(questionSetAnswers);
    ...
    private List<AnswerLineDTO> buildAnswerAEV52(){
        ...
        List<AnswerLineDTO> list = new ArrayList<>();
                 ...
                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("AEV52",5.0,  mapRepetition1 ));
