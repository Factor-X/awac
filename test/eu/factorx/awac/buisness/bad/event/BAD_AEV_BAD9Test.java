...
/*
 * Test for bad AEV_BAD9
*/
@Component
public class BAD_AEV_BAD9Test{
    ...
    @Autowired
    private BaseActivityDataAEV_BAD9 baseActivityDataAEV_BAD9;
    ...
    public void test(long productId){
        ...
        List<BaseActivityData> bads = baseActivityDataAEV_BAD9.getBaseActivityData(questionSetAnswers);
