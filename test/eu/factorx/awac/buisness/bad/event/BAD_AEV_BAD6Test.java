...
/*
 * Test for bad AEV_BAD6
*/
@Component
public class BAD_AEV_BAD6Test{
    ...
    @Autowired
    private BaseActivityDataAEV_BAD6 baseActivityDataAEV_BAD6;
    ...
    public void test(long productId){
        ...
        List<BaseActivityData> bads = baseActivityDataAEV_BAD6.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(640.0, false);
