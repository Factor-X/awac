...
/*
 * Test for bad AEV_BAD13C
*/
@Component
public class BAD_AEV_BAD13CTest{
    ...
    @Autowired
    private BaseActivityDataAEV_BAD13C baseActivityDataAEV_BAD13C;
    ...
    public void test(long productId){
        ...
        List<BaseActivityData> bads = baseActivityDataAEV_BAD13C.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(520.0, false);
