...
/*
 * Test for bad AEV_BAD1F
*/
@Component
public class BAD_AEV_BAD1FTest{
    ...
    @Autowired
    private BaseActivityDataAEV_BAD1F baseActivityDataAEV_BAD1F;
    ...
    public void test(long productId){
        ...
        List<BaseActivityData> bads = baseActivityDataAEV_BAD1F.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(2.0, false);
