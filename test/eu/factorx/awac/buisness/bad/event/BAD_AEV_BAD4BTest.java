...
/*
 * Test for bad AEV_BAD4B
*/
@Component
public class BAD_AEV_BAD4BTest{
    ...
    @Autowired
    private BaseActivityDataAEV_BAD4B baseActivityDataAEV_BAD4B;
    ...
    public void test(long productId){
        ...
        List<BaseActivityData> bads = baseActivityDataAEV_BAD4B.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(144.0, false);
    ...
    private List<AnswerLineDTO> buildAnswerAEV46(){
        ...
        List<AnswerLineDTO> list = new ArrayList<>();
                 ...
                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("AEV46",30.0,  mapRepetition1 ));
