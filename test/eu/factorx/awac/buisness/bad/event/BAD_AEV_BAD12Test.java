...
/*
 * Test for bad AEV_BAD12
*/
@Component
public class BAD_AEV_BAD12Test{
    ...
    @Autowired
    private BaseActivityDataAEV_BAD12 baseActivityDataAEV_BAD12;
    ...
    public void test(long productId){
        ...
        List<BaseActivityData> bads = baseActivityDataAEV_BAD12.getBaseActivityData(questionSetAnswers);
