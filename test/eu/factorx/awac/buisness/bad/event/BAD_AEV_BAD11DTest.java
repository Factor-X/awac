...
/*
 * Test for bad AEV_BAD11D
*/
@Component
public class BAD_AEV_BAD11DTest{
    ...
    @Autowired
    private BaseActivityDataAEV_BAD11D baseActivityDataAEV_BAD11D;
    ...
    public void test(long productId){
        ...
        List<BaseActivityData> bads = baseActivityDataAEV_BAD11D.getBaseActivityData(questionSetAnswers);
