...
/*
 * Test for bad AEV_BAD7E
*/
@Component
public class BAD_AEV_BAD7ETest{
    ...
    @Autowired
    private BaseActivityDataAEV_BAD7E baseActivityDataAEV_BAD7E;
    ...
    public void test(long productId){
        ...
        List<BaseActivityData> bads = baseActivityDataAEV_BAD7E.getBaseActivityData(questionSetAnswers);
