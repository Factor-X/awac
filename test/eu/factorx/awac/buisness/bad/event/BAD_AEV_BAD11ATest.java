...
/*
 * Test for bad AEV_BAD11A
*/
@Component
public class BAD_AEV_BAD11ATest{
    ...
    @Autowired
    private BaseActivityDataAEV_BAD11A baseActivityDataAEV_BAD11A;
    ...
    public void test(long productId){
        ...
        List<BaseActivityData> bads = baseActivityDataAEV_BAD11A.getBaseActivityData(questionSetAnswers);
