...
/*
 * Test for bad AEV_BAD10D
*/
@Component
public class BAD_AEV_BAD10DTest{
    ...
    @Autowired
    private BaseActivityDataAEV_BAD10D baseActivityDataAEV_BAD10D;
    ...
    public void test(long productId){
        ...
        List<BaseActivityData> bads = baseActivityDataAEV_BAD10D.getBaseActivityData(questionSetAnswers);
