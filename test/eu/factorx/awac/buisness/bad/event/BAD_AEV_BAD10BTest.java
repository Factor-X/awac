...
/*
 * Test for bad AEV_BAD10B
*/
@Component
public class BAD_AEV_BAD10BTest{
    ...
    @Autowired
    private BaseActivityDataAEV_BAD10B baseActivityDataAEV_BAD10B;
    ...
    public void test(long productId){
        ...
        List<BaseActivityData> bads = baseActivityDataAEV_BAD10B.getBaseActivityData(questionSetAnswers);
