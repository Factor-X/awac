...
/*
 * Test for bad AEV_BAD13A
*/
@Component
public class BAD_AEV_BAD13ATest{
    ...
    @Autowired
    private BaseActivityDataAEV_BAD13A baseActivityDataAEV_BAD13A;
    ...
    public void test(long productId){
        ...
        List<BaseActivityData> bads = baseActivityDataAEV_BAD13A.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(280.0, false);
