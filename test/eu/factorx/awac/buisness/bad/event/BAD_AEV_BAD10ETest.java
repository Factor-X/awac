...
/*
 * Test for bad AEV_BAD10E
*/
@Component
public class BAD_AEV_BAD10ETest{
    ...
    @Autowired
    private BaseActivityDataAEV_BAD10E baseActivityDataAEV_BAD10E;
    ...
    public void test(long productId){
        ...
        List<BaseActivityData> bads = baseActivityDataAEV_BAD10E.getBaseActivityData(questionSetAnswers);
