...
/*
 * Test for bad AEV_BAD3B
*/
@Component
public class BAD_AEV_BAD3BTest{
    ...
    @Autowired
    private BaseActivityDataAEV_BAD3B baseActivityDataAEV_BAD3B;
    ...
    public void test(long productId){
        ...
        List<BaseActivityData> bads = baseActivityDataAEV_BAD3B.getBaseActivityData(questionSetAnswers);
