...
/*
 * Test for bad AEV_BAD2A
*/
@Component
public class BAD_AEV_BAD2ATest{
    ...
    @Autowired
    private BaseActivityDataAEV_BAD2A baseActivityDataAEV_BAD2A;
    ...
    public void test(long productId){
        ...
        List<BaseActivityData> bads = baseActivityDataAEV_BAD2A.getBaseActivityData(questionSetAnswers);
