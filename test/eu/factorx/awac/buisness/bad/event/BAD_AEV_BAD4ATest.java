...
/*
 * Test for bad AEV_BAD4A
*/
@Component
public class BAD_AEV_BAD4ATest{
    ...
    @Autowired
    private BaseActivityDataAEV_BAD4A baseActivityDataAEV_BAD4A;
    ...
    public void test(long productId){
        ...
        List<BaseActivityData> bads = baseActivityDataAEV_BAD4A.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(336.0, false);
