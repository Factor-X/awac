...
/*
 * Test for bad AEV_BAD7A
*/
@Component
public class BAD_AEV_BAD7ATest{
    ...
    @Autowired
    private BaseActivityDataAEV_BAD7A baseActivityDataAEV_BAD7A;
    ...
    public void test(long productId){
        ...
        List<BaseActivityData> bads = baseActivityDataAEV_BAD7A.getBaseActivityData(questionSetAnswers);
