...
/*
 * Test for bad AEV_BAD10A
*/
@Component
public class BAD_AEV_BAD10ATest{
    ...
    @Autowired
    private BaseActivityDataAEV_BAD10A baseActivityDataAEV_BAD10A;
    ...
    public void test(long productId){
        ...
        List<BaseActivityData> bads = baseActivityDataAEV_BAD10A.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(150.0, false);
