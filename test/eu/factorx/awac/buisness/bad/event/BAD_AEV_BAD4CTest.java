...
/*
 * Test for bad AEV_BAD4C
*/
@Component
public class BAD_AEV_BAD4CTest{
    ...
    @Autowired
    private BaseActivityDataAEV_BAD4C baseActivityDataAEV_BAD4C;
    ...
    public void test(long productId){
        ...
        List<BaseActivityData> bads = baseActivityDataAEV_BAD4C.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(960.0, false);
    ...
    private List<AnswerLineDTO> buildAnswerAEV48(){
        ...
        List<AnswerLineDTO> list = new ArrayList<>();
                 ...
                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("AEV48",20.0,  mapRepetition1 ));
