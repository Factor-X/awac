...
/*
 * Test for bad AEV_BAD1E
*/
@Component
public class BAD_AEV_BAD1ETest{
    ...
    @Autowired
    private BaseActivityDataAEV_BAD1E baseActivityDataAEV_BAD1E;
    ...
    public void test(long productId){
        ...
        List<BaseActivityData> bads = baseActivityDataAEV_BAD1E.getBaseActivityData(questionSetAnswers);
