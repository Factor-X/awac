...
/*
 * Test for bad AEV_BAD4G
*/
@Component
public class BAD_AEV_BAD4GTest{
    ...
    @Autowired
    private BaseActivityDataAEV_BAD4G baseActivityDataAEV_BAD4G;
    ...
    public void test(long productId){
        ...
        List<BaseActivityData> bads = baseActivityDataAEV_BAD4G.getBaseActivityData(questionSetAnswers);
    ...
    private List<AnswerLineDTO> buildAnswerAEV53(){
        ...
        List<AnswerLineDTO> list = new ArrayList<>();
                 ...
                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("AEV53",5.0,  mapRepetition1 ));
