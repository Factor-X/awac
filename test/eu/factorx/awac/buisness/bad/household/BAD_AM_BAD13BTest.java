...
/*
 * Test for bad AM_BAD13B
*/
@Component
public class BAD_AM_BAD13BTest{
    ...
    @Autowired
    private BaseActivityDataAM_BAD13B baseActivityDataAM_BAD13B;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAM_BAD13B.getBaseActivityData(questionSetAnswers);
