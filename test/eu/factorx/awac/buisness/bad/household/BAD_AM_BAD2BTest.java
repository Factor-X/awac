...
/*
 * Test for bad AM_BAD2B
*/
@Component
public class BAD_AM_BAD2BTest{
    ...
    @Autowired
    private BaseActivityDataAM_BAD2B baseActivityDataAM_BAD2B;
    ...
    public void test(long siteId){
        ...
        //add answers
                ...
                answerLineDTOList.addAll(buildAnswerAM53());
        ...
        List<BaseActivityData> bads = baseActivityDataAM_BAD2B.getBaseActivityData(questionSetAnswers);
     ...
     * question : AM53
     */
    private List<AnswerLineDTO> buildAnswerAM53(){
