...
/*
 * Test for bad AM_BAD10
*/
@Component
public class BAD_AM_BAD10Test{
    ...
    @Autowired
    private BaseActivityDataAM_BAD10 baseActivityDataAM_BAD10;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAM_BAD10.getBaseActivityData(questionSetAnswers);
