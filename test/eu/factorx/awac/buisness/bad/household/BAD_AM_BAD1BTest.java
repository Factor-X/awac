...
/*
 * Test for bad AM_BAD1B
*/
@Component
public class BAD_AM_BAD1BTest{
    ...
    @Autowired
    private BaseActivityDataAM_BAD1B baseActivityDataAM_BAD1B;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAM_BAD1B.getBaseActivityData(questionSetAnswers);
