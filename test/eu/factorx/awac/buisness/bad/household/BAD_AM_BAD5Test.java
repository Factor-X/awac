...
/*
 * Test for bad AM_BAD5
*/
@Component
public class BAD_AM_BAD5Test{
    ...
    @Autowired
    private BaseActivityDataAM_BAD5 baseActivityDataAM_BAD5;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAM_BAD5.getBaseActivityData(questionSetAnswers);
