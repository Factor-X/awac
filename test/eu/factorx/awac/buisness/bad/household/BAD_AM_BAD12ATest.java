...
/*
 * Test for bad AM_BAD12A
*/
@Component
public class BAD_AM_BAD12ATest{
    ...
    @Autowired
    private BaseActivityDataAM_BAD12A baseActivityDataAM_BAD12A;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAM_BAD12A.getBaseActivityData(questionSetAnswers);
