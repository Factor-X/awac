...
/*
 * Test for bad AM_BAD7
*/
@Component
public class BAD_AM_BAD7Test{
    ...
    @Autowired
    private BaseActivityDataAM_BAD7 baseActivityDataAM_BAD7;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAM_BAD7.getBaseActivityData(questionSetAnswers);
