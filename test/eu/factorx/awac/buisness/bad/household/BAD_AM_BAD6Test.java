...
/*
 * Test for bad AM_BAD6
*/
@Component
public class BAD_AM_BAD6Test{
    ...
    @Autowired
    private BaseActivityDataAM_BAD6 baseActivityDataAM_BAD6;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAM_BAD6.getBaseActivityData(questionSetAnswers);
