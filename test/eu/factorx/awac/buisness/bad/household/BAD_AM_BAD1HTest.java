...
/*
 * Test for bad AM_BAD1H
*/
@Component
public class BAD_AM_BAD1HTest{
    ...
    @Autowired
    private BaseActivityDataAM_BAD1H baseActivityDataAM_BAD1H;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAM_BAD1H.getBaseActivityData(questionSetAnswers);
    ...
    private List<AnswerLineDTO> buildAnswerAM38(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                ...
                list.add(new AnswerLineDTO("AM38",1.0,  mapRepetition1  , UnitCode.U5169.getKey()  ));
