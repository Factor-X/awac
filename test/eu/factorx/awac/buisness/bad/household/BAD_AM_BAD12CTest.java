...
/*
 * Test for bad AM_BAD12C
*/
@Component
public class BAD_AM_BAD12CTest{
    ...
    @Autowired
    private BaseActivityDataAM_BAD12C baseActivityDataAM_BAD12C;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAM_BAD12C.getBaseActivityData(questionSetAnswers);
