...
/*
 * Test for bad AM_BAD1F
*/
@Component
public class BAD_AM_BAD1FTest{
    ...
    @Autowired
    private BaseActivityDataAM_BAD1F baseActivityDataAM_BAD1F;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAM_BAD1F.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(285714.2857, false);
    ...
    private List<AnswerLineDTO> buildAnswerAM36(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                ...
                list.add(new AnswerLineDTO("AM36",3.5,  mapRepetition1  , UnitCode.U5169.getKey()  ));
