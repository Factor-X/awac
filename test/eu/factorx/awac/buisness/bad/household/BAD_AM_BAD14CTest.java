...
/*
 * Test for bad AM_BAD14C
*/
@Component
public class BAD_AM_BAD14CTest{
    ...
    @Autowired
    private BaseActivityDataAM_BAD14C baseActivityDataAM_BAD14C;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAM_BAD14C.getBaseActivityData(questionSetAnswers);
