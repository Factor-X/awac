...
/*
 * Test for bad AM_BAD11
*/
@Component
public class BAD_AM_BAD11Test{
    ...
    @Autowired
    private BaseActivityDataAM_BAD11 baseActivityDataAM_BAD11;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAM_BAD11.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(1.248, false);
