...
/*
 * Test for bad AM_BAD14B
*/
@Component
public class BAD_AM_BAD14BTest{
    ...
    @Autowired
    private BaseActivityDataAM_BAD14B baseActivityDataAM_BAD14B;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAM_BAD14B.getBaseActivityData(questionSetAnswers);
    ...
    private List<AnswerLineDTO> buildAnswerAM178(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("AM178",2000.0,  mapRepetition1  , UnitCode.U5169.getKey()  ));
