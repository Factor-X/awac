...
/*
 * Test for bad AM_BAD8
*/
@Component
public class BAD_AM_BAD8Test{
    ...
    @Autowired
    private BaseActivityDataAM_BAD8 baseActivityDataAM_BAD8;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAM_BAD8.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(4400.0, false);
