...
/*
 * Test for bad AM_BAD1C
*/
@Component
public class BAD_AM_BAD1CTest{
    ...
    @Autowired
    private BaseActivityDataAM_BAD1C baseActivityDataAM_BAD1C;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAM_BAD1C.getBaseActivityData(questionSetAnswers);
