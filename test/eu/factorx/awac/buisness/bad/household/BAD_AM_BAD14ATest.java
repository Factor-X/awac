...
/*
 * Test for bad AM_BAD14A
*/
@Component
public class BAD_AM_BAD14ATest{
    ...
    @Autowired
    private BaseActivityDataAM_BAD14A baseActivityDataAM_BAD14A;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAM_BAD14A.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(26.0, false);
