...
/*
 * Test for bad AM_BAD2A
*/
@Component
public class BAD_AM_BAD2ATest{
    ...
    @Autowired
    private BaseActivityDataAM_BAD2A baseActivityDataAM_BAD2A;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAM_BAD2A.getBaseActivityData(questionSetAnswers);
