...
/*
 * Test for bad AM_BAD1D
*/
@Component
public class BAD_AM_BAD1DTest{
    ...
    @Autowired
    private BaseActivityDataAM_BAD1D baseActivityDataAM_BAD1D;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAM_BAD1D.getBaseActivityData(questionSetAnswers);
    ...
    private List<AnswerLineDTO> buildAnswerAM34(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("AM26",4);
                list.add(new AnswerLineDTO("AM34",0.6,  mapRepetition1  , UnitCode.U5169.getKey()  ));
