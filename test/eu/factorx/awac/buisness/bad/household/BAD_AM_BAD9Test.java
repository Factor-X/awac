...
/*
 * Test for bad AM_BAD9
*/
@Component
public class BAD_AM_BAD9Test{
    ...
    @Autowired
    private BaseActivityDataAM_BAD9 baseActivityDataAM_BAD9;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAM_BAD9.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(2100.0, false);
