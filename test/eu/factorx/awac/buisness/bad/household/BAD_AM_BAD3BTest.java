...
/*
 * Test for bad AM_BAD3B
*/
@Component
public class BAD_AM_BAD3BTest{
    ...
    @Autowired
    private BaseActivityDataAM_BAD3B baseActivityDataAM_BAD3B;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAM_BAD3B.getBaseActivityData(questionSetAnswers);
