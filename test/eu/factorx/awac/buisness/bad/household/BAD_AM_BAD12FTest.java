...
/*
 * Test for bad AM_BAD12F
*/
@Component
public class BAD_AM_BAD12FTest{
    ...
    @Autowired
    private BaseActivityDataAM_BAD12F baseActivityDataAM_BAD12F;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAM_BAD12F.getBaseActivityData(questionSetAnswers);
