...
/*
 * Test for bad AM_BAD12B
*/
@Component
public class BAD_AM_BAD12BTest{
    ...
    @Autowired
    private BaseActivityDataAM_BAD12B baseActivityDataAM_BAD12B;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAM_BAD12B.getBaseActivityData(questionSetAnswers);
