...
/*
 * Test for bad AM_BAD12E
*/
@Component
public class BAD_AM_BAD12ETest{
    ...
    @Autowired
    private BaseActivityDataAM_BAD12E baseActivityDataAM_BAD12E;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAM_BAD12E.getBaseActivityData(questionSetAnswers);
