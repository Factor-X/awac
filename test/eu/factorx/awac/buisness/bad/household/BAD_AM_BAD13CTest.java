...
/*
 * Test for bad AM_BAD13C
*/
@Component
public class BAD_AM_BAD13CTest{
    ...
    @Autowired
    private BaseActivityDataAM_BAD13C baseActivityDataAM_BAD13C;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAM_BAD13C.getBaseActivityData(questionSetAnswers);
