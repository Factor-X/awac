...
/*
 * Test for bad AM_BAD2F
*/
@Component
public class BAD_AM_BAD2FTest{
    ...
    @Autowired
    private BaseActivityDataAM_BAD2F baseActivityDataAM_BAD2F;
    ...
    public void test(long siteId){
        ...
        //add answers
                ...
                answerLineDTOList.addAll(buildAnswerAM58());
        ...
        List<BaseActivityData> bads = baseActivityDataAM_BAD2F.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(1666.666667, false);
     ...
     * question : AM58
     */
    private List<AnswerLineDTO> buildAnswerAM58(){
