...
/*
 * Test for bad AM_BAD13A
*/
@Component
public class BAD_AM_BAD13ATest{
    ...
    @Autowired
    private BaseActivityDataAM_BAD13A baseActivityDataAM_BAD13A;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAM_BAD13A.getBaseActivityData(questionSetAnswers);
