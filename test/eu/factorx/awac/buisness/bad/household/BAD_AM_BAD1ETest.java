...
/*
 * Test for bad AM_BAD1E
*/
@Component
public class BAD_AM_BAD1ETest{
    ...
    @Autowired
    private BaseActivityDataAM_BAD1E baseActivityDataAM_BAD1E;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAM_BAD1E.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(333333.3333333333, false);
    ...
    private List<AnswerLineDTO> buildAnswerAM35(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                ...
                list.add(new AnswerLineDTO("AM35",3.0,  mapRepetition1  , UnitCode.U5169.getKey()  ));
