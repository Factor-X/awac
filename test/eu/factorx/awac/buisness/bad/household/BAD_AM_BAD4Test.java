...
/*
 * Test for bad AM_BAD4
*/
@Component
public class BAD_AM_BAD4Test{
    ...
    @Autowired
    private BaseActivityDataAM_BAD4 baseActivityDataAM_BAD4;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAM_BAD4.getBaseActivityData(questionSetAnswers);
