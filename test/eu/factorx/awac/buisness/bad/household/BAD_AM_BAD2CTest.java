...
/*
 * Test for bad AM_BAD2C
*/
@Component
public class BAD_AM_BAD2CTest{
    ...
    @Autowired
    private BaseActivityDataAM_BAD2C baseActivityDataAM_BAD2C;
    ...
    public void test(long siteId){
        ...
        //add answers
                ...
                answerLineDTOList.addAll(buildAnswerAM55());
        ...
        List<BaseActivityData> bads = baseActivityDataAM_BAD2C.getBaseActivityData(questionSetAnswers);
     ...
     * question : AM55
     */
    private List<AnswerLineDTO> buildAnswerAM55(){
