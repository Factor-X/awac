...
/*
 * Test for bad AM_BAD1J
*/
@Component
public class BAD_AM_BAD1JTest{
    ...
    @Autowired
    private BaseActivityDataAM_BAD1J baseActivityDataAM_BAD1J;
    ...
    public void test(long organizationId){
        ...
        List<BaseActivityData> bads = baseActivityDataAM_BAD1J.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(3333.333333, false);
    ...
    private List<AnswerLineDTO> buildAnswerAM40(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                ...
                list.add(new AnswerLineDTO("AM40",0.3,  mapRepetition1  , UnitCode.U5169.getKey()  ));
