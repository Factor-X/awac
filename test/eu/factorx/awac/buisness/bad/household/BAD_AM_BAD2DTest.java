...
/*
 * Test for bad AM_BAD2D
*/
@Component
public class BAD_AM_BAD2DTest{
    ...
    @Autowired
    private BaseActivityDataAM_BAD2D baseActivityDataAM_BAD2D;
    ...
    public void test(long siteId){
        ...
        //add answers
                ...
                answerLineDTOList.addAll(buildAnswerAM54());
                answerLineDTOList.addAll(buildAnswerAM56());
        ...
        List<BaseActivityData> bads = baseActivityDataAM_BAD2D.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(147058.8235, false);
     ...
     * question : AM54
     */
    private List<AnswerLineDTO> buildAnswerAM54(){
     ...
     * question : AM56
     */
    private List<AnswerLineDTO> buildAnswerAM56(){
