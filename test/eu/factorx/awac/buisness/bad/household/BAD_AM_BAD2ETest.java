...
/*
 * Test for bad AM_BAD2E
*/
@Component
public class BAD_AM_BAD2ETest{
    ...
    @Autowired
    private BaseActivityDataAM_BAD2E baseActivityDataAM_BAD2E;
    ...
    public void test(long siteId){
        ...
        //add answers
                ...
                answerLineDTOList.addAll(buildAnswerAM57());
        ...
        List<BaseActivityData> bads = baseActivityDataAM_BAD2E.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(138888.8889, false);
     ...
     * question : AM57
     */
    private List<AnswerLineDTO> buildAnswerAM57(){
