...
/*
 * Test for bad AM_BAD1A
*/
@Component
public class BAD_AM_BAD1ATest{
    ...
    @Autowired
    private BaseActivityDataAM_BAD1A baseActivityDataAM_BAD1A;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAM_BAD1A.getBaseActivityData(questionSetAnswers);
