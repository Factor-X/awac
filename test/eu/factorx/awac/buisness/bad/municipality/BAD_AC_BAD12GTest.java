...
import eu.factorx.awac.service.knowledge.activity.contributor.municipality.BaseActivityDataAC_BAD12G;
...
/*
 * Test for bad AC_BAD12G
*/
@Component
public class BAD_AC_BAD12GTest {
    ...
    @Autowired
    private BaseActivityDataAC_BAD12G baseActivityDataAC_BAD12G;
    ...
    public void test(long siteId) {
        ...
        //add answers
        answerLineDTOList.addAll(buildAnswerAC105());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD12G.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
        mapResult.put(4452.0, false);
     ...
     * question : AC105
     */
    private List<AnswerLineDTO> buildAnswerAC105() {

        List<AnswerLineDTO> list = new ArrayList<>();

        //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
        list.add(new AnswerLineDTO("AC105", 4452.0, identifier, mapRepetition1));
