...
import eu.factorx.awac.service.knowledge.activity.contributor.municipality.BaseActivityDataAC_BAD4;
...
/*
 * Test for bad AC_BAD4
*/
@Component
public class BAD_AC_BAD4Test {
    ...
    @Autowired
    private BaseActivityDataAC_BAD4 baseActivityDataAC_BAD4;
    ...
    public void test(long siteId) {
        ...
        answerLineDTOList.addAll(buildAnswerAC40());
        answerLineDTOList.addAll(buildAnswerAC41());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD4.getBaseActivityData(questionSetAnswers);
     ...
     * question : AC40
     */
    private List<AnswerLineDTO> buildAnswerAC40() {

        List<AnswerLineDTO> list = new ArrayList<>();

        //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
        mapRepetition1.put("AC39", 1);
        mapRepetition1.put("AC10", 1);
        list.add(new AnswerLineDTO("AC40", "AS_113", identifier, mapRepetition1));
        //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
        mapRepetition2.put("AC39", 2);
        mapRepetition2.put("AC10", 1);
        list.add(new AnswerLineDTO("AC40", "AS_140", identifier, mapRepetition2));
     ...
     * question : AC41
     */
    private List<AnswerLineDTO> buildAnswerAC41() {
        ...
        mapRepetition1.put("AC39", 1);
        mapRepetition1.put("AC10", 1);
        list.add(new AnswerLineDTO("AC41", 1.1, identifier, mapRepetition1, UnitCode.U5133.getKey()));
        //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
        mapRepetition2.put("AC39", 2);
        mapRepetition2.put("AC10", 1);
        list.add(new AnswerLineDTO("AC41", 156.0, identifier, mapRepetition2, UnitCode.U5134.getKey()));
