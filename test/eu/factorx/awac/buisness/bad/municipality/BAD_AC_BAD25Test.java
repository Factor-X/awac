...
/*
 * Test for bad AC_BAD25
*/
@Component
public class BAD_AC_BAD25Test{
    ...
    @Autowired
    private BaseActivityDataAC_BAD25 baseActivityDataAC_BAD25;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerAC615());
                answerLineDTOList.addAll(buildAnswerAC617());
                answerLineDTOList.addAll(buildAnswerAC616());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD25.getBaseActivityData(questionSetAnswers);
     ...
     * question : AC615
     */
    private List<AnswerLineDTO> buildAnswerAC615(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("AC613",1);
                list.add(new AnswerLineDTO("AC615","AS_5",  mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("AC613",2);
                list.add(new AnswerLineDTO("AC615","AS_162",  mapRepetition2 ));
     ...
     * question : AC617
     */
    private List<AnswerLineDTO> buildAnswerAC617(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("AC613",1);
                list.add(new AnswerLineDTO("AC617",80000.0,  mapRepetition1  , UnitCode.U5170.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("AC613",2);
                list.add(new AnswerLineDTO("AC617",150000.0,  mapRepetition2  , UnitCode.U5170.getKey()  ));
     ...
     * question : AC616
     */
    private List<AnswerLineDTO> buildAnswerAC616(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("AC613",1);
                list.add(new AnswerLineDTO("AC616",1.4,  mapRepetition1  , UnitCode.U5170.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("AC613",2);
                list.add(new AnswerLineDTO("AC616",1.6,  mapRepetition2  , UnitCode.U5170.getKey()  ));
