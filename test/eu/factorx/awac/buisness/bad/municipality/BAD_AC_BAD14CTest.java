...
import eu.factorx.awac.service.knowledge.activity.contributor.municipality.BaseActivityDataAC_BAD14C;
...
/*
 * Test for bad AC_BAD14C
*/
@Component
public class BAD_AC_BAD14CTest {
    ...
    @Autowired
    private BaseActivityDataAC_BAD14C baseActivityDataAC_BAD14C;
    ...
    public void test(long siteId) {
        ...
        //add answers
        answerLineDTOList.addAll(buildAnswerAC117());
        answerLineDTOList.addAll(buildAnswerAC118());
        answerLineDTOList.addAll(buildAnswerAC120());
        answerLineDTOList.addAll(buildAnswerAC128());
        answerLineDTOList.addAll(buildAnswerAC127());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD14C.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
        mapResult.put(3200.0, false);
     ...
     * question : AC117
     */
    private List<AnswerLineDTO> buildAnswerAC117() {
        ...
        list.add(new AnswerLineDTO("AC117", "plastique", identifier, mapRepetition1));
        //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
        mapRepetition2.put("AC117", 2);
        list.add(new AnswerLineDTO("AC117", "agro", identifier, mapRepetition2));
     ...
     * question : AC118
     */
    private List<AnswerLineDTO> buildAnswerAC118() {
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
        mapRepetition1.put("AC117", 1);
        list.add(new AnswerLineDTO("AC118", "AT_62", identifier, mapRepetition1));
        //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
        mapRepetition2.put("AC117", 2);
        list.add(new AnswerLineDTO("AC118", "AT_67", identifier, mapRepetition2));
     ...
     * question : AC120
     */
    private List<AnswerLineDTO> buildAnswerAC120() {
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
        mapRepetition1.put("AC117", 1);
        list.add(new AnswerLineDTO("AC120", "AS_226", identifier, mapRepetition1));
     ...
     * question : AC128
     */
    private List<AnswerLineDTO> buildAnswerAC128() {
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
        mapRepetition1.put("AC117", 1);
        list.add(new AnswerLineDTO("AC128", 4000.0, identifier, mapRepetition1, UnitCode.U5135.getKey()));
        //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
        mapRepetition2.put("AC117", 2);
        list.add(new AnswerLineDTO("AC128", 5500.0, identifier, mapRepetition2, UnitCode.U5133.getKey()));
     ...
     * question : AC127
     */
    private List<AnswerLineDTO> buildAnswerAC127() {
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
        mapRepetition1.put("AC117", 1);
        list.add(new AnswerLineDTO("AC127", 0.2, identifier, mapRepetition1));
