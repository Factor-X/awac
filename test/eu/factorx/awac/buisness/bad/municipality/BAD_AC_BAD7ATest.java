...
import eu.factorx.awac.service.knowledge.activity.contributor.municipality.BaseActivityDataAC_BAD7A;
...
/*
 * Test for bad AC_BAD7A
*/
@Component
public class BAD_AC_BAD7ATest {
    ...
    @Autowired
    private BaseActivityDataAC_BAD7A baseActivityDataAC_BAD7A;
    ...
    public void test(long siteId) {
        ...
        answerLineDTOList.addAll(buildAnswerAC59());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD7A.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
        mapResult.put(0.001, false);
        mapResult.put(6.2, false);
     ...
     * question : AC59
     */
    private List<AnswerLineDTO> buildAnswerAC59() {
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
        mapRepetition1.put("AC56", 1);
        list.add(new AnswerLineDTO("AC59", 3600.0, identifier, mapRepetition1, UnitCode.U5156.getKey()));
        //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
        mapRepetition2.put("AC56", 2);
        list.add(new AnswerLineDTO("AC59", 6.2, identifier, mapRepetition2, UnitCode.U5156.getKey()));
