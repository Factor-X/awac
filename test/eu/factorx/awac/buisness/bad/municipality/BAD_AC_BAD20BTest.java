...
/*
 * Test for bad AC_BAD20B
*/
@Component
public class BAD_AC_BAD20BTest{
    ...
    @Autowired
    private BaseActivityDataAC_BAD20B baseActivityDataAC_BAD20B;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerAC504());
                answerLineDTOList.addAll(buildAnswerAC503());
                answerLineDTOList.addAll(buildAnswerAC505());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD20B.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(23000.0, false);
     ...
     * question : AC504
     */
    private List<AnswerLineDTO> buildAnswerAC504(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("AC504",23.0,  mapRepetition1  , UnitCode.U5122.getKey()  ));
     ...
     * question : AC503
     */
    private List<AnswerLineDTO> buildAnswerAC503(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("AC503",32.0,  mapRepetition1  , UnitCode.U5122.getKey()  ));
     ...
     * question : AC505
     */
    private List<AnswerLineDTO> buildAnswerAC505(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("AC505",2500.0,  mapRepetition1  , UnitCode.U5126.getKey()  ));
