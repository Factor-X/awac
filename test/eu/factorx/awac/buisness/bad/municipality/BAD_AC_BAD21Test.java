...
/*
 * Test for bad AC_BAD21
*/
@Component
public class BAD_AC_BAD21Test{
    ...
    @Autowired
    private BaseActivityDataAC_BAD21 baseActivityDataAC_BAD21;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerAC509());
                answerLineDTOList.addAll(buildAnswerAC510());
                answerLineDTOList.addAll(buildAnswerAC511());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD21.getBaseActivityData(questionSetAnswers);
     ...
     * question : AC509
     */
    private List<AnswerLineDTO> buildAnswerAC509(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("AC507",1);
                list.add(new AnswerLineDTO("AC509","AS_5",  mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("AC507",2);
                list.add(new AnswerLineDTO("AC509","AS_163",  mapRepetition2 ));
     ...
     * question : AC510
     */
    private List<AnswerLineDTO> buildAnswerAC510(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("AC507",1);
                list.add(new AnswerLineDTO("AC510",4.5,  mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("AC507",2);
                list.add(new AnswerLineDTO("AC510",12.0,  mapRepetition2 ));
     ...
     * question : AC511
     */
    private List<AnswerLineDTO> buildAnswerAC511(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("AC507",1);
                list.add(new AnswerLineDTO("AC511",245000.0,  mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("AC507",2);
                list.add(new AnswerLineDTO("AC511",120000.0,  mapRepetition2 ));
