...
import eu.factorx.awac.service.knowledge.activity.contributor.municipality.BaseActivityDataAC_BAD15B;
...
/*
 * Test for bad AC_BAD15B
*/
@Component
public class BAD_AC_BAD15BTest {
    ...
    @Autowired
    private BaseActivityDataAC_BAD15B baseActivityDataAC_BAD15B;
    ...
    public void test(long siteId) {
        ...
        answerLineDTOList.addAll(buildAnswerAC135());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD15B.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
        mapResult.put(452.0, false);
     ...
     * question : AC135
     */
    private List<AnswerLineDTO> buildAnswerAC135() {

        List<AnswerLineDTO> list = new ArrayList<>();

        //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
        mapRepetition1.put("AC132", 2);
        list.add(new AnswerLineDTO("AC135", 452.0, identifier, mapRepetition1, UnitCode.U5135.getKey()));
