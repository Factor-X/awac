...
/*
 * Test for bad AC_BAD23C
*/
@Component
public class BAD_AC_BAD23CTest{
    ...
    @Autowired
    private BaseActivityDataAC_BAD23C baseActivityDataAC_BAD23C;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD23C.getBaseActivityData(questionSetAnswers);
