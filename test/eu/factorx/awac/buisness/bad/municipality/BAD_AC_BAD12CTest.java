...
import eu.factorx.awac.service.knowledge.activity.contributor.municipality.BaseActivityDataAC_BAD12C;
...
/*
 * Test for bad AC_BAD12C
*/
@Component
public class BAD_AC_BAD12CTest {
    ...
    @Autowired
    private BaseActivityDataAC_BAD12C baseActivityDataAC_BAD12C;
    ...
    public void test(long siteId) {
        ...
        //add answers
        answerLineDTOList.addAll(buildAnswerAC101());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD12C.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
        mapResult.put(5662.0, false);
     ...
     * question : AC101
     */
    private List<AnswerLineDTO> buildAnswerAC101() {

        List<AnswerLineDTO> list = new ArrayList<>();

        //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
        list.add(new AnswerLineDTO("AC101", 5662.0, identifier, mapRepetition1));
