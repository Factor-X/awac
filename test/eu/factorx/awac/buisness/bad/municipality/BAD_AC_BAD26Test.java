...
/*
 * Test for bad AC_BAD26
*/
@Component
public class BAD_AC_BAD26Test{
    ...
    @Autowired
    private BaseActivityDataAC_BAD26 baseActivityDataAC_BAD26;
    ...
    public void test(long siteId){
        ...
        //add answers
                ...
                answerLineDTOList.addAll(buildAnswerAC901());
                answerLineDTOList.addAll(buildAnswerAC902());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD26.getBaseActivityData(questionSetAnswers);
     ...
     * question : AC901
     */
    private List<AnswerLineDTO> buildAnswerAC901(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                ...
                list.add(new AnswerLineDTO("AC901","AS_13",  mapRepetition1 ));
     ...
     * question : AC902
     */
    private List<AnswerLineDTO> buildAnswerAC902(){
