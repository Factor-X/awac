...
/*
 * Test for bad AC_BAD17A
*/
@Component
public class BAD_AC_BAD17ATest{
    ...
    @Autowired
    private BaseActivityDataAC_BAD17A baseActivityDataAC_BAD17A;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD17A.getBaseActivityData(questionSetAnswers);
