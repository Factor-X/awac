...
import eu.factorx.awac.service.knowledge.activity.contributor.municipality.BaseActivityDataAC_BAD12B;
...
/*
 * Test for bad AC_BAD12B
*/
@Component
public class BAD_AC_BAD12BTest {
    ...
    @Autowired
    private BaseActivityDataAC_BAD12B baseActivityDataAC_BAD12B;
    ...
    public void test(long siteId) {
        ...
        //add answers
        answerLineDTOList.addAll(buildAnswerAC100());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD12B.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
        mapResult.put(122000.0, false);
     ...
     * question : AC100
     */
    private List<AnswerLineDTO> buildAnswerAC100() {

        List<AnswerLineDTO> list = new ArrayList<>();

        //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
        list.add(new AnswerLineDTO("AC100", 122000.0, identifier, mapRepetition1));
