...
/*
 * Test for bad AC_BAD24
*/
@Component
public class BAD_AC_BAD24Test{
    ...
    @Autowired
    private BaseActivityDataAC_BAD24 baseActivityDataAC_BAD24;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerAC609());
                answerLineDTOList.addAll(buildAnswerAC610());
                answerLineDTOList.addAll(buildAnswerAC611());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD24.getBaseActivityData(questionSetAnswers);
     ...
     * question : AC609
     */
    private List<AnswerLineDTO> buildAnswerAC609(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("AC607",1);
                list.add(new AnswerLineDTO("AC609","AS_5",  mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("AC607",2);
                list.add(new AnswerLineDTO("AC609","AS_163",  mapRepetition2 ));
     ...
     * question : AC610
     */
    private List<AnswerLineDTO> buildAnswerAC610(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("AC607",1);
                list.add(new AnswerLineDTO("AC610",4.5,  mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("AC607",2);
                list.add(new AnswerLineDTO("AC610",12.0,  mapRepetition2 ));
     ...
     * question : AC611
     */
    private List<AnswerLineDTO> buildAnswerAC611(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("AC607",1);
                list.add(new AnswerLineDTO("AC611",245000.0,  mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("AC607",2);
                list.add(new AnswerLineDTO("AC611",120000.0,  mapRepetition2 ));
