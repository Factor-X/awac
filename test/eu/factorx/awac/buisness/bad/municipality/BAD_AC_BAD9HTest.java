...
import eu.factorx.awac.service.knowledge.activity.contributor.municipality.BaseActivityDataAC_BAD9H;
...
/*
 * Test for bad AC_BAD9H
*/
@Component
public class BAD_AC_BAD9HTest {
    ...
    @Autowired
    private BaseActivityDataAC_BAD9H baseActivityDataAC_BAD9H;
    ...
    public void test(long siteId) {
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD9H.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
        mapResult.put(900.0, false);
