...
import eu.factorx.awac.service.knowledge.activity.contributor.municipality.BaseActivityDataAC_BAD11D;
...
/*
 * Test for bad AC_BAD11D
*/
@Component
public class BAD_AC_BAD11DTest {
    ...
    @Autowired
    private BaseActivityDataAC_BAD11D baseActivityDataAC_BAD11D;
    ...
    public void test(long siteId) {
        ...
        //add answers
        answerLineDTOList.addAll(buildAnswerAC97());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD11D.getBaseActivityData(questionSetAnswers);
     ...
     * question : AC97
     */
    private List<AnswerLineDTO> buildAnswerAC97() {

        List<AnswerLineDTO> list = new ArrayList<>();

        //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
        list.add(new AnswerLineDTO("AC97", 854.0, identifier, mapRepetition1));
