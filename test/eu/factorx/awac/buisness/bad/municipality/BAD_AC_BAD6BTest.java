...
import eu.factorx.awac.service.knowledge.activity.contributor.municipality.BaseActivityDataAC_BAD6B;
...
/*
 * Test for bad AC_BAD6B
*/
@Component
public class BAD_AC_BAD6BTest {
    ...
    @Autowired
    private BaseActivityDataAC_BAD6B baseActivityDataAC_BAD6B;
    ...
    public void test(long siteId) {
        ...
        //add answers
        answerLineDTOList.addAll(buildAnswerAC54());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD6B.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
        mapResult.put(0.03416666666667, false);
     ...
     * question : AC54
     */
    private List<AnswerLineDTO> buildAnswerAC54() {

        List<AnswerLineDTO> list = new ArrayList<>();

        //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
        list.add(new AnswerLineDTO("AC54", 123000.0, identifier, mapRepetition1, UnitCode.U5156.getKey()));
    ...
    private void controlGlobalBad(BaseActivityData bad) {
        /*
        assertTrue("BaseActivityDataCode error. Expected : ActivityCategoryCode.AC_18, founded : "+bad.getKey(),bad.getKey().equals(BaseActivityDataCode.ActivityCategoryCode.AC_18));
