...
import eu.factorx.awac.service.knowledge.activity.contributor.municipality.BaseActivityDataAC_BAD6A;
...
/*
 * Test for bad AC_BAD6A
*/
@Component
public class BAD_AC_BAD6ATest {
    ...
    @Autowired
    private BaseActivityDataAC_BAD6A baseActivityDataAC_BAD6A;
    ...
    public void test(long siteId) {
        ...
        //add answers
        answerLineDTOList.addAll(buildAnswerAC55());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD6A.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
        mapResult.put(9900.0, false);
     ...
     * question : AC55
     */
    private List<AnswerLineDTO> buildAnswerAC55() {

        List<AnswerLineDTO> list = new ArrayList<>();

        //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
        list.add(new AnswerLineDTO("AC55", 9900.0, identifier, mapRepetition1, UnitCode.U5156.getKey()));
