...
/*
 * Test for bad AC_BAD20C
*/
@Component
public class BAD_AC_BAD20CTest{
    ...
    @Autowired
    private BaseActivityDataAC_BAD20C baseActivityDataAC_BAD20C;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD20C.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(2500.0, false);
