...
import eu.factorx.awac.service.knowledge.activity.contributor.municipality.BaseActivityDataAC_BAD12E;
...
/*
 * Test for bad AC_BAD12E
*/
@Component
public class BAD_AC_BAD12ETest {
    ...
    @Autowired
    private BaseActivityDataAC_BAD12E baseActivityDataAC_BAD12E;
    ...
    public void test(long siteId) {
        ...
        //add answers
        answerLineDTOList.addAll(buildAnswerAC103());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD12E.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
        mapResult.put(4542.0, false);
     ...
     * question : AC103
     */
    private List<AnswerLineDTO> buildAnswerAC103() {

        List<AnswerLineDTO> list = new ArrayList<>();

        //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
        list.add(new AnswerLineDTO("AC103", 4542.0, identifier, mapRepetition1));
