...
/*
 * Test for bad AC_BAD19
*/
@Component
public class BAD_AC_BAD19Test{
    ...
    @Autowired
    private BaseActivityDataAC_BAD19 baseActivityDataAC_BAD19;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerAC415());
                answerLineDTOList.addAll(buildAnswerAC417());
                answerLineDTOList.addAll(buildAnswerAC416());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD19.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(57142.857142857145, false);
                mapResult.put(93750.0, false);
     ...
     * question : AC415
     */
    private List<AnswerLineDTO> buildAnswerAC415(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("AC413",1);
                list.add(new AnswerLineDTO("AC415","AS_5",  mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("AC413",2);
                list.add(new AnswerLineDTO("AC415","AS_162",  mapRepetition2 ));
     ...
     * question : AC417
     */
    private List<AnswerLineDTO> buildAnswerAC417(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("AC413",1);
                list.add(new AnswerLineDTO("AC417",80000.0,  mapRepetition1  , UnitCode.U5170.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("AC413",2);
                list.add(new AnswerLineDTO("AC417",150000.0,  mapRepetition2  , UnitCode.U5170.getKey()  ));
     ...
     * question : AC416
     */
    private List<AnswerLineDTO> buildAnswerAC416(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("AC413",1);
                list.add(new AnswerLineDTO("AC416",1.4,  mapRepetition1  , UnitCode.U5170.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("AC413",2);
                list.add(new AnswerLineDTO("AC416",1.6,  mapRepetition2  , UnitCode.U5170.getKey()  ));
