...
import eu.factorx.awac.service.knowledge.activity.contributor.municipality.BaseActivityDataAC_BAD15A;
...
/*
 * Test for bad AC_BAD15A
*/
@Component
public class BAD_AC_BAD15ATest {
    ...
    @Autowired
    private BaseActivityDataAC_BAD15A baseActivityDataAC_BAD15A;
    ...
    public void test(long siteId) {
        ...
        answerLineDTOList.addAll(buildAnswerAC134());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD15A.getBaseActivityData(questionSetAnswers);
     ...
     * question : AC134
     */
    private List<AnswerLineDTO> buildAnswerAC134() {
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
        mapRepetition1.put("AC132", 1);
        list.add(new AnswerLineDTO("AC134", 5000.0, identifier, mapRepetition1, UnitCode.U5115.getKey()));
