...
import eu.factorx.awac.service.knowledge.activity.contributor.municipality.BaseActivityDataAC_BAD9E;
...
/*
 * Test for bad AC_BAD9E
*/
@Component
public class BAD_AC_BAD9ETest {
    ...
    @Autowired
    private BaseActivityDataAC_BAD9E baseActivityDataAC_BAD9E;
    ...
    public void test(long siteId) {
        ...
        answerLineDTOList.addAll(buildAnswerAC79());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD9E.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
        mapResult.put(1080.0, false);
    ...
    private List<AnswerLineDTO> buildAnswerAC76() {
        ...
        list.add(new AnswerLineDTO("AC76", "ASC_7", identifier, mapRepetition1));
        //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
        mapRepetition2.put("AC73", 4);
        list.add(new AnswerLineDTO("AC76", "ASC_7", identifier, mapRepetition2));
        //add repetition
        Map<String, Integer> mapRepetition3 = new HashMap<>();
        mapRepetition3.put("AC73", 6);
        list.add(new AnswerLineDTO("AC76", "ASC_7", identifier, mapRepetition3));
        //add repetition
        Map<String, Integer> mapRepetition4 = new HashMap<>();
        mapRepetition4.put("AC73", 8);
        list.add(new AnswerLineDTO("AC76", "ASC_7", identifier, mapRepetition4));
     ...
     * question : AC79
     */
    private List<AnswerLineDTO> buildAnswerAC79() {
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
        mapRepetition1.put("AC73", 1);
        list.add(new AnswerLineDTO("AC79", 1.3, identifier, mapRepetition1));
        //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
        mapRepetition2.put("AC73", 2);
        list.add(new AnswerLineDTO("AC79", 1.2, identifier, mapRepetition2));
