...
import eu.factorx.awac.service.knowledge.activity.contributor.municipality.BaseActivityDataAC_BAD5B;
...
/*
 * Test for bad AC_BAD5B
*/
@Component
public class BAD_AC_BAD5BTest {
    ...
    @Autowired
    private BaseActivityDataAC_BAD5B baseActivityDataAC_BAD5B;
    ...
    public void test(long siteId) {
        ...
        answerLineDTOList.addAll(buildAnswerAC47());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD5B.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
        mapResult.put(10.0, false);
     ...
     * question : AC47
     */
    private List<AnswerLineDTO> buildAnswerAC47() {
        ...
        mapRepetition1.put("AC10", 1);
        mapRepetition1.put("AC44", 1);
        list.add(new AnswerLineDTO("AC47", 10.0, identifier, mapRepetition1, UnitCode.U5135.getKey()));
        //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
        mapRepetition2.put("AC10", 2);
        mapRepetition2.put("AC44", 1);
        list.add(new AnswerLineDTO("AC47", 2500.0, identifier, mapRepetition2, UnitCode.U5133.getKey()));
