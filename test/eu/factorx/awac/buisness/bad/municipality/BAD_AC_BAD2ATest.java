...
import eu.factorx.awac.service.knowledge.activity.contributor.municipality.BaseActivityDataAC_BAD2A;
...
/*
 * Test for bad AC_BAD2A
*/
@Component
public class BAD_AC_BAD2ATest {
    ...
    @Autowired
    private BaseActivityDataAC_BAD2A baseActivityDataAC_BAD2A;
    ...
    public void test(long siteId) {
        ...
        answerLineDTOList.addAll(buildAnswerAC30());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD2A.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
        mapResult.put(5850.0, false);
     ...
     * question : AC30
     */
    private List<AnswerLineDTO> buildAnswerAC30() {
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
        mapRepetition1.put("AC10", 1);
        list.add(new AnswerLineDTO("AC30", 5850.0, identifier, mapRepetition1, UnitCode.U5156.getKey()));
