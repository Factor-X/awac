...
import eu.factorx.awac.service.knowledge.activity.contributor.municipality.BaseActivityDataAC_BAD9A;
...
/*
 * Test for bad AC_BAD9A
*/
@Component
public class BAD_AC_BAD9ATest {
    ...
    @Autowired
    private BaseActivityDataAC_BAD9A baseActivityDataAC_BAD9A;
    ...
    public void test(long siteId) {
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD9A.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
        mapResult.put(780.0, false);
