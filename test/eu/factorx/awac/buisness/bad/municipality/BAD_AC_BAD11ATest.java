...
import eu.factorx.awac.service.knowledge.activity.contributor.municipality.BaseActivityDataAC_BAD11A;
...
/*
 * Test for bad AC_BAD11A
*/
@Component
public class BAD_AC_BAD11ATest {
    ...
    @Autowired
    private BaseActivityDataAC_BAD11A baseActivityDataAC_BAD11A;
    ...
    public void test(long siteId) {
        ...
        //add answers
        answerLineDTOList.addAll(buildAnswerAC94());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD11A.getBaseActivityData(questionSetAnswers);
     ...
     * question : AC94
     */
    private List<AnswerLineDTO> buildAnswerAC94() {

        List<AnswerLineDTO> list = new ArrayList<>();

        //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
        list.add(new AnswerLineDTO("AC94", 90000.0, identifier, mapRepetition1));
