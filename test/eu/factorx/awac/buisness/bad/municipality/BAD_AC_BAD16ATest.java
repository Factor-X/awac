...
import eu.factorx.awac.service.knowledge.activity.contributor.municipality.BaseActivityDataAC_BAD16A;
...
/*
 * Test for bad AC_BAD16A
*/
@Component
public class BAD_AC_BAD16ATest {
    ...
    @Autowired
    private BaseActivityDataAC_BAD16A baseActivityDataAC_BAD16A;
    ...
    public void test(long siteId) {
        ...
        answerLineDTOList.addAll(buildAnswerAC142());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD16A.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
        mapResult.put(178.0, false);
     ...
     * question : AC142
     */
    private List<AnswerLineDTO> buildAnswerAC142() {
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
        mapRepetition1.put("AC139", 1);
        list.add(new AnswerLineDTO("AC142", 200.0, identifier, mapRepetition1));
