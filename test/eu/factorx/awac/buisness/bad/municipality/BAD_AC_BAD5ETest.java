...
import eu.factorx.awac.service.knowledge.activity.contributor.municipality.BaseActivityDataAC_BAD5E;
...
/*
 * Test for bad AC_BAD5E
*/
@Component
public class BAD_AC_BAD5ETest {
    ...
    @Autowired
    private BaseActivityDataAC_BAD5E baseActivityDataAC_BAD5E;
    ...
    public void test(long siteId) {
        ...
        answerLineDTOList.addAll(buildAnswerAC50());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD5E.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
        mapResult.put(6.0, false);
     ...
     * question : AC50
     */
    private List<AnswerLineDTO> buildAnswerAC50() {
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
        mapRepetition1.put("AC10", 1);
        mapRepetition1.put("AC44", 2);
        list.add(new AnswerLineDTO("AC50", 6.0, identifier, mapRepetition1, UnitCode.U5135.getKey()));
