...
import eu.factorx.awac.service.knowledge.activity.contributor.municipality.BaseActivityDataAC_BAD16B;
...
/*
 * Test for bad AC_BAD16B
*/
@Component
public class BAD_AC_BAD16BTest {
    ...
    @Autowired
    private BaseActivityDataAC_BAD16B baseActivityDataAC_BAD16B;
    ...
    public void test(long siteId) {
        ...
        //add answers
        answerLineDTOList.addAll(buildAnswerAC140());
        answerLineDTOList.addAll(buildAnswerAC141());
        answerLineDTOList.addAll(buildAnswerAC143());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD16B.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
        mapResult.put(4450.0, false);
     ...
     * question : AC140
     */
    private List<AnswerLineDTO> buildAnswerAC140() {

        List<AnswerLineDTO> list = new ArrayList<>();

        //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
        mapRepetition1.put("AC139", 1);
        list.add(new AnswerLineDTO("AC140", "projet", identifier, mapRepetition1));
     ...
     * question : AC141
     */
    private List<AnswerLineDTO> buildAnswerAC141() {
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
        mapRepetition1.put("AC139", 1);
        list.add(new AnswerLineDTO("AC141", 0.89, identifier, mapRepetition1));
     ...
     * question : AC143
     */
    private List<AnswerLineDTO> buildAnswerAC143() {
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
        mapRepetition1.put("AC139", 1);
        list.add(new AnswerLineDTO("AC143", 5000.0, identifier, mapRepetition1));
    ...
    private void controlGlobalBad(BaseActivityData bad) {
        /*
        assertTrue("BaseActivityDataCode error. Expected : ActivityCategoryCode.AC_17, founded : "+bad.getKey(),bad.getKey().equals(BaseActivityDataCode.ActivityCategoryCode.AC_17));
