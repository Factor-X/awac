...
public class BAD_AC_BAD16BTest{
    ...
    private List<AnswerLineDTO> buildAnswerAC140(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                ...
                list.add(new AnswerLineDTO("AC140","projet",  mapRepetition1 ));
    ...
    private List<AnswerLineDTO> buildAnswerAC141(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("AC139",1);
                list.add(new AnswerLineDTO("AC141",0.89,  mapRepetition1 ));
    ...
    private List<AnswerLineDTO> buildAnswerAC143(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("AC139",1);
                list.add(new AnswerLineDTO("AC143",5000.0,  mapRepetition1 ));
