...
import eu.factorx.awac.service.knowledge.activity.contributor.municipality.BaseActivityDataAC_BAD9G;
...
public class BAD_AC_BAD9GTest {
    ...
    private List<AnswerLineDTO> buildAnswerAC81() {
        ...
        list.add(new AnswerLineDTO("AC81", 1.0, identifier, mapRepetition1));
        //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
        mapRepetition2.put("AC73", 6);
        list.add(new AnswerLineDTO("AC81", 0.9, identifier, mapRepetition2));
