...
/*
 * Test for bad AC_BAD20A
*/
@Component
public class BAD_AC_BAD20ATest{
    ...
    @Autowired
    private BaseActivityDataAC_BAD20A baseActivityDataAC_BAD20A;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD20A.getBaseActivityData(questionSetAnswers);
