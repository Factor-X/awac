...
/*
 * Test for bad AC_BAD23B
*/
@Component
public class BAD_AC_BAD23BTest{
    ...
    @Autowired
    private BaseActivityDataAC_BAD23B baseActivityDataAC_BAD23B;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerAC604());
                answerLineDTOList.addAll(buildAnswerAC603());
                answerLineDTOList.addAll(buildAnswerAC605());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD23B.getBaseActivityData(questionSetAnswers);
     ...
     * question : AC604
     */
    private List<AnswerLineDTO> buildAnswerAC604(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("AC604",23.0,  mapRepetition1  , UnitCode.U5122.getKey()  ));
     ...
     * question : AC605
     */
    private List<AnswerLineDTO> buildAnswerAC605(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                list.add(new AnswerLineDTO("AC605",2500.0,  mapRepetition1  , UnitCode.U5126.getKey()  ));
