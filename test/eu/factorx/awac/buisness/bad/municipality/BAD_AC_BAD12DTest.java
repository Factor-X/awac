...
import eu.factorx.awac.service.knowledge.activity.contributor.municipality.BaseActivityDataAC_BAD12D;
...
/*
 * Test for bad AC_BAD12D
*/
@Component
public class BAD_AC_BAD12DTest {
    ...
    @Autowired
    private BaseActivityDataAC_BAD12D baseActivityDataAC_BAD12D;
    ...
    public void test(long siteId) {
        ...
        //add answers
        answerLineDTOList.addAll(buildAnswerAC102());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD12D.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
        mapResult.put(854.0, false);
     ...
     * question : AC102
     */
    private List<AnswerLineDTO> buildAnswerAC102() {

        List<AnswerLineDTO> list = new ArrayList<>();

        //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
        list.add(new AnswerLineDTO("AC102", 854.0, identifier, mapRepetition1));
