...
import eu.factorx.awac.service.knowledge.activity.contributor.municipality.BaseActivityDataAC_BAD12F;
...
/*
 * Test for bad AC_BAD12F
*/
@Component
public class BAD_AC_BAD12FTest {
    ...
    @Autowired
    private BaseActivityDataAC_BAD12F baseActivityDataAC_BAD12F;
    ...
    public void test(long siteId) {
        ...
        //add answers
        answerLineDTOList.addAll(buildAnswerAC104());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD12F.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
        mapResult.put(22300.0, false);
     ...
     * question : AC104
     */
    private List<AnswerLineDTO> buildAnswerAC104() {
