...
import eu.factorx.awac.service.knowledge.activity.contributor.municipality.BaseActivityDataAC_BAD5D;
...
/*
 * Test for bad AC_BAD5D
*/
@Component
public class BAD_AC_BAD5DTest {
    ...
    @Autowired
    private BaseActivityDataAC_BAD5D baseActivityDataAC_BAD5D;
    ...
    public void test(long siteId) {
        ...
        answerLineDTOList.addAll(buildAnswerAC49());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD5D.getBaseActivityData(questionSetAnswers);
     ...
     * question : AC49
     */
    private List<AnswerLineDTO> buildAnswerAC49() {
        ...
        list.add(new AnswerLineDTO("AC49", 5.0, identifier, mapRepetition1, UnitCode.U5135.getKey()));
