...
import eu.factorx.awac.service.knowledge.activity.contributor.municipality.BaseActivityDataAC_BAD3;
...
/*
 * Test for bad AC_BAD3
*/
@Component
public class BAD_AC_BAD3Test {
    ...
    @Autowired
    private BaseActivityDataAC_BAD3 baseActivityDataAC_BAD3;
    ...
    public void test(long siteId) {
        ...
        answerLineDTOList.addAll(buildAnswerAC34());
        answerLineDTOList.addAll(buildAnswerAC36());
        answerLineDTOList.addAll(buildAnswerAC35());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD3.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
        mapResult.put(1.33333333333333, false);
        mapResult.put(0.01894736842105, false);
     ...
     * question : AC34
     */
    private List<AnswerLineDTO> buildAnswerAC34() {
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
        mapRepetition1.put("AC10", 1);
        mapRepetition1.put("AC33", 1);
        list.add(new AnswerLineDTO("AC34", "AS_2", identifier, mapRepetition1));
        //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
        mapRepetition2.put("AC10", 1);
        mapRepetition2.put("AC33", 2);
        list.add(new AnswerLineDTO("AC34", "AS_45", identifier, mapRepetition2));
     ...
     * question : AC36
     */
    private List<AnswerLineDTO> buildAnswerAC36() {
        ...
        mapRepetition1.put("AC10", 1);
        mapRepetition1.put("AC33", 1);
        list.add(new AnswerLineDTO("AC36", 1200000.0, identifier, mapRepetition1, UnitCode.U5155.getKey()));
        //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
        mapRepetition2.put("AC10", 1);
        mapRepetition2.put("AC33", 2);
        list.add(new AnswerLineDTO("AC36", 5.0, identifier, mapRepetition2, UnitCode.U5156.getKey()));
     ...
     * question : AC35
     */
    private List<AnswerLineDTO> buildAnswerAC35() {
        ...
        mapRepetition1.put("AC10", 1);
        mapRepetition1.put("AC33", 1);
        list.add(new AnswerLineDTO("AC35", 0.9, identifier, mapRepetition1));
        //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
        mapRepetition2.put("AC10", 1);
        mapRepetition2.put("AC33", 2);
        list.add(new AnswerLineDTO("AC35", 0.95, identifier, mapRepetition2));
