...
/*
 * Test for bad AC_BAD8A
*/
@Component
public class BAD_AC_BAD8ATest{
    ...
    @Autowired
    private BaseActivityDataAC_BAD8A baseActivityDataAC_BAD8A;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD8A.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(5892.0, false);
    ...
    private List<AnswerLineDTO> buildAnswerAC67(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                ...
                list.add(new AnswerLineDTO("AC67","essence",  mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("AC66",2);
                list.add(new AnswerLineDTO("AC67","diesel",  mapRepetition2 ));
    ...
    private List<AnswerLineDTO> buildAnswerAC70(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("AC66",1);
                list.add(new AnswerLineDTO("AC70","AS_5",  mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("AC66",2);
                list.add(new AnswerLineDTO("AC70","AS_162",  mapRepetition2 ));
    ...
    private List<AnswerLineDTO> buildAnswerAC71(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("AC66",1);
                list.add(new AnswerLineDTO("AC71",5892.0,  mapRepetition1  , UnitCode.U5126.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("AC66",2);
                list.add(new AnswerLineDTO("AC71",2.3,  mapRepetition2  , UnitCode.U5122.getKey()  ));
    ...
    private List<AnswerLineDTO> buildAnswerAC68(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("AC66",1);
                list.add(new AnswerLineDTO("AC68","1",  mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("AC66",2);
                list.add(new AnswerLineDTO("AC68","2",  mapRepetition2 ));
