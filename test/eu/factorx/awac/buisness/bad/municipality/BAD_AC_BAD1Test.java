...
import eu.factorx.awac.service.knowledge.activity.contributor.municipality.BaseActivityDataAC_BAD1;
...
/*
 * Test for bad AC_BAD1
*/
@Component
public class BAD_AC_BAD1Test {
    ...
    @Autowired
    private BaseActivityDataAC_BAD1 baseActivityDataAC_BAD1;
    ...
    public void test(long siteId) {
        ...
        answerLineDTOList.addAll(buildAnswerAC26());
        answerLineDTOList.addAll(buildAnswerAC27());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD1.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
        mapResult.put(3.0E-6, false);
     ...
     * question : AC26
     */
    private List<AnswerLineDTO> buildAnswerAC26() {
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
        mapRepetition1.put("AC10", 1);
        mapRepetition1.put("AC25", 1);
        list.add(new AnswerLineDTO("AC26", "AS_13", identifier, mapRepetition1));
        //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
        mapRepetition2.put("AC10", 2);
        mapRepetition2.put("AC25", 1);
        list.add(new AnswerLineDTO("AC26", "AS_15", identifier, mapRepetition2));
     ...
     * question : AC27
     */
    private List<AnswerLineDTO> buildAnswerAC27() {
        ...
        mapRepetition1.put("AC10", 1);
        mapRepetition1.put("AC25", 1);
        list.add(new AnswerLineDTO("AC27", 3000.0, identifier, mapRepetition1, UnitCode.U5155.getKey()));
        //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
        mapRepetition2.put("AC10", 2);
        mapRepetition2.put("AC25", 1);
        list.add(new AnswerLineDTO("AC27", 100.0, identifier, mapRepetition2, UnitCode.U5156.getKey()));
