...
public class BAD_AC_BAD7BTest{
    ...
    private List<AnswerLineDTO> buildAnswerAC57(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                ...
                list.add(new AnswerLineDTO("AC57","coffret1",  mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("AC56",2);
                list.add(new AnswerLineDTO("AC57","coffret2",  mapRepetition2 ));
    ...
    private List<AnswerLineDTO> buildAnswerAC58(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("AC56",1);
                list.add(new AnswerLineDTO("AC58",3.6E7,  mapRepetition1  , UnitCode.U5155.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("AC56",2);
                list.add(new AnswerLineDTO("AC58",5678.0,  mapRepetition2  , UnitCode.U5156.getKey()  ));
