...
import eu.factorx.awac.service.knowledge.activity.contributor.municipality.BaseActivityDataAC_BAD7B;
...
/*
 * Test for bad AC_BAD7B
*/
@Component
public class BAD_AC_BAD7BTest {
    ...
    @Autowired
    private BaseActivityDataAC_BAD7B baseActivityDataAC_BAD7B;
    ...
    public void test(long siteId) {
        ...
        //add answers
        answerLineDTOList.addAll(buildAnswerAC57());
        answerLineDTOList.addAll(buildAnswerAC58());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD7B.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
        mapResult.put(10.0, false);
        mapResult.put(5678.0, false);
     ...
     * question : AC57
     */
    private List<AnswerLineDTO> buildAnswerAC57() {
        ...
        list.add(new AnswerLineDTO("AC57", "coffret1", identifier, mapRepetition1));
        //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
        mapRepetition2.put("AC56", 2);
        list.add(new AnswerLineDTO("AC57", "coffret2", identifier, mapRepetition2));
     ...
     * question : AC58
     */
    private List<AnswerLineDTO> buildAnswerAC58() {
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
        mapRepetition1.put("AC56", 1);
        list.add(new AnswerLineDTO("AC58", 3.6E7, identifier, mapRepetition1, UnitCode.U5156.getKey()));
        //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
        mapRepetition2.put("AC56", 2);
        list.add(new AnswerLineDTO("AC58", 5678.0, identifier, mapRepetition2, UnitCode.U5156.getKey()));
    ...
    private void controlGlobalBad(BaseActivityData bad) {
        /*
        assertTrue("BaseActivityDataCode error. Expected : ActivityCategoryCode.AC_19, founded : "+bad.getKey(),bad.getKey().equals(BaseActivityDataCode.ActivityCategoryCode.AC_19));
