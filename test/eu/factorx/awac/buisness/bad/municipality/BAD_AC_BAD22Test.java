...
/*
 * Test for bad AC_BAD22
*/
@Component
public class BAD_AC_BAD22Test{
    ...
    @Autowired
    private BaseActivityDataAC_BAD22 baseActivityDataAC_BAD22;
    ...
    public void test(long siteId){
        ...
        //add answers
                answerLineDTOList.addAll(buildAnswerAC515());
                answerLineDTOList.addAll(buildAnswerAC517());
                answerLineDTOList.addAll(buildAnswerAC516());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD22.getBaseActivityData(questionSetAnswers);
     ...
     * question : AC515
     */
    private List<AnswerLineDTO> buildAnswerAC515(){

        List<AnswerLineDTO> list = new ArrayList<>();

                 //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("AC513",1);
                list.add(new AnswerLineDTO("AC515","AS_5",  mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("AC513",2);
                list.add(new AnswerLineDTO("AC515","AS_162",  mapRepetition2 ));
     ...
     * question : AC517
     */
    private List<AnswerLineDTO> buildAnswerAC517(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("AC513",1);
                list.add(new AnswerLineDTO("AC517",80000.0,  mapRepetition1  , UnitCode.U5170.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("AC513",2);
                list.add(new AnswerLineDTO("AC517",150000.0,  mapRepetition2  , UnitCode.U5170.getKey()  ));
     ...
     * question : AC516
     */
    private List<AnswerLineDTO> buildAnswerAC516(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("AC513",1);
                list.add(new AnswerLineDTO("AC516",1.4,  mapRepetition1  , UnitCode.U5170.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("AC513",2);
                list.add(new AnswerLineDTO("AC516",1.6,  mapRepetition2  , UnitCode.U5170.getKey()  ));
