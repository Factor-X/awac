...
/*
 * Test for bad AC_BAD17B
*/
@Component
public class BAD_AC_BAD17BTest{
    ...
    @Autowired
    private BaseActivityDataAC_BAD17B baseActivityDataAC_BAD17B;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD17B.getBaseActivityData(questionSetAnswers);
     ...
     * question : AC403
     */
    private List<AnswerLineDTO> buildAnswerAC403(){
