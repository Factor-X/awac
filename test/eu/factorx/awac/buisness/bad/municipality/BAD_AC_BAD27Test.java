...
/*
 * Test for bad AC_BAD27
*/
@Component
public class BAD_AC_BAD27Test{
    ...
    @Autowired
    private BaseActivityDataAC_BAD27 baseActivityDataAC_BAD27;
    ...
    public void test(long siteId){
        ...
        //add answers
                ...
                answerLineDTOList.addAll(buildAnswerAC904());
                answerLineDTOList.addAll(buildAnswerAC905());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD27.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
                mapResult.put(3.0, false);
     ...
     * question : AC904
     */
    private List<AnswerLineDTO> buildAnswerAC904(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("AC10",1);
                mapRepetition1.put("AC903",1);
                list.add(new AnswerLineDTO("AC904","AS_13",  mapRepetition1 ));
     ...
     * question : AC905
     */
    private List<AnswerLineDTO> buildAnswerAC905(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("AC10",1);
                mapRepetition1.put("AC903",1);
                list.add(new AnswerLineDTO("AC905",3000.0,  mapRepetition1  , UnitCode.U5133.getKey()  ));
