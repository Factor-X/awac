...
/*
 * Test for bad AC_BAD5
*/
@Component
public class BAD_AC_BAD5Test{
    ...
    @Autowired
    private BaseActivityDataAC_BAD5 baseActivityDataAC_BAD5;
    ...
    public void test(long siteId){
        ...
        //add answers
                ...
                answerLineDTOList.addAll(buildAnswerAC5001());
                answerLineDTOList.addAll(buildAnswerAC5002());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD5.getBaseActivityData(questionSetAnswers);
     ...
     * question : AC5001
     */
    private List<AnswerLineDTO> buildAnswerAC5001(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("AC10",1);
                mapRepetition1.put("AC5000",1);
                list.add(new AnswerLineDTO("AC5001","1",  mapRepetition1 ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("AC10",1);
                mapRepetition2.put("AC5000",2);
                list.add(new AnswerLineDTO("AC5001","30",  mapRepetition2 ));
     ...
     * question : AC5002
     */
    private List<AnswerLineDTO> buildAnswerAC5002(){
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
                mapRepetition1.put("AC10",1);
                mapRepetition1.put("AC5000",1);
                list.add(new AnswerLineDTO("AC5002",18.0,  mapRepetition1  , UnitCode.U5135.getKey()  ));
                //add repetition
        Map<String, Integer> mapRepetition2 = new HashMap<>();
                mapRepetition2.put("AC10",1);
                mapRepetition2.put("AC5000",2);
                list.add(new AnswerLineDTO("AC5002",24.0,  mapRepetition2  , UnitCode.U5135.getKey()  ));
