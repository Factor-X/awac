...
import eu.factorx.awac.service.knowledge.activity.contributor.municipality.BaseActivityDataAC_BAD2B;
...
/*
 * Test for bad AC_BAD2B
*/
@Component
public class BAD_AC_BAD2BTest {
    ...
    @Autowired
    private BaseActivityDataAC_BAD2B baseActivityDataAC_BAD2B;
    ...
    public void test(long siteId) {
        ...
        answerLineDTOList.addAll(buildAnswerAC31());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD2B.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
        mapResult.put(3500.0, false);
     ...
     * question : AC31
     */
    private List<AnswerLineDTO> buildAnswerAC31() {
        ...
        Map<String, Integer> mapRepetition1 = new HashMap<>();
        mapRepetition1.put("AC10", 1);
        list.add(new AnswerLineDTO("AC31", 3.5, identifier, mapRepetition1, UnitCode.U5337.getKey()));
