...
import eu.factorx.awac.service.knowledge.activity.contributor.municipality.BaseActivityDataAC_BAD14K;
...
/*
 * Test for bad AC_BAD14K
*/
@Component
public class BAD_AC_BAD14KTest {
    ...
    @Autowired
    private BaseActivityDataAC_BAD14K baseActivityDataAC_BAD14K;
    ...
    public void test(long siteId) {
        ...
        answerLineDTOList.addAll(buildAnswerAC125());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD14K.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
        mapResult.put(5.5, false);
     ...
     * question : AC125
     */
    private List<AnswerLineDTO> buildAnswerAC125() {

        List<AnswerLineDTO> list = new ArrayList<>();

        //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
        mapRepetition1.put("AC117", 2);
        list.add(new AnswerLineDTO("AC125", "AS_312", identifier, mapRepetition1));
