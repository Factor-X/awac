...
import eu.factorx.awac.service.knowledge.activity.contributor.municipality.BaseActivityDataAC_BAD9C;
...
/*
 * Test for bad AC_BAD9C
*/
@Component
public class BAD_AC_BAD9CTest {
    ...
    @Autowired
    private BaseActivityDataAC_BAD9C baseActivityDataAC_BAD9C;
    ...
    public void test(long siteId) {
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD9C.getBaseActivityData(questionSetAnswers);
