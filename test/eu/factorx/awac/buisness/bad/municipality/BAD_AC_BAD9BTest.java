...
import eu.factorx.awac.service.knowledge.activity.contributor.municipality.BaseActivityDataAC_BAD9B;
...
/*
 * Test for bad AC_BAD9B
*/
@Component
public class BAD_AC_BAD9BTest {
    ...
    @Autowired
    private BaseActivityDataAC_BAD9B baseActivityDataAC_BAD9B;
    ...
    public void test(long siteId) {
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD9B.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
        mapResult.put(840.0, false);
