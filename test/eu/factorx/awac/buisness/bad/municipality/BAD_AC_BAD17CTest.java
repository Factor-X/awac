...
/*
 * Test for bad AC_BAD17C
*/
@Component
public class BAD_AC_BAD17CTest{
    ...
    @Autowired
    private BaseActivityDataAC_BAD17C baseActivityDataAC_BAD17C;
    ...
    public void test(long siteId){
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD17C.getBaseActivityData(questionSetAnswers);
