...
import eu.factorx.awac.service.knowledge.activity.contributor.municipality.BaseActivityDataAC_BAD14D;
...
/*
 * Test for bad AC_BAD14D
*/
@Component
public class BAD_AC_BAD14DTest {
    ...
    @Autowired
    private BaseActivityDataAC_BAD14D baseActivityDataAC_BAD14D;
    ...
    public void test(long siteId) {
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD14D.getBaseActivityData(questionSetAnswers);

        //control content
        //map mapResult
        Map<Double, Boolean> mapResult = new HashMap<>();
        mapResult.put(800.0, false);
