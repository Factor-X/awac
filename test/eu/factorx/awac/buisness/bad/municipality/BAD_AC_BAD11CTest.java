...
import eu.factorx.awac.service.knowledge.activity.contributor.municipality.BaseActivityDataAC_BAD11C;
...
/*
 * Test for bad AC_BAD11C
*/
@Component
public class BAD_AC_BAD11CTest {
    ...
    @Autowired
    private BaseActivityDataAC_BAD11C baseActivityDataAC_BAD11C;
    ...
    public void test(long siteId) {
        ...
        //add answers
        answerLineDTOList.addAll(buildAnswerAC96());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD11C.getBaseActivityData(questionSetAnswers);
     ...
     * question : AC96
     */
    private List<AnswerLineDTO> buildAnswerAC96() {

        List<AnswerLineDTO> list = new ArrayList<>();

        //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
        list.add(new AnswerLineDTO("AC96", 5662.0, identifier, mapRepetition1));
