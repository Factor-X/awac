...
import eu.factorx.awac.service.knowledge.activity.contributor.municipality.BaseActivityDataAC_BAD12A;
...
/*
 * Test for bad AC_BAD12A
*/
@Component
public class BAD_AC_BAD12ATest {
    ...
    @Autowired
    private BaseActivityDataAC_BAD12A baseActivityDataAC_BAD12A;
    ...
    public void test(long siteId) {
        ...
        //add answers
        answerLineDTOList.addAll(buildAnswerAC99());
        ...
        List<BaseActivityData> bads = baseActivityDataAC_BAD12A.getBaseActivityData(questionSetAnswers);
     ...
     * question : AC99
     */
    private List<AnswerLineDTO> buildAnswerAC99() {

        List<AnswerLineDTO> list = new ArrayList<>();

        //add repetition
        Map<String, Integer> mapRepetition1 = new HashMap<>();
        list.add(new AnswerLineDTO("AC99", 90000.0, identifier, mapRepetition1));
