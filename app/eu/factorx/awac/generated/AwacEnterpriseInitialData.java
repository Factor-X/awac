...
if (a7 == null) {
    ...
    ValueSelectionQuestion a8 = (ValueSelectionQuestion) questionService.findByCode(QuestionCode.A8);
if (a8 == null) {
    a8 = new ValueSelectionQuestion(a1, 0, QuestionCode.A8, CodeList.SECTEURTYPE);
    JPA.em().persist(a8);
} else {
    if (!a8.getQuestionSet().equals(a1) && a1.getQuestions().contains(a8)) {
        a1.getQuestions().remove(a8);
        JPA.em().persist(a1);
    }
    if (a8.getQuestionSet().equals(a1) && !a1.getQuestions().contains(a8)) {
        a1.getQuestions().add(a8);
        JPA.em().persist(a1);
    }
    a8.setOrderIndex(0);
    a8.setCodeList(CodeList.SECTEURTYPE);
    JPA.em().persist(a8);
}
