...
public class GESSIMPLIFIECode extends Code {
    ...
    public static final GESSIMPLIFIECode 404A=new

    GESSIMPLIFIECode("25");

    public static final GESSIMPLIFIECode 407C=new

    GESSIMPLIFIECode("26");

    public static final GESSIMPLIFIECode R408A = new GESSIMPLIFIECode("27");
    public static final GESSIMPLIFIECode 410A=new

    GESSIMPLIFIECode("28");

    public static final GESSIMPLIFIECode 413A=new
    ...
    public static final GESSIMPLIFIECode 403B=new
