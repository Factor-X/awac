...
public class FRIGORIGENECode extends Code {
    ...
    public static final FRIGORIGENECode 404A=new

    FRIGORIGENECode("25");

    public static final FRIGORIGENECode 407C=new

    FRIGORIGENECode("26");

    public static final FRIGORIGENECode R408A = new FRIGORIGENECode("27");
    public static final FRIGORIGENECode 410A=new

    FRIGORIGENECode("28");

    public static final FRIGORIGENECode 413A=new
    ...
    public static final FRIGORIGENECode 403B=new
