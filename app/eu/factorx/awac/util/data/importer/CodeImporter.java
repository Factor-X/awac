...
//        importCodesFromDatasheet("BaseActivityData", BaseActivityDataCode.class, CodeList.BASE_ACTIVITY_DATA);
		...
		importCodesFromDatasheet("SECTEURPRIMAIRE", SECTEURPRIMAIRECode.class, CodeList.SECTEURPRIMAIRE);
		importCodesFromDatasheet("SECTEURSECONDAIRE", SECTEURSECONDAIRECode.class, CodeList.SECTEURSECONDAIRE);
		importCodesFromDatasheet("SECTEURTERTIAIRE", SECTEURTERTIAIRECode.class, CodeList.SECTEURTERTIAIRE);
		importCodesFromDatasheet("SECTEURTYPE", SECTEURTYPECode.class, CodeList.SECTEURTYPE);
		...
		importCodesFromDatasheet("TRAITEMENTEAU", TRAITEMENTEAUCode.class, CodeList.TRAITEMENTEAU);
