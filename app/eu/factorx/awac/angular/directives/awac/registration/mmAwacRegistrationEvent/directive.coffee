...
.directive "mmAwacRegistrationEvent", (directiveService,downloadService,messageFlash,translationService,modalService) ->
    restrict: "E"
    scope:{}
    ...
    controller: ($scope) ->
        ...
        $scope.registration = () ->
            ...
            if $scope.allFieldValid()
                ...
                #send request
                downloadService.postJson '/awac/registration/event', data, (result) ->
                    if result.success
