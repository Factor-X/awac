...
.controller "Form7Ctrl", ($scope, downloadService, $http) ->
    ...
    $scope.getRepetitionMapByQuestionSet = (code, mapRepetition) ->
        ...
        if $scope.mapRepetition[code] != null && $scope.mapRepetition[code] != undefined
            for repetition in $scope.mapRepetition[code]
                ...
                #control map
                if mapRepetition == null || mapRepetition == undefined || $scope.compareRepetitionMap(repetition,
                    mapRepetition)
    ...
    $scope.removeIteration = (questionSetCode, iterationToDelete, mapRepetition) ->
        ...
        while (len--)
            ...
            if question.mapRepetition != null && question.mapRepetition != undefined && $scope.compareRepetitionMap(question.mapRepetition,
                mapRepetition)
        ...
        for key in Object.keys($scope.mapRepetition)
            if key != '$$hashKey'
                ...
                while (len--)
                    ...
                    if $scope.compareRepetitionMap(iteration,
                        mapRepetition) && iteration[questionSetCode] && iteration[questionSetCode] == iterationToDelete[questionSetCode]
