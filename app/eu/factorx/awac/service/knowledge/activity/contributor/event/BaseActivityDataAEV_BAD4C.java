 ...
 */
@Component
public class BaseActivityDataAEV_BAD4C extends ActivityResultContributor {
    ...
    public List<BaseActivityData> getBaseActivityData(Map<QuestionCode, List<QuestionSetAnswer>> questionSetAnswers) {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    QuestionAnswer questionAEV48Answer = answersByCode2.get(QuestionCode.AEV48);
                                    QuestionAnswer questionAEV49Answer = answersByCode2.get(QuestionCode.AEV49);
                
                    //control them
                    if (                            questionAEV48Answer == null  ||
                                                                                questionAEV49Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.AEV_BAD4C);
            ...
            baseActivityData.setValue(toDouble(questionAEV40Answer)*toDouble(questionAEV41Answer, getUnitByCode(UnitCode.U5106))*toDouble(questionAEV48Answer)*toDouble(questionAEV49Answer)/100);
