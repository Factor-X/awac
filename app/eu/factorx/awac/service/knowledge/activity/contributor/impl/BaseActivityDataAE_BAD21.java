...
public class BaseActivityDataAE_BAD21 extends ActivityResultContributor {
	...
	public List<BaseActivityData> getBaseActivityData(Map<QuestionCode, List<QuestionSetAnswer>> questionSetAnswers) {
		...
		for (QuestionSetAnswer questionSetAnswer : questionSetAnswers.get(QuestionCode.A182)) {
			...
			baseActivityData.setValue(toDouble(questionA183Answer, baseActivityDataUnit) / 2 * toDouble(questionA184Answer, baseActivityDataUnit) / 365);
