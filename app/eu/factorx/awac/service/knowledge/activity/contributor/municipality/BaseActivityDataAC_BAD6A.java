...
* Name of the BAD : Eclairage public: électricité grise
 */
@Component
public class BaseActivityDataAC_BAD6A extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    QuestionAnswer questionAC55Answer = answersByCode1.get(QuestionCode.AC55);
                
                    //control them
                    if (                            questionAC55Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.AC_BAD6A);
            ...
            baseActivityData.setValue(toDouble(questionAC55Answer, getUnitByCode(UnitCode.U5156)));
