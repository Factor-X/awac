 ...
 */
@Component
public class BaseActivityDataAE_BAD34D extends ActivityResultContributor {
    ...
    public List<BaseActivityData> getBaseActivityData(Map<QuestionCode, List<QuestionSetAnswer>> questionSetAnswers) {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                             for (QuestionSetAnswer questionSetAnswer3 : getChildrenQuestionSetAnswers(questionSetAnswer2,QuestionCode.A1030)) {
             
                            //create a map for each repetition level
                Map<QuestionCode, QuestionAnswer> answersByCode3 = byQuestionCode(questionSetAnswer3.getQuestionAnswers());

                //load question for this level
                                    QuestionAnswer questionA1031Answer = answersByCode3.get(QuestionCode.A1031);
                                    QuestionAnswer questionA1032Answer = answersByCode3.get(QuestionCode.A1032);
                
                    //control them
                    if (                            questionA1031Answer == null  ||
                                                                                questionA1032Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.AE_BAD34D);
            ...
            baseActivityData.setActivitySource(toActivitySourceCode(questionA1031Answer));

            baseActivityData.setActivityOwnership(null);
            baseActivityData.setUnit(baseActivityDataUnit);
            baseActivityData.setValue(toDouble(questionA1032Answer, baseActivityDataUnit));
