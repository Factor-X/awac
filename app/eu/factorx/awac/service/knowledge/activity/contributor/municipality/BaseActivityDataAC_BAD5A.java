 ...
 */
@Component
public class BaseActivityDataAC_BAD5A extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    ...
                                    QuestionAnswer questionAC46Answer = answersByCode3.get(QuestionCode.AC46);
                
                    //control them
                    if (                            questionAC45Answer == null  ||
                                                                                questionAC46Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.AC_BAD5A);
            ...
            baseActivityData.setActivityType(ActivityTypeCode.AT_37);

            baseActivityData.setActivitySource(toActivitySourceCode(questionAC45Answer));

            baseActivityData.setActivityOwnership(true);
            baseActivityData.setUnit(baseActivityDataUnit);
            baseActivityData.setValue(toDouble(questionAC46Answer, getUnitByCode(UnitCode.U5135)));
