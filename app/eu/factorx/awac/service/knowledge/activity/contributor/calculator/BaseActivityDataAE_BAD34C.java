...
* Name of the BAD : Site: traitement aval - réfrigérant direct
 */
@Component
public class BaseActivityDataAE_BAD34C extends ActivityResultContributor {
    ...
    public List<BaseActivityData> getBaseActivityData(Map<QuestionCode, List<QuestionSetAnswer>> questionSetAnswers) {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                             for (QuestionSetAnswer questionSetAnswer3 : getChildrenQuestionSetAnswers(questionSetAnswer2,QuestionCode.A288)) {
             
                            //create a map for each repetition level
                Map<QuestionCode, QuestionAnswer> answersByCode3 = byQuestionCode(questionSetAnswer3.getQuestionAnswers());

                //load question for this level
                                    QuestionAnswer questionA289Answer = answersByCode3.get(QuestionCode.A289);
                                    QuestionAnswer questionA290Answer = answersByCode3.get(QuestionCode.A290);
            ...
            baseActivityData.setValue(toDouble(questionA290Answer, getUnitByCode(UnitCode.U5135)));
