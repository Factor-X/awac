 ...
 */
@Component
public class BaseActivityDataAC_BAD5B extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    ...
                                    QuestionAnswer questionAC47Answer = answersByCode3.get(QuestionCode.AC47);
                
                    //control them
                    if (                            questionAC45Answer == null  ||
                                                                                questionAC47Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.AC_BAD5B);
            ...
            baseActivityData.setActivityType(ActivityTypeCode.AT_42);

            baseActivityData.setActivitySource(toActivitySourceCode(questionAC45Answer));

            baseActivityData.setActivityOwnership(true);
            baseActivityData.setUnit(baseActivityDataUnit);
            baseActivityData.setValue(toDouble(questionAC47Answer, getUnitByCode(UnitCode.U5135)));
