...
public class BaseActivityDataAE_BAD27F extends ActivityResultContributor {
    ...
    public List<BaseActivityData> getBaseActivityData(Map<QuestionCode, List<QuestionSetAnswer>> questionSetAnswers) {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            baseActivityData.setActivitySource(convertCode(toActivitySourceCode(questionA214Answer), ConversionCriterion.RECYCLAGE,eu.factorx.awac.models.code.type.ActivitySourceCode.class));
