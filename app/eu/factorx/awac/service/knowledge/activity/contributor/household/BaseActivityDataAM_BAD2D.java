...
* Name of the BAD : Cuisson: combustion directe (prix propane)
 */
@Component
public class BaseActivityDataAM_BAD2D extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    ...
                                    QuestionAnswer questionAM56Answer = answersByCode1.get(QuestionCode.AM56);
                
                    //control them
                    if (                            questionAM49Answer == null  ||
                                                                                questionAM54Answer == null  ||
                                                                                questionAM56Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.AM_BAD2D);
                            baseActivityData.setAlternativeGroup("null");
                        baseActivityData.setRank(0);
            baseActivityData.setSpecificPurpose(null);
            baseActivityData.setActivityCategory(ActivityCategoryCode.AC_1);
            baseActivityData.setActivitySubCategory(ActivitySubCategoryCode.ASC_15);
            ...
            baseActivityData.setValue(toDouble(questionAM54Answer, getUnitByCode(UnitCode.U5170))*1000/toDouble(questionAM56Answer, getUnitByCode(UnitCode.U5170)));
