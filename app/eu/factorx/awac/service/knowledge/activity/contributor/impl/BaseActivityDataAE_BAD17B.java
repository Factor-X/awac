...
public class BaseActivityDataAE_BAD17B extends ActivityResultContributor {
	...
	public List<BaseActivityData> getBaseActivityData(Map<QuestionCode, List<QuestionSetAnswer>> questionSetAnswers) {
		...
		for (QuestionSetAnswer questionSetAnswer : questionSetAnswersA142) {
            ...
            baseActivityData.setValue(toDouble(questionA145Answer, getUnitByCode(UnitCode.U5135)) * toDouble(questionA146Answer, getUnitByCode(UnitCode.U5106)) * toDouble(questionA148Answer));
