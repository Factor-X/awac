 ...
 */
@Component
public class BaseActivityDataAPE_BAD18B extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    ...
                                    QuestionAnswer questionAP165Answer = answersByCode1.get(QuestionCode.AP165);
                
                    //control them
                    if (                            questionAP162Answer == null  ||
                                                                                questionAP165Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.APE_BAD18B);
            ...
            baseActivityData.setValue(toDouble(questionAP165Answer, baseActivityDataUnit));
