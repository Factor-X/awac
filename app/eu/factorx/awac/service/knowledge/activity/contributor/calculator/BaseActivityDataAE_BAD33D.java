 ...
 */
@Component
public class BaseActivityDataAE_BAD33D extends ActivityResultContributor {
    ...
    public List<BaseActivityData> getBaseActivityData(Map<QuestionCode, List<QuestionSetAnswer>> questionSetAnswers) {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                             for (QuestionSetAnswer questionSetAnswer4 : getChildrenQuestionSetAnswers(questionSetAnswer3,QuestionCode.A1024)) {
             
                            //create a map for each repetition level
                Map<QuestionCode, QuestionAnswer> answersByCode4 = byQuestionCode(questionSetAnswer4.getQuestionAnswers());

                //load question for this level
                                    QuestionAnswer questionA1025Answer = answersByCode4.get(QuestionCode.A1025);
                                    QuestionAnswer questionA1026Answer = answersByCode4.get(QuestionCode.A1026);
                
                    //control them
                    if (                            questionA1025Answer == null  ||
                                                                                questionA1026Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.AE_BAD33D);
            ...
            baseActivityData.setActivitySource(toActivitySourceCode(questionA1025Answer));

            baseActivityData.setActivityOwnership(null);
            baseActivityData.setUnit(baseActivityDataUnit);
            baseActivityData.setValue(toDouble(questionA1026Answer, baseActivityDataUnit));
