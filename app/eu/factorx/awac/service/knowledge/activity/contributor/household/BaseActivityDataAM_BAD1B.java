...
* Name of the BAD : Logement: combustion directe chauffage (masse)
 */
@Component
public class BaseActivityDataAM_BAD1B extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    ...
                                    QuestionAnswer questionAM31Answer = answersByCode1.get(QuestionCode.AM31);
                
                    //control them
                    if (                            questionAM27Answer == null  ||
                                                                                questionAM31Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.AM_BAD1B);
            ...
            baseActivityData.setValue(toDouble(questionAM31Answer, baseActivityDataUnit));
