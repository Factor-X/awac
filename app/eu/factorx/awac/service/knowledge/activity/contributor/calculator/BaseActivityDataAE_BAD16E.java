...
* Name of the BAD : Site: transport amont possédé réfrigérants
 */
@Component
public class BaseActivityDataAE_BAD16E extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    QuestionAnswer questionA137Answer = answersByCode1.get(QuestionCode.A137);
                                    QuestionAnswer questionA136Answer = answersByCode1.get(QuestionCode.A136);
                                    QuestionAnswer questionA138Answer = answersByCode1.get(QuestionCode.A138);
                    ...
                    if (                            questionA137Answer == null  ||
                       ...
                       continue;
                        ...
                        if(toBoolean(questionA136Answer) && !toBoolean(questionA138Answer)){
            
            //build the bad
            BaseActivityData baseActivityData = new BaseActivityData();

            baseActivityData.setKey(BaseActivityDataCode.AE_BAD16E);
            ...
            baseActivityData.setValue(4.84E-4);
