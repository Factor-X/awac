 ...
 */
@Component
public class BaseActivityDataAE_BAD44A extends ActivityResultContributor {
    ...
    public List<BaseActivityData> getBaseActivityData(Map<QuestionCode, List<QuestionSetAnswer>> questionSetAnswers) {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            baseActivityData.setKey(BaseActivityDataCode.AE_BAD44A);
            ...
            baseActivityData.setValue(toDouble(questionA503Answer, baseActivityDataUnit)+0*toDouble(questionA504Answer, baseActivityDataUnit)+0*toDouble(questionA505Answer, baseActivityDataUnit));
