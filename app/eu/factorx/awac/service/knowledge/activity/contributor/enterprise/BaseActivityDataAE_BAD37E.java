    ...
    public List<BaseActivityData> getBaseActivityData(Map<QuestionCode, List<QuestionSetAnswer>> questionSetAnswers) {
        ...
        //2. build BAD
                ...
                //load question without repetition
                    List<QuestionSetAnswer> questionSetAnswersA1015 = questionSetAnswers.get(QuestionCode.A1015);
        
        //... and control
        if (
                    questionSetAnswersA1015 == null || questionSetAnswersA1015.size()==0         ) {
        return res;
        }

        //load question
                        QuestionAnswer questionA1017Answer = byQuestionCode(questionSetAnswersA1015.get(0).getQuestionAnswers()).get(QuestionCode.A1017);
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            baseActivityData.setActivitySource(toActivitySourceCode(questionA1014Answer));
