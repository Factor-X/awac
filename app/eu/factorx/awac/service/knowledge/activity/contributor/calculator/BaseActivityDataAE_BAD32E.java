 ...
 */
@Component
public class BaseActivityDataAE_BAD32E extends ActivityResultContributor {
    ...
    public List<BaseActivityData> getBaseActivityData(Map<QuestionCode, List<QuestionSetAnswer>> questionSetAnswers) {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            baseActivityData.setKey(BaseActivityDataCode.AE_BAD32E);
            ...
            baseActivityData.setValue(toDouble(questionA267Answer, getUnitByCode(UnitCode.U5135))*2500);
