...
* Name of the BAD : Site: mobilité  véhicules non possédés DDT DPRO GPL direct
 */
@Component
public class BaseActivityDataAE_BAD44C extends ActivityResultContributor {
    ...
    public List<BaseActivityData> getBaseActivityData(Map<QuestionCode, List<QuestionSetAnswer>> questionSetAnswers) {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            baseActivityData.setKey(BaseActivityDataCode.AE_BAD44C);
            ...
            baseActivityData.setValue(toDouble(questionA505Answer, baseActivityDataUnit));
