 ...
 */
@Component
public class BaseActivityDataAEV_BAD1D extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    ...
                                    QuestionAnswer questionAEV20Answer = answersByCode1.get(QuestionCode.AEV20);
                
                    //control them
                    if (                            questionAEV14Answer == null  ||
                                                                                questionAEV18Answer == null  ||
                                                                                questionAEV20Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.AEV_BAD1D);
            ...
            baseActivityData.setValue(toDouble(questionAEV18Answer, getUnitByCode(UnitCode.U5170))/toDouble(questionAEV20Answer, getUnitByCode(UnitCode.U5170))*1000);
