 ...
 */
@Component
public class BaseActivityDataAEV_BAD7A extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    QuestionAnswer questionAEV79Answer = answersByCode1.get(QuestionCode.AEV79);
                
                    //control them
                    if (                            questionAEV79Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.AEV_BAD7A);
            ...
            baseActivityData.setValue(toDouble(questionAEV79Answer));
