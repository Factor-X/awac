 ...
 */
@Component
public class BaseActivityDataAC_BAD17A extends ActivityResultContributor {
    ...
    public List<BaseActivityData> getBaseActivityData(Map<QuestionCode, List<QuestionSetAnswer>> questionSetAnswers) {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            baseActivityData.setKey(BaseActivityDataCode.AC_BAD17A);
            ...
            baseActivityData.setValue(toDouble(questionAC403Answer, baseActivityDataUnit)+0*toDouble(questionAC404Answer, baseActivityDataUnit)+0*toDouble(questionAC405Answer, baseActivityDataUnit));
