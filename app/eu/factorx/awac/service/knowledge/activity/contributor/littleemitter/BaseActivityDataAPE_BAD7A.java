...
public class BaseActivityDataAPE_BAD7A extends ActivityResultContributor {
    ...
    public List<BaseActivityData> getBaseActivityData(Map<QuestionCode, List<QuestionSetAnswer>> questionSetAnswers) {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            baseActivityData.setValue(toDouble(questionAP85Answer)*toDouble(questionAP86Answer)*toDouble(questionAP87Answer, getUnitByCode(UnitCode.U5106))*toDouble(questionAP90Answer)/100);
