...
* Name of the BAD : Cuisson: électricité
 */
@Component
public class BaseActivityDataAM_BAD2B extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    ...
                                    QuestionAnswer questionAM53Answer = answersByCode1.get(QuestionCode.AM53);
                
                    //control them
                    if (                            questionAM49Answer == null  ||
                                                                                questionAM53Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.AM_BAD2B);
            ...
            baseActivityData.setValue(toDouble(questionAM53Answer, baseActivityDataUnit));
