    ...
    public List<BaseActivityData> getBaseActivityData(Map<QuestionCode, List<QuestionSetAnswer>> questionSetAnswers) {
        ...
        for (QuestionSetAnswer questionSetAnswer1 : questionSetAnswersA22) {
            ...
            if (toBoolean(questionA48Answer)) {
                ...
                Logger.info("=>"+questionA23Answer+"/"+toDouble(questionA23Answer, getUnitByCode(UnitCode.U5156)));
                Logger.info("=>"+questionA49Answer+"/"+toDouble(questionA49Answer, getUnitByCode(UnitCode.U5147)));
