 ...
 */
@Component
public class BaseActivityDataAE_BAD32F extends ActivityResultContributor {
    ...
    public List<BaseActivityData> getBaseActivityData(Map<QuestionCode, List<QuestionSetAnswer>> questionSetAnswers) {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
                ...
                //load question for this level
                    ...
                    if (                            questionA267Answer == null  ||
                       ...
                       continue;
                        ...
                        if(getCode(questionA268Answer).getKey().equals("3")){
            
            //build the bad
            BaseActivityData baseActivityData = new BaseActivityData();

            baseActivityData.setKey(BaseActivityDataCode.AE_BAD32F);
            ...
            baseActivityData.setValue(toDouble(questionA267Answer, getUnitByCode(UnitCode.U5135))*5000);
