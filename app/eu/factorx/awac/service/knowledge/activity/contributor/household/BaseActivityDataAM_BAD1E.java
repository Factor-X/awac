...
* Name of the BAD : Chauffage: combustion directe (prix gaz)
 */
@Component
public class BaseActivityDataAM_BAD1E extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    ...
                                    QuestionAnswer questionAM35Answer = answersByCode1.get(QuestionCode.AM35);
                
                    //control them
                    if (                            questionAM27Answer == null  ||
                                                                                questionAM33Answer == null  ||
                                                                                questionAM35Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.AM_BAD1E);
            ...
            baseActivityData.setValue(toDouble(questionAM33Answer, getUnitByCode(UnitCode.U5170))*1000/toDouble(questionAM35Answer, getUnitByCode(UnitCode.U5170)));
