...
* Name of the BAD : mobilité DDT tram
 */
@Component
public class BaseActivityDataAC_BAD11D extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    QuestionAnswer questionAC97Answer = answersByCode1.get(QuestionCode.AC97);
                
                    //control them
                    if (                            questionAC97Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.AC_BAD11D);
            ...
            baseActivityData.setValue(toDouble(questionAC97Answer));
