 ...
 */
@Component
public class BaseActivityDataAE_BAD10B extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    ...
                                    QuestionAnswer questionA74Answer = answersByCode1.get(QuestionCode.A74);
                                    QuestionAnswer questionA72Answer = answersByCode1.get(QuestionCode.A72);
                
                    //control them
                    if (                            questionA71Answer == null  ||
                       ...
                       continue;
                        ...
                        if(toBoolean(questionA69Answer) && ((getCode(questionA72Answer).getKey().equals("2")) || (getCode(questionA72Answer).getKey().equals("3")) || (getCode(questionA72Answer).getKey().equals("4")) || (getCode(questionA72Answer).getKey().equals("5")))){
            
            //build the bad
            BaseActivityData baseActivityData = new BaseActivityData();

            baseActivityData.setKey(BaseActivityDataCode.AE_BAD10B);
            ...
            baseActivityData.setValue(toDouble(questionA76Answer)*toDouble(questionA74Answer)/100);
