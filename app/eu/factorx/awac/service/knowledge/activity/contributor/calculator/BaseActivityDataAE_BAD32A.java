 ...
 */
@Component
public class BaseActivityDataAE_BAD32A extends ActivityResultContributor {
    ...
    public List<BaseActivityData> getBaseActivityData(Map<QuestionCode, List<QuestionSetAnswer>> questionSetAnswers) {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
                ...
                //load question for this level
                    ...
                    if (                            questionA267Answer == null  ||
                       ...
                       continue;
                        ...
                        if(getCode(questionA268Answer).getKey().equals("1")){
            ...
            baseActivityData.setValue(0.854*200*toDouble(questionA267Answer, getUnitByCode(UnitCode.U5135))/11.4/0.4426*24.98/100);
