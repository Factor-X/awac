 ...
 */
@Component
public class BaseActivityDataAEV_BAD4B extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    ...
                                    QuestionAnswer questionAEV46Answer = answersByCode2.get(QuestionCode.AEV46);
                
                    //control them
                    if (                            questionAEV43Answer == null  ||
                                                                                questionAEV44Answer == null  ||
                                                                                questionAEV46Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.AEV_BAD4B);
            ...
            baseActivityData.setValue(toDouble(questionAEV40Answer)*toDouble(questionAEV41Answer, getUnitByCode(UnitCode.U5106))*toDouble(questionAEV43Answer)*toDouble(questionAEV44Answer)/100*toDouble(questionAEV46Answer));
