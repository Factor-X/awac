 ...
 */
@Component
public class BaseActivityDataAPE_BAD1E extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    ...
                                    QuestionAnswer questionAP27Answer = answersByCode1.get(QuestionCode.AP27);
                
                    //control them
                    if (                            questionAP18Answer == null  ||
                                                                                questionAP24Answer == null  ||
                                                                                questionAP27Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.APE_BAD1E);
            ...
            baseActivityData.setValue(toDouble(questionAP24Answer, getUnitByCode(UnitCode.U5170))/toDouble(questionAP27Answer, getUnitByCode(UnitCode.U5170))*1000);
