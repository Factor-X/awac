 ...
 */
@Component
public class BaseActivityDataAM_BAD13A extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    QuestionAnswer questionAM172Answer = answersByCode1.get(QuestionCode.AM172);
                
                    //control them
                    if (                            questionAM172Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.AM_BAD13A);
            ...
            baseActivityData.setValue(toDouble(questionAM172Answer)*52);
