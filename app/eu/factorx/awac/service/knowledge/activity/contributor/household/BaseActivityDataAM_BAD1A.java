...
* Name of the BAD : Logement: combustion directe chauffage (volume)
 */
@Component
public class BaseActivityDataAM_BAD1A extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    ...
                                    QuestionAnswer questionAM30Answer = answersByCode1.get(QuestionCode.AM30);
                
                    //control them
                    if (                            questionAM27Answer == null  ||
                                                                                questionAM30Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.AM_BAD1A);
            ...
            baseActivityData.setValue(toDouble(questionAM30Answer, baseActivityDataUnit));
