 ...
 */
@Component
public class BaseActivityDataAC_BAD14L extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    ...
                                    QuestionAnswer questionAC126Answer = answersByCode1.get(QuestionCode.AC126);
                                    QuestionAnswer questionAC129Answer = answersByCode1.get(QuestionCode.AC129);
                
                    //control them
                    if (                            questionAC117Answer == null  ||
                                                                                questionAC118Answer == null  ||
                                                                                questionAC126Answer == null  ||
                                                                                questionAC129Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.AC_BAD14L);
            ...
            baseActivityData.setActivitySource(toActivitySourceCode(questionAC126Answer));

            baseActivityData.setActivityOwnership(null);
            baseActivityData.setUnit(baseActivityDataUnit);
            baseActivityData.setValue(toDouble(questionAC129Answer, getUnitByCode(UnitCode.U5170)));
