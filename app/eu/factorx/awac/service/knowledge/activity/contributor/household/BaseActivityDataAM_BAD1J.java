...
* Name of the BAD : Chauffage: électricité (prix)
 */
@Component
public class BaseActivityDataAM_BAD1J extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    ...
                                    QuestionAnswer questionAM40Answer = answersByCode1.get(QuestionCode.AM40);
                
                    //control them
                    if (                            questionAM27Answer == null  ||
                                                                                questionAM33Answer == null  ||
                                                                                questionAM40Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.AM_BAD1J);
            ...
            baseActivityData.setValue(toDouble(questionAM33Answer, getUnitByCode(UnitCode.U5170))/toDouble(questionAM40Answer, getUnitByCode(UnitCode.U5170))*0.0036);
