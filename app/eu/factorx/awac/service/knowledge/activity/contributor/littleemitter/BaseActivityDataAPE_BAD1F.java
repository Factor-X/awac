 ...
 */
@Component
public class BaseActivityDataAPE_BAD1F extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    ...
                                    QuestionAnswer questionAP28Answer = answersByCode1.get(QuestionCode.AP28);
                
                    //control them
                    if (                            questionAP18Answer == null  ||
                                                                                questionAP24Answer == null  ||
                                                                                questionAP28Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.APE_BAD1F);
            ...
            baseActivityData.setValue(toDouble(questionAP24Answer, getUnitByCode(UnitCode.U5170))/toDouble(questionAP28Answer, getUnitByCode(UnitCode.U5170))/1000);
