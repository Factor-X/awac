 ...
 */
@Component
public class BaseActivityDataAEV_BAD4D extends ActivityResultContributor {
    ...
    public List<BaseActivityData> getBaseActivityData(Map<QuestionCode, List<QuestionSetAnswer>> questionSetAnswers) {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    QuestionAnswer questionAEV50Answer = answersByCode2.get(QuestionCode.AEV50);
                
                    //control them
                    if (                            questionAEV50Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.AEV_BAD4D);
            ...
            baseActivityData.setValue(toDouble(questionAEV40Answer)*toDouble(questionAEV41Answer, getUnitByCode(UnitCode.U5106))*toDouble(questionAEV50Answer));
