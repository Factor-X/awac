 ...
 */
@Component
public class BaseActivityDataAC_BAD9H extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    ...
                                    QuestionAnswer questionAC82Answer = answersByCode1.get(QuestionCode.AC82);
                    ...
                    if (                            questionAC74Answer == null  ||
                                                                                ...
                                                                                questionAC82Answer == null  ||
                                                                                questionAC75Answer == null  ||
                                                                                questionAC78Answer == null                                                 ) {
                       continue;
                    }
                    
                        if((!getCode(questionAC75Answer).getKey().equals("1")) && ((getCode(questionAC78Answer).getKey().equals("3"))  || (getCode(questionAC78Answer).getKey().equals("4")))){
            
            //build the bad
            BaseActivityData baseActivityData = new BaseActivityData();

            baseActivityData.setKey(BaseActivityDataCode.AC_BAD9H);
            ...
            baseActivityData.setValue(toDouble(questionAC83Answer, getUnitByCode(UnitCode.U5106))/100*toDouble(questionAC82Answer));
