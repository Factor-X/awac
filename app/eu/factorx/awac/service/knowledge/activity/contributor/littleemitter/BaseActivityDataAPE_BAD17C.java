 ...
 */
@Component
public class BaseActivityDataAPE_BAD17C extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    ...
                                    QuestionAnswer questionAP158Answer = answersByCode1.get(QuestionCode.AP158);
                
                    //control them
                    if (                            questionAP153Answer == null  ||
                                                                                questionAP154Answer == null  ||
                                                                                questionAP155Answer == null  ||
                                                                                questionAP158Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.APE_BAD17C);
            ...
            baseActivityData.setValue(toDouble(questionAP154Answer, getUnitByCode(UnitCode.U5135))*toDouble(questionAP155Answer, getUnitByCode(UnitCode.U5106))*toDouble(questionAP158Answer));
