 ...
 */
@Component
public class BaseActivityDataAPE_BAD19A extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    QuestionAnswer questionAP190Answer = answersByCode1.get(QuestionCode.AP190);
                
                    //control them
                    if (                            questionAP190Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.APE_BAD19A);
            ...
            baseActivityData.setValue(toDouble(questionAP190Answer, baseActivityDataUnit));
