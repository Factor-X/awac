 ...
 */
@Component
public class BaseActivityDataAE_BAD37D extends ActivityResultContributor {
    ...
    public List<BaseActivityData> getBaseActivityData(Map<QuestionCode, List<QuestionSetAnswer>> questionSetAnswers) {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                             for (QuestionSetAnswer questionSetAnswer2 : getChildrenQuestionSetAnswers(questionSetAnswer1,QuestionCode.A1012)) {
             
                            //create a map for each repetition level
                Map<QuestionCode, QuestionAnswer> answersByCode2 = byQuestionCode(questionSetAnswer2.getQuestionAnswers());

                //load question for this level
                                    QuestionAnswer questionA1013Answer = answersByCode2.get(QuestionCode.A1013);
                                    QuestionAnswer questionA1014Answer = answersByCode2.get(QuestionCode.A1014);
                
                    //control them
                    if (                            questionA1013Answer == null  ||
                                                                                questionA1014Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.AE_BAD37D);
            ...
            baseActivityData.setActivitySource(toActivitySourceCode(questionA1013Answer));

            baseActivityData.setActivityOwnership(null);
            baseActivityData.setUnit(baseActivityDataUnit);
            baseActivityData.setValue(toDouble(questionA1014Answer, baseActivityDataUnit));
