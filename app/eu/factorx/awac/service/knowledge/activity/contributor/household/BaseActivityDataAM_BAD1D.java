...
* Name of the BAD : Chauffage: combustion directe (prix mazout)
 */
@Component
public class BaseActivityDataAM_BAD1D extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    ...
                                    QuestionAnswer questionAM34Answer = answersByCode1.get(QuestionCode.AM34);
                
                    //control them
                    if (                            questionAM27Answer == null  ||
                                                                                questionAM33Answer == null  ||
                                                                                questionAM34Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.AM_BAD1D);
            ...
            baseActivityData.setValue(toDouble(questionAM33Answer, getUnitByCode(UnitCode.U5170))/toDouble(questionAM34Answer, getUnitByCode(UnitCode.U5170)));
