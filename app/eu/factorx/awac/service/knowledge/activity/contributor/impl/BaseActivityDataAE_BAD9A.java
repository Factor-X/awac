 ...
 * CHECK XM
 */
public class BaseActivityDataAE_BAD9A extends ActivityResultContributor {
	...
	public List<BaseActivityData> getBaseActivityData(Map<QuestionCode, List<QuestionSetAnswer>> questionSetAnswers) {
		...
		for (QuestionSetAnswer questionSetAnswer : questionSetAnswers.get(QuestionCode.A62)) {
			...
			baseActivityData.setValue(toDouble(questionA63Answer, baseActivityDataUnit));
