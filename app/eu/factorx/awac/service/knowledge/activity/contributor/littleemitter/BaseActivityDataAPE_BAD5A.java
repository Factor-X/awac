...
* Name of the BAD : mobilité DPRO essence direct
 */
@Component
public class BaseActivityDataAPE_BAD5A extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    QuestionAnswer questionAP66Answer = answersByCode1.get(QuestionCode.AP66);
                
                    //control them
                    if (                            questionAP66Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.APE_BAD5A);
            ...
            baseActivityData.setValue(toDouble(questionAP66Answer, baseActivityDataUnit));
