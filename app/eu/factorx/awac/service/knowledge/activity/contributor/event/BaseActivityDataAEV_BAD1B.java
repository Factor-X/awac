 ...
 */
@Component
public class BaseActivityDataAEV_BAD1B extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    ...
                                    QuestionAnswer questionAEV17Answer = answersByCode1.get(QuestionCode.AEV17);
                
                    //control them
                    if (                            questionAEV14Answer == null  ||
                                                                                questionAEV17Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.AEV_BAD1B);
            ...
            baseActivityData.setValue(toDouble(questionAEV17Answer, baseActivityDataUnit));
