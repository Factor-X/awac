 ...
 */
@Component
public class BaseActivityDataAPE_BAD8H extends ActivityResultContributor {
    ...
    public List<BaseActivityData> getBaseActivityData(Map<QuestionCode, List<QuestionSetAnswer>> questionSetAnswers) {
        ...
        QuestionAnswer questionAP102Answer = byQuestionCode(questionSetAnswersAP93.get(0).getQuestionAnswers()).get(QuestionCode.AP102);
        ...
        for (QuestionSetAnswer questionSetAnswer1 : questionSetAnswersAP2) {
            ...
            baseActivityData.setKey(BaseActivityDataCode.APE_BAD8H);
            ...
            Logger.warn("=> toDouble(questionAP7Answer)"+toDouble(questionAP7Answer));
            Logger.warn("=> toDouble(questionAP92Answer, getUnitByCode(UnitCode.U5106))"+toDouble(questionAP92Answer, getUnitByCode(UnitCode.U5106)));
            Logger.warn("=> toDouble(questionAP102Answer)"+toDouble(questionAP102Answer));

            baseActivityData.setValue(toDouble(questionAP7Answer) * toDouble(questionAP92Answer, getUnitByCode(UnitCode.U5106)) * 2 * 220 * toDouble(questionAP102Answer) * 4 / 100);
