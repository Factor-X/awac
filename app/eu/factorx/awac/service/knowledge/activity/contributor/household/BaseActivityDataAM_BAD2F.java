...
* Name of the BAD : Cuisson: électricité (prix)
 */
@Component
public class BaseActivityDataAM_BAD2F extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    ...
                                    QuestionAnswer questionAM58Answer = answersByCode1.get(QuestionCode.AM58);
                
                    //control them
                    if (                            questionAM49Answer == null  ||
                                                                                questionAM54Answer == null  ||
                                                                                questionAM58Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.AM_BAD2F);
                            baseActivityData.setAlternativeGroup("null");
                        baseActivityData.setRank(0);
            baseActivityData.setSpecificPurpose(null);
            baseActivityData.setActivityCategory(ActivityCategoryCode.AC_1);
            baseActivityData.setActivitySubCategory(ActivitySubCategoryCode.ASC_23);
            ...
            baseActivityData.setValue(toDouble(questionAM54Answer, getUnitByCode(UnitCode.U5170))/toDouble(questionAM58Answer, getUnitByCode(UnitCode.U5170))*0.0036);
