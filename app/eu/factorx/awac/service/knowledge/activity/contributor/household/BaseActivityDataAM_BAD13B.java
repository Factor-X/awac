 ...
 */
@Component
public class BaseActivityDataAM_BAD13B extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    QuestionAnswer questionAM173Answer = answersByCode1.get(QuestionCode.AM173);
                
                    //control them
                    if (                            questionAM173Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.AM_BAD13B);
            ...
            baseActivityData.setValue(toDouble(questionAM173Answer)*52);
