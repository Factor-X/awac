...
* Name of the BAD : Site: Déchet eau industrielle indirecte Azote traité par l'entreprise
 */
@Component
public class BaseActivityDataAE_BAD53B extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    ...
                                    QuestionAnswer questionA6008Answer = answersByCode1.get(QuestionCode.A6008);
                
                    //control them
                    if (                            questionA6009Answer == null  ||
                                                                                questionA6008Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.AE_BAD53B);
            ...
            baseActivityData.setValue(toDouble(questionA6008Answer, getUnitByCode(UnitCode.U5135)));
