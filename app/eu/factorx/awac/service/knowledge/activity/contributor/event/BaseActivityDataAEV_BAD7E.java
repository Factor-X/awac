 ...
 */
@Component
public class BaseActivityDataAEV_BAD7E extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    QuestionAnswer questionAEV83Answer = answersByCode1.get(QuestionCode.AEV83);
                
                    //control them
                    if (                            questionAEV83Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.AEV_BAD7E);
            ...
            baseActivityData.setValue(toDouble(questionAEV83Answer));
