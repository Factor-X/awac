 ...
 * CHECKED BY FLO
 */
public class BaseActivityDataAE_BAD31G extends BaseActivityDataForProducts {
	...
	public List<BaseActivityData> getBaseActivityData(QuestionSetAnswer questionSetAnswer, QuestionAnswer questionA245Answer) {
		...
		for (QuestionSetAnswer questionSetAnswersChild : questionSetAnswer.getChildren()) {
			...
			baseActivityData.setUnit(baseActivityDataUnit);
				baseActivityData.setValue(toDouble(questionA254Answer, baseActivityDataUnit) * toDouble(questionA255Answer, baseActivityDataUnit) * toDouble(questionA262Answer, baseActivityDataUnit));
