 ...
 */
@Component
public class BaseActivityDataAC_BAD20C extends ActivityResultContributor {
    ...
    public List<BaseActivityData> getBaseActivityData(Map<QuestionCode, List<QuestionSetAnswer>> questionSetAnswers) {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            baseActivityData.setKey(BaseActivityDataCode.AC_BAD20C);
            ...
            baseActivityData.setValue(toDouble(questionAC505Answer, baseActivityDataUnit));
