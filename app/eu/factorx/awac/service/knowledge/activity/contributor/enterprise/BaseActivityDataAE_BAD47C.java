 ...
 */
@Component
public class BaseActivityDataAE_BAD47C extends ActivityResultContributor {
    ...
    public List<BaseActivityData> getBaseActivityData(Map<QuestionCode, List<QuestionSetAnswer>> questionSetAnswers) {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            baseActivityData.setKey(BaseActivityDataCode.AE_BAD47C);
            ...
            baseActivityData.setValue(toDouble(questionA605Answer, baseActivityDataUnit)+0*toDouble(questionA603Answer, baseActivityDataUnit)+0*toDouble(questionA604Answer, baseActivityDataUnit));
