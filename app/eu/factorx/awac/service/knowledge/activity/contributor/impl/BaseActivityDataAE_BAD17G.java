...
public class BaseActivityDataAE_BAD17G extends ActivityResultContributor {
	...
	public List<BaseActivityData> getBaseActivityData(Map<QuestionCode, List<QuestionSetAnswer>> questionSetAnswers) {
		...
		for (QuestionSetAnswer questionSetAnswer : questionSetAnswers.get(QuestionCode.A142)) {
			...
			baseActivityData.setValue(toDouble(questionA145Answer, baseActivityDataUnit) * toDouble(questionA146Answer, baseActivityDataUnit) * toDouble(questionA153Answer, baseActivityDataUnit));
