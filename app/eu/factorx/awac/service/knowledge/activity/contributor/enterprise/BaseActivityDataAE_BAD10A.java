 ...
 */
@Component
public class BaseActivityDataAE_BAD10A extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    ...
                                    QuestionAnswer questionA73Answer = answersByCode1.get(QuestionCode.A73);
                    ...
                    if (                            questionA71Answer == null  ||
                       ...
                       continue;
                        ...
                        if(toBoolean(questionA69Answer) && (getCode(questionA72Answer).getKey().equals("1"))){
            
            //build the bad
            BaseActivityData baseActivityData = new BaseActivityData();

            baseActivityData.setKey(BaseActivityDataCode.AE_BAD10A);
            ...
            baseActivityData.setValue(toDouble(questionA76Answer)*toDouble(questionA73Answer)/100);
