 ...
 */
@Component
public class BaseActivityDataAC_BAD5D extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    ...
                                    QuestionAnswer questionAC49Answer = answersByCode3.get(QuestionCode.AC49);
                
                    //control them
                    if (                            questionAC45Answer == null  ||
                                                                                questionAC49Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.AC_BAD5D);
            ...
            baseActivityData.setActivityType(ActivityTypeCode.AT_40);

            baseActivityData.setActivitySource(toActivitySourceCode(questionAC45Answer));

            baseActivityData.setActivityOwnership(true);
            baseActivityData.setUnit(baseActivityDataUnit);
            baseActivityData.setValue(toDouble(questionAC49Answer, getUnitByCode(UnitCode.U5135)));
