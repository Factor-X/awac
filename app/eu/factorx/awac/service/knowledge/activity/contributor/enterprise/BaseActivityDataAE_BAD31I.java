...
* Name of the BAD : Site: transport aval externe avion long
 */
@Component
public class BaseActivityDataAE_BAD31I extends ActivityResultContributor {
