 ...
 */
@Component
public class BaseActivityDataAEV_BAD10D extends ActivityResultContributor {
    ...
    public List<BaseActivityData> getBaseActivityData(Map<QuestionCode, List<QuestionSetAnswer>> questionSetAnswers) {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
                ...
                //load question for this level
                    ...
                    if (                            questionAEV113Answer == null  ||
                       ...
                       continue;
                        ...
                        if((getCode(questionAEV115Answer).getKey().equals("4"))||(getCode(questionAEV115Answer).getKey().equals("5"))){
            
            //build the bad
            BaseActivityData baseActivityData = new BaseActivityData();

            baseActivityData.setKey(BaseActivityDataCode.AEV_BAD10D);
            ...
            baseActivityData.setValue(toDouble(questionAEV113Answer)*12*toDouble(questionAEV114Answer, getUnitByCode(UnitCode.U5126))*1);
