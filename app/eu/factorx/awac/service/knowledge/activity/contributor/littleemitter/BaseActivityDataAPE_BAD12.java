 ...
 */
@Component
public class BaseActivityDataAPE_BAD12 extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    QuestionAnswer questionAP120Answer = answersByCode1.get(QuestionCode.AP120);
                
                    //control them
                    if (                            questionAP120Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.APE_BAD12);
            ...
            baseActivityData.setValue(toDouble(questionAP120Answer));
