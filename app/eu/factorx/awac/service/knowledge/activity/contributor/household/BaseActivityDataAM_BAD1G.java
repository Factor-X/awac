...
* Name of the BAD : Chauffage: combustion directe (prix butane)
 */
@Component
public class BaseActivityDataAM_BAD1G extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    ...
                                    QuestionAnswer questionAM37Answer = answersByCode1.get(QuestionCode.AM37);
                
                    //control them
                    if (                            questionAM27Answer == null  ||
                                                                                questionAM33Answer == null  ||
                                                                                questionAM37Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.AM_BAD1G);
            ...
            baseActivityData.setValue(toDouble(questionAM33Answer, getUnitByCode(UnitCode.U5170))*1000/toDouble(questionAM37Answer, getUnitByCode(UnitCode.U5170)));
