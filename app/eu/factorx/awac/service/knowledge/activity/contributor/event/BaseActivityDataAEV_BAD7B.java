 ...
 */
@Component
public class BaseActivityDataAEV_BAD7B extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    QuestionAnswer questionAEV80Answer = answersByCode1.get(QuestionCode.AEV80);
                
                    //control them
                    if (                            questionAEV80Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.AEV_BAD7B);
            ...
            baseActivityData.setValue(toDouble(questionAEV80Answer));
