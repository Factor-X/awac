...
* Name of the BAD : mobilité DDT train nat
 */
@Component
public class BaseActivityDataAC_BAD11C extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    QuestionAnswer questionAC96Answer = answersByCode1.get(QuestionCode.AC96);
                
                    //control them
                    if (                            questionAC96Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.AC_BAD11C);
            ...
            baseActivityData.setValue(toDouble(questionAC96Answer));
