 ...
 */
@Component
public class BaseActivityDataAPE_BAD1A extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    ...
                                    QuestionAnswer questionAP21Answer = answersByCode1.get(QuestionCode.AP21);
                
                    //control them
                    if (                            questionAP18Answer == null  ||
                                                                                questionAP21Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.APE_BAD1A);
            ...
            baseActivityData.setValue(toDouble(questionAP21Answer, baseActivityDataUnit));
