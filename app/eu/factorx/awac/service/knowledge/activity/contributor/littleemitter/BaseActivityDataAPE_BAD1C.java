 ...
 */
@Component
public class BaseActivityDataAPE_BAD1C extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    QuestionAnswer questionAP23Answer = answersByCode1.get(QuestionCode.AP23);
                
                    //control them
                    if (                            questionAP23Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.APE_BAD1C);
            ...
            baseActivityData.setValue(toDouble(questionAP23Answer, baseActivityDataUnit));
