 ...
 */
@Component
public class BaseActivityDataAPE_BAD8F extends ActivityResultContributor {
    ...
    public List<BaseActivityData> getBaseActivityData(Map<QuestionCode, List<QuestionSetAnswer>> questionSetAnswers) {
        ...
        //load question
                        QuestionAnswer questionAP92Answer = byQuestionCode(questionSetAnswersAP91.get(0).getQuestionAnswers()).get(QuestionCode.AP92);
                                QuestionAnswer questionAP101Answer = byQuestionCode(questionSetAnswersAP93.get(0).getQuestionAnswers()).get(QuestionCode.AP101);
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            baseActivityData.setKey(BaseActivityDataCode.APE_BAD8F);
            ...
            baseActivityData.setValue(toDouble(questionAP7Answer)*toDouble(questionAP92Answer, getUnitByCode(UnitCode.U5106))*2*220*toDouble(questionAP101Answer));
