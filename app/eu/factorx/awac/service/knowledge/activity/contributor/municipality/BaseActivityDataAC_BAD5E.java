 ...
 */
@Component
public class BaseActivityDataAC_BAD5E extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    ...
                                    QuestionAnswer questionAC50Answer = answersByCode3.get(QuestionCode.AC50);
                
                    //control them
                    if (                            questionAC45Answer == null  ||
                                                                                questionAC50Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.AC_BAD5E);
            ...
            baseActivityData.setActivityType(ActivityTypeCode.AT_41);

            baseActivityData.setActivitySource(toActivitySourceCode(questionAC45Answer));

            baseActivityData.setActivityOwnership(true);
            baseActivityData.setUnit(baseActivityDataUnit);
            baseActivityData.setValue(toDouble(questionAC50Answer, getUnitByCode(UnitCode.U5135)));
