...
* Name of the BAD : Cuisson: combustion directe
 */
@Component
public class BaseActivityDataAM_BAD2A extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    ...
                                    QuestionAnswer questionAM52Answer = answersByCode1.get(QuestionCode.AM52);
                
                    //control them
                    if (                            questionAM49Answer == null  ||
                                                                                questionAM52Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.AM_BAD2A);
            ...
            baseActivityData.setValue(toDouble(questionAM52Answer, baseActivityDataUnit));
