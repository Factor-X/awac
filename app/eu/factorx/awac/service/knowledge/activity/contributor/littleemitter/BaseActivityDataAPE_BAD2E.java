 ...
 */
@Component
public class BaseActivityDataAPE_BAD2E extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    QuestionAnswer questionAP46Answer = answersByCode1.get(QuestionCode.AP46);
                                    QuestionAnswer questionAP47Answer = answersByCode1.get(QuestionCode.AP47);
                                    QuestionAnswer questionAP43Answer = answersByCode1.get(QuestionCode.AP43);
                
                    //control them
                    if (                            questionAP46Answer == null  ||
                                                                                questionAP47Answer == null  ||
            ...
            baseActivityData.setKey(BaseActivityDataCode.APE_BAD2E);
            ...
            baseActivityData.setValue(toDouble(questionAP46Answer, getUnitByCode(UnitCode.U5170))/toDouble(questionAP47Answer, getUnitByCode(UnitCode.U5170))*0.0036);
