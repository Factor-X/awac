...
* Name of the BAD : Chauffage: combustion directe (prix charbon)
 */
@Component
public class BaseActivityDataAM_BAD1I extends ActivityResultContributor {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                ...
                //load question for this level
                                    ...
                                    QuestionAnswer questionAM39Answer = answersByCode1.get(QuestionCode.AM39);
                
                    //control them
                    if (                            questionAM27Answer == null  ||
                                                                                questionAM33Answer == null  ||
                                                                                questionAM39Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.AM_BAD1I);
            ...
            baseActivityData.setValue(toDouble(questionAM33Answer, getUnitByCode(UnitCode.U5170))/(toDouble(questionAM39Answer, getUnitByCode(UnitCode.U5170))*1000));
