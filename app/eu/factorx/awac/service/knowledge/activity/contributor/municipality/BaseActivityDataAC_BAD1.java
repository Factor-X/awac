 ...
 */
@Component
public class BaseActivityDataAC_BAD1 extends ActivityResultContributor {
    ...
    public List<BaseActivityData> getBaseActivityData(Map<QuestionCode, List<QuestionSetAnswer>> questionSetAnswers) {
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            //loop ($repetition.mainQuestionSetDescription)
                             for (QuestionSetAnswer questionSetAnswer3 : getChildrenQuestionSetAnswers(questionSetAnswer2,QuestionCode.AC25)) {
             
                            //create a map for each repetition level
                Map<QuestionCode, QuestionAnswer> answersByCode3 = byQuestionCode(questionSetAnswer3.getQuestionAnswers());

                //load question for this level
                                    QuestionAnswer questionAC26Answer = answersByCode3.get(QuestionCode.AC26);
                                    QuestionAnswer questionAC27Answer = answersByCode3.get(QuestionCode.AC27);
                
                    //control them
                    if (                            questionAC26Answer == null  ||
                                                                                questionAC27Answer == null                                                 ) {
                       continue;
                    }
            ...
            baseActivityData.setKey(BaseActivityDataCode.AC_BAD1);
            ...
            baseActivityData.setActivitySource(toActivitySourceCode(questionAC26Answer));

            baseActivityData.setActivityOwnership(true);
            baseActivityData.setUnit(baseActivityDataUnit);
            baseActivityData.setValue(toDouble(questionAC27Answer, getUnitByCode(UnitCode.U5321)));
