...
public class BaseActivityDataAC_BAD9F extends ActivityResultContributor {
    ...
    public List<BaseActivityData> getBaseActivityData(Map<QuestionCode, List<QuestionSetAnswer>> questionSetAnswers) {
        ...
        //... and control
        if (
                    questionSetAnswersAC66 == null || questionSetAnswersAC66.size()==0         ) {
        return res;
        }

        //load question
                        QuestionAnswer questionAC69Answer = byQuestionCode(questionSetAnswersAC66.get(0).getQuestionAnswers()).get(QuestionCode.AC69);
        ...
        //2.1 loop for each answer for each loop for each parents of one or more question needed by the BAD
            ...
            baseActivityData.setValue(toDouble(questionAC83Answer, baseActivityDataUnit)/100*toDouble(questionAC80Answer));
