define ["../../module"], (directives) ->
  "use strict"
  directives.directive "mmAwacStringQuestion", (directiveService, translationService) ->
    restrict: "E"
    scope:  directiveService.autoScope
        ngDataToCompare: '='
    templateUrl: "assets/html/sources/app/eu/factorx/awac/angular/directives/awac/mmAwacStringQuestion/template.html"
    replace: true
    link: (scope) ->
