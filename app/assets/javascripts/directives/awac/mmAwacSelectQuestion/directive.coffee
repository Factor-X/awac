define ["../../module"], (directives) ->
  "use strict"
  directives.directive "mmAwacSelectQuestion", (directiveService, translationService) ->
    restrict: "E"
    scope:  directiveService.autoScope
        ngDataToCompare: '='
    templateUrl: "assets/html/sources/app/eu/factorx/awac/angular/directives/awac/mmAwacSelectQuestion/template.html"
    replace: true
    link: (scope) ->
