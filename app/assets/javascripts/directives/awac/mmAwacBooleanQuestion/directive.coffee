define ["../../module"], (directives) ->
  "use strict"
  directives.directive "mmAwacBooleanQuestion", (directiveService, translationService) ->
    restrict: "E"
    scope:  directiveService.autoScope
        ngDataToCompare: '='
    templateUrl: "assets/html/sources/app/eu/factorx/awac/angular/directives/awac/mmAwacBooleanQuestion/template.html"
