define ["../../module"], (directives) ->
  "use strict"
  directives.directive "mmAwacRealWithUnitQuestion", (directiveService, translationService) ->
    restrict: "E"
    scope:  directiveService.autoScope
        ngDataToCompare: '='
    templateUrl: "assets/html/sources/app/eu/factorx/awac/angular/directives/awac/mmAwacRealWithUnitQuestion/template.html"
    replace: true
    link: (scope) ->
