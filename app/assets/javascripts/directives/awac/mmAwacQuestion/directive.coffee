define ["../../module"], (directives) ->
  "use strict"
  directives.directive "mmAwacQuestion", (directiveService, translationService,$compile) ->
    restrict: "E"
    scope: directiveService.autoScope
        ngQuestionCode: '='
        ngCondition: '='
        ngRepetitionMap: '='
    templateUrl: "assets/html/sources/app/eu/factorx/awac/angular/directives/awac/mmAwacQuestion/template.html"
    replace: true
    compile: () ->
        post: (scope, element) ->
