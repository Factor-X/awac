...
define ["../../module"], (directives) ->
  "use strict"
  directives.directive "mmAwacModalLogin", (directiveService) ->
    restrict: "E"
    scope: {}
    templateUrl: "assets/html/sources/app/eu/factorx/awac/angular/directives/awac/mmAwacModalLogin/template.html"
