...
angular.module('app.directives').directive('mmSizeValidator', function(){
  ...
  */
  ...
  $scope.saveFormProgress = function() {
    var answer, answered, formProgress, formProgressDTO, founded, key, listTotal, percentage, promise, tabSet, total, _i, _j, _k, _l, _len, _len2, _len3, _len4, _len5, _m, _ref, _ref2, _ref3, _ref4, _ref5;
    percentage = 0;
    total = 0;
    answered = 0;
    listTotal = [];
    ...
    founded = false;
    _ref5 = $scope.$parent.formProgress;
    for (_m = 0, _len5 = _ref5.length; _m < _len5; _m++) {
      formProgress = _ref5[_m];
...
});angular.module('app.controllers').controller("SiteManagerCtrl", function($scope, translationService) {});angular.module('app.controllers').controller("UserDataCtrl", function($scope, downloadService, $http, translationService, messageFlash, modalService, $timeout) {
  $scope.isLoading = false;
