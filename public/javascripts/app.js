  ...
  */
  ...
  $scope.init = function(route) {
    ...
    */
    ...
    $scope.getAnswerToCompare = function(code, mapIteration, index) {
      var answer, i, _i, _len, _ref;
    ...
    $scope.getFirstRepeteableElement = function(questionSetCode) {
