  ...
  return {
    ...
    link: function(scope) {
      ...
      if (scope.ngCondition) {
        return console.log("ma condition est vrai !!");
      } else {
        return console.log("ma condition est fausse !!");
      }
    }
  };
