...
defaultResolve = {
  testConnection: function($http, $rootScope, $location, downloadService) {
    console.log("$rootScope.currentPerson");
    console.log($rootScope.currentPerson);
...
angular.module('app.directives').directive('mmPatternValidator', function(){
  ...
  */
  ...
  modalService.show(modalService.LOADING);
  console.log("oo");
  console.log($scope.formIdentifier);
  console.log($scope.$root.periodSelectedKey);
  console.log($scope.$root.scopeSelectedId);
  ...
  $scope.$watchCollection('[$root.periodSelectedKey,$root.scopeSelectedId]', function() {
    ...
    if (($scope.$root.periodSelectedKey != null) && ($scope.$root.scopeSelectedId != null)) {
      ...
      if ($route.current) {
        ...
        console.log("je uis une grosse put");
...
angular.module('app').run(function($rootScope, $location, downloadService, messageFlash, $timeout, translationService, tmhDynamicLocale, $routeParams) {
  ...
  $rootScope.testForm = function(period, scope) {
    ...
    console.log("TESTTTTT ->>>>>>>>>>>>>>>>>>>>>>>>>>>>>> " + period + " " + scope);
    ...
    if ($rootScope.mySites != null) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        site = _ref[_i];
        if (site.id = scope) {
          console.log("EJ TROUVE SITE !! ");
          console.log(site.listPeriodAvailable);
          _ref2 = site.listPeriodAvailable;
          for (_j = 0, _len2 = _ref2.length; _j < _len2; _j++) {
            periodToFind = _ref2[_j];
            console.log("?" + period + " " + periodToFind.key);
            if (period + "" === periodToFind.key + "") {
              console.log("JE REOUTR PARIDOE");
              return true;
            }
          }
        }
    ...
    console.log("test null je retour false");
    return false;
  };
  ...
  $rootScope.toDefaultForm = function() {
    if (($rootScope.scopeSelectedId != null) && ($rootScope.periodSelectedKey != null)) {
      console.log("je uis une grosse merde");
