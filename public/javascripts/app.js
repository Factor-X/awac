...
angular.module('app.directives').directive('mmSizeValidator', function(){
  ...
  */
  ...
  $scope.displayFormMenu = displayFormMenu;
  $scope.graphs = {};
  return downloadService.getJson("result/getReport/" + $scope.$parent.period + "/" + $scope.$parent.scopeId, function(data) {
