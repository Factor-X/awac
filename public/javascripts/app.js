...
<<<<<<< HEAD
});angular.module('app.directives').directive("mmAwacRegistrationVerification", function(directiveService, downloadService, messageFlash, translationService) {
  return {
    restrict: "E",
    scope: {},
    templateUrl: "$/angular/templates/mm-awac-registration-verification.html",
    replace: true,
    controller: function($scope) {
      $scope.validatePasswordConfirmField = function() {
