    ...
    link: function(scope) {
      ...
      scope.$watch('ngCondition', function() {
        if (scope.getCondition() === false) {
          ...
          if (scope.$parent.getUnitCategories(scope.getQuestionCode()).mainUnitId !== void 0) {
