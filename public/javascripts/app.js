  ...
  return {
    ...
    controller: function($scope, modalService) {
      ...
      $scope.getIndicatorOptions = function() {
        var indicatorAssociations, indicatorOptions, selectedIndicatorsKeys;
      ...
      $scope.allFieldValid = function() {
        return $scope.title.isValid && $scope.physicalMeasure.isValid && $scope.webSite.isValid && $scope.responsiblePerson.isValid && $scope.comment.isValid && (($scope.typeKey.field === "2") || ($scope.indicatorAssociations.length > 0));
      };
      $scope.save = function() {
        var data;
        $scope.isLoading = true;
