...
});angular.module('app.controllers').controller("ActionsCtrl", function($scope, displayFormMenu, modalService, downloadService, $filter) {
  $scope.displayFormMenu = displayFormMenu;
  $scope.actions = [];
  $scope.typeOptions = [];
  $scope.statusOptions = [];
