...
angular.module('app.directives', ['ngAnimate', 'ngSanitize', 'ui.bootstrap', 'ui.bootstrap.datetimepicker', 'ngCkeditor']);
...
angular.module('app').config(function($httpProvider) {
  ...
  this.getLabelByKey = function(codeLabelsList, codeKey) {
    return _.findWhere(codeLabelsList, {
      key: codeKey
    }).label;
  };
  return;
...
angular.module('app.directives').directive('mmSizeValidator', function(){
  ...
  return {
    ...
    controller: function($scope, modalService) {
      ...
      $scope.refreshBaseIndicatorOptions = function() {
        var baseIndicatorAssociations, baseIndicatorOptions, selectedIndicatorsKeys;
        ...
        if (baseIndicatorAssociations.length > 0) {
          ...
          baseIndicatorOptions = _.reject(baseIndicatorOptions, function(codeLabel) {
            return _.contains(selectedIndicatorsKeys, codeLabel.key);
          });
        }
        baseIndicatorOptions = _.sortBy(baseIndicatorOptions, function(codeLabel) {
...
});angular.module('app.controllers').controller("AdminFactorsManagerCtrl", function($scope, $filter, $q, displayLittleFormMenu, downloadService, modalService, messageFlash, translationService, ngTableParams, $filter, $compile) {
  $scope.displayLittleFormMenu = displayLittleFormMenu;
  $scope.factors = null;
  modalService.show(modalService.LOADING);
  ...
  $scope.remove = function(factor) {};
  return $scope.names = function(column) {
    var def;
    def = $q.defer();
...
});angular.module('app.controllers').controller("AdminTranslationCtrl", function($scope, displayLittleFormMenu, downloadService, modalService, messageFlash, translationService, ngTableParams, $filter, $compile) {
