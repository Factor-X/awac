...
angular.module('app.directives').directive('mmPatternValidator', function(){
    ...
    compile: function() {
      return {
        ...
        post: function(scope, element) {
          ...
          return scope.copyDataToCompare = function() {
  ...
  */
  ...
  return $scope.saveFormProgress = function() {
    var answer, answered, formProgressDTO, listTotal, percentage, promise, total, _i, _len, _ref;
    percentage = 0;
    total = 0;
    answered = 0;
    listTotal = [];
    ...
    return promise.success(function(data, status, headers, config) {
      var formProgress, founded, _i, _len, _ref;
      founded = false;
      _ref = $scope.$parent.formProgress;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
