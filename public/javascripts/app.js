...
});angular.module('app.directives').directive("mmAwacSection", function(directiveService, downloadService, messageFlash, modalService) {
  return {
    restrict: "E",
    scope: directiveService.autoScope({
      ngTitleCode: '=',
    ...
    link: function(scope) {
      ...
      scope.verification = function(valid) {
        ...
        if (valid) {
          return downloadService.postJson('/awac/verification/verify', data, function(result) {
            if (result.success) {
              return scope.$parent.verifyQuestionSet(scope.getTitleCode(), result.data);
            } else {
              return messageFlash.displayError(scope.getTitleCode(), result.data.message);
            }
          });
        } else {
      ...
      scope.getVerificationClass = function(valid) {
        if (valid) {
      ...
      return scope.getVerifierName = function() {
        if (scope.$parent.getQuestionSetVerification(scope.getTitleCode()) != null) {
...
<<<<<<< HEAD
});angular.module('app.directives').directive("mmAwacModalCreateReductionAction", function(directiveService, downloadService, translationService, messageFlash) {
  return {
    restrict: "E",
    scope: directiveService.autoScope({
      ngParams: '='
...
});angular.module('app.directives').directive("mmAwacModalEditOrCreateReductionAction", function(directiveService, downloadService, translationService, messageFlash) {
  return {
    restrict: "E",
    scope: directiveService.autoScope({
      ngParams: '='
      ...
      if (result.success) {
        ...
        */
        ...
        if (result.data.__type === 'eu.factorx.awac.dto.myrmex.get.MustChangePasswordExceptionsDTO') {
          ...
          return messageFlash.displayError(translateWithVars(result.data.code, result.data.parameters));
        } else {
          return messageFlash.displayError(result.data.message);
        }
      }
...
=======
  ...
  return $scope.$watch('selectedPeriodForEvent', function() {
    return downloadService.getJson('awac/organization/events/byPeriod/' + $scope.selectedPeriodForEvent, function(result) {
      if (result.success) {
...
<<<<<<< HEAD
  ...
  return $scope.displayLittleFormMenu = displayLittleFormMenu;
});angular.module('app.controllers').controller("ActionsCtrl", function($scope, displayFormMenu, modalService) {
  $scope.displayFormMenu = displayFormMenu;
  $scope.pouet = true;
  $scope.actions = [
    {
  ...
  return $scope.create = function() {
    return modalService.show(modalService.CREATE_REDUCTION_ACTION);
  };
  ...
  $scope.isLoading = function() {
    ...
    for (k in $scope.initialLoad) {
      if (!$scope.initialLoad[k]) {
        return true;
=======
});angular.module('app.controllers').controller("FormCtrl", function($scope, downloadService, messageFlash, translationService, modalService, $route, $timeout) {
...
=======
  ...
  return $scope.create = function() {
    return modalService.show(modalService.EDIT_OR_CREATE_REDUCTION_ACTION);
  };
});angular.module('app').run(function(loggerService) {
  var log;
  loggerService.initialize();
...
angular.module('app').run(function($rootScope, $location, downloadService, messageFlash, $timeout, translationService, tmhDynamicLocale, $routeParams, $route, modalService) {
  ...
  downloadService.getJson('/awac/verification/myVerificationRequests', function(result) {
    ...
    if (!result.success) {
      modalService.close(modalService.LOADING);
      return messageFlash.displaySuccess(translationService.get(result.data));
    } else {
      modalService.close(modalService.LOADING);
  ...
  $scope.selectRequest = function(request) {
    ...
    $scope.displayMenu = true;
    return $('.injectFormMenu:first').append($scope.directiveMenu);
  };
  ...
  modalService.show(modalService.LOADING);
  downloadService.getJson("/awac/verification/requests", function(result) {
    if (!result.success) {
      messageFlash.displayError(result.data.message);
      return modalService.close(modalService.LOADING);
    } else {
  ...
  return downloadService.getJson('awac/organization/getMyOrganization', function(result) {
    if (!result.success) {
      ...
      $scope.organization = result.data;
      $scope.events = [];
      downloadService.getJson('awac/organization/events/byPeriod/' + $scope.$root.periods[0], function(result) {
        return $scope.events = result.data.organizationEventList;
      });
