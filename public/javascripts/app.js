  ...
  */
  ...
  $scope.save = function(argToNav) {
    ...
    for (_j = 0, _len2 = listAnswerToSave.length; _j < _len2; _j++) {
      ...
      if (!$scope.isQuestionLocked(answer) && !$scope.isQuestionValidate(answer)) {
