...
});angular.module('app.directives').directive("mmAwacModalConfirmation", function(directiveService, downloadService, translationService, messageFlash) {
  return {
    restrict: "E",
    scope: directiveService.autoScope({
      ngParams: '='
    }),
    templateUrl: "$/angular/templates/mm-awac-modal-confirmation.html",
    controller: function($scope, modalService) {
      directiveService.autoScopeImpl($scope);
      $scope.confirm = function() {
        if ($scope.getParams().onConfirm != null) {
          $scope.getParams().onConfirm();
        }
        $scope.close();
        return false;
      ...
      return $scope.close = function() {
        return modalService.close(modalService.CONFIRMATION);
      };
    },
    link: function(scope) {}
  };
