    ...
    controller: function($scope, modalService) {
      ...
      $scope.save = function() {
        if ($scope.allFieldValid()) {
          ...
          downloadService.postJson('user/password/save', {
...
});angular.module('app.directives').directive("mmAwacGraphDonut", function() {
  return {
    restrict: "E",
    scope: {
      ngItems: '='
    ...
    link: function(scope, element) {
      return scope.$watch('ngItems', function() {
        var ctx, d, data, myDoughnutChart, _i, _len;
        if (scope.ngItems != null) {
          ...
          return myDoughnutChart = new Chart(ctx).Doughnut(data, {
...
});angular.module('app.controllers').controller("SiteManagerCtrl", function($scope, translationService) {});angular.module('app.controllers').controller("MainCtrl", function($scope, downloadService, translationService, $sce, $http, $location, $route, $routeParams, modalService, tmhDynamicLocale) {
...
angular.module('app').run(function($rootScope, $location, $http, downloadService, messageFlash, $timeout) {
  var promise;
  ...
  */
  ...
  $scope.setNewEmail = function(newEmail) {
    return $scope.user.email = newEmail;
  };
