...
angular.module('app').run(function($rootScope, $location, $http, flash) {
  ...
  return $rootScope.displayModalBackground = false;
});angular.module('app.controllers').controller("UserDataCtrl", function($scope) {});angular.module('app.controllers').controller("FormCtrl", function($scope, downloadService, $http, messageFlash, modalService, formIdentifier, $timeout, displayFormMenu) {
