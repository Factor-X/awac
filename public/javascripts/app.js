...
angular.module('app.controllers').controller("MainCtrl", function($scope, downloadService, translationService, $sce, $location, $route, $routeParams, modalService, $timeout) {
  ...
  $scope.computeDisplayMenu = function() {
    ...
    } else if (($scope.getMainScope() != null) && ($scope.getMainScope().displayLittleFormMenu != null) && $scope.getMainScope().displayLittleFormMenu === true) {
  ...
  $scope.$watch('$root.periodSelectedKey', function() {
    var k, p, v;
  ...
  $scope.$watch('$root.scopeSelectedId', function() {
    var k, p, v;
  ...
  $scope.loadPeriodForComparison = function() {
    var url;
    if (($scope.$root.periodToCompare != null) && !isNaN($scope.$root.periodToCompare)) {
      ...
      return downloadService.getJson(url, function(result) {
        ...
        if (result.success) {
          ...
          return messageFlash.displayError(data.message);
        }
      });
    }
  };
...
angular.module('app').run(function($rootScope, $location, downloadService, messageFlash, $timeout, translationService, tmhDynamicLocale, $routeParams) {
  ...
  $rootScope.computePeriod = function(scopeId) {
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      site = _ref[_i];
      _results.push(site.scope === scopeId ? ($rootScope.availablePeriods = site.listPeriodAvailable, console.log("$rootScope.availablePeriods"), console.log($rootScope.availablePeriods)) : void 0);
    }
    return _results;
  };
  ...
  */
  ...
  $scope.getAnswerOrCreate = function(code, mapIteration, tabSet, tab) {
    var answerLine, defaultUnitCode, question, result, value, wasEdited, _ref;
    if (tabSet == null) {
      tabSet = null;
    }
    if (tab == null) {
    ...
    if (result) {
      ...
      answerLine = {
        ...
        'lastUpdateUser': (_ref = $scope.$root.currentPerson) != null ? _ref.identifier : void 0,
        'wasEdited': wasEdited
      };
      if (tabSet != null) {
