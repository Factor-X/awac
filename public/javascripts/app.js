...
angular.module('app').run(function($rootScope, $location, $http) {
  ...
  $rootScope.loginSuccess = function(data) {
    ...
    return $location.path('/form2/' + data.defaultPeriod + '/' + data.organization.sites[0].scope);
  };
