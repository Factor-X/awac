...
angular.module('app.directives').directive('mmSizeValidator', function(){
...
});angular.module('app.directives').directive("mmAwacRepetitionQuestionDisable", function(directiveService, translationService) {
  return {
    restrict: "E",
    scope: directiveService.autoScope({
      ngQuestionCode: '=',
  ...
  return {
    ...
    link: function(scope, element) {
      ...
      return scope.getStatusClass = function() {
        var answer;
  ...
  return console.log(new Date().getTimezoneOffset());
});
