...
angular.module('app.controllers').config(function($routeProvider) {
  ...
  return;
});angular.module('app.filters').filter("numberToI18N", function($sce, translationService) {
