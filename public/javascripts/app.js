      ...
      scope.getTemplate = function() {
        ...
        if (scope.$parent.getQuestion(scope.getQuestionCode()) !== null) {
          ...
          if (answerType === 'BOOLEAN') {
            ...
            if (scope.$parent.getQuestion(scope.getQuestionCode())) {
