...
angular.module('app.controllers', ['app.services', 'ngRoute', 'angular-flash.service', 'angular-flash.flash-alert-directive', 'angularFileUpload', 'tmh.dynamicLocale', 'ngTable']);
          ...
          if (!result.success) {
            ...
            scope.tableParams = new ngTableParams({
              ...
              getData: function($defer, params) {
                ...
                return params.total(result.data.logLines.length);
              }
            });
            return modalService.close(modalService.LOADING);
          }
...
angular.module('app').run(function($rootScope, $location, downloadService, messageFlash, $timeout, translationService, tmhDynamicLocale, $routeParams) {
  ...
  $rootScope.$on('$routeChangeStart', function(event, current) {
    ...
    if (!$rootScope.currentPerson && !current.$$route.anonymousAllowed) {
