...
angular.module('app.controllers').config(function($routeProvider) {
  ...
  this.show = function(modalName, params) {
    ...
    return $rootScope.$broadcast(target, arg);
  };
  this.hide = function(modalName) {
    var arg;
    arg = {};
    arg.show = false;
    return $rootScope.$broadcast('SHOW_MODAL_' + modalName, arg);
  };
  return;
...
angular.module('app.directives').directive('mmNotNullValidator', function(){
  ...
  return {
    ...
    controller: function($scope, downloadService, translationService, $sce, $modal, $http) {
      ...
      show = true;
      return $scope.$on('SHOW_MODAL_' + modalName, function(event, args) {
  ...
  */
  ...
  $scope.nav = function(loc) {
    if (loc.indexOf("/form") > -1) {
      return modalService.show("CONFIRMATION_EXIT_FORM", loc);
    } else {
