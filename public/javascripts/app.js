...
initializeEnterpriseRoutes = function() {
  angular.module('app').run(function($rootScope, $location) {
    return $rootScope.onLoginSuccess = function(data) {
      return $location.path('/enterprise-form2/' + data.defaultPeriod + '/' + data.organization.sites[0].scope);
    };
  });
  return angular.module('app').config(function($routeProvider) {
    $routeProvider.when('/enterprise-form2/:period/:scope', {
...
initializeMunicipalityRoutes = function() {
  angular.module('app').run(function($rootScope, $location) {
    return $rootScope.onLoginSuccess = function(data) {
      return $location.path('/municipality-form1/' + data.defaultPeriod + '/' + data.organization.sites[0].scope);
    };
  });
  return angular.module('app').config(function($routeProvider) {
    $routeProvider.when('/municipality-form1/:period/:scope', {
