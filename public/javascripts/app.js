...
});angular.module('app.directives').directive("mmAwacAdminSurvey", function(directiveService, $timeout, ngTableParams, $http, $filter, downloadService, messageFlash, modalService) {
  return {
    restrict: "E",
    scope: {},
