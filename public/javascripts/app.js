...
angular.module('app').run(function($rootScope, $location, $http, flash) {
  ...
  $rootScope.loginSuccess = function(data) {
    ...
    if ($rootScope.referrer) {
      return $location.path($rootScope.referrer);
    } else {
