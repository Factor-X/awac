...
angular.module('app').run(function($rootScope, $location, downloadService, messageFlash, $timeout, translationService, tmhDynamicLocale) {
...
});angular.module('app.controllers').controller("SiteManagerCtrl", function($scope, translationService, modalService) {
  ...
  return $scope.editOrCreateSite = function(site) {
    var params;
    params = {};
    if (site != null) {
      params.site = site;
