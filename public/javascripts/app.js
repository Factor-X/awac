...
angular.module('app.directives').directive('mmSizeValidator', function(){
...
});angular.module('app.directives').directive("mmAwacModalEmailChange", function(directiveService, translationService, messageFlash) {
  return {
    restrict: "E",
    scope: directiveService.autoScope({
      ngParams: '='
...
});angular.module('app.directives').directive("mmAwacModalPasswordChange", function(directiveService, translationService, messageFlash) {
  return {
    restrict: "E",
    scope: directiveService.autoScope({
      ngParams: '='
...
});angular.module('app.controllers').controller("LoginCtrl", function($scope, downloadService, $location, messageFlash) {
  $scope.loginInfo = {
  ...
  return $scope.sendForgotPassword = function() {
    $scope.isLoading = true;
...
angular.module('app').run(function($rootScope, $location, downloadService, messageFlash, $timeout) {
  ...
  downloadService.postJson('/awac/testAuthentication', null, function(result) {
    if (result.success) {
      return $rootScope.loginSuccess(data);
    } else {
      ;
    }
  });
