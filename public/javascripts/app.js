...
angular.module('app.directives').directive('mmPatternValidator', function(){
  ...
  return {
    ...
    link: function(scope, element) {
      ...
      return scope.getLeftTotalOutOfScope = function() {
        var rl, total, _i, _len, _ref;
        if (!scope.ngModel) {
          return void 0;
        }
  ...
  return {
    ...
    link: function(scope) {
      ...
      scope.lock = function() {
        var data;
        if ((!scope.isLocked() || scope.isLockedByMyself() || scope.$root.currentPerson.isAdmin) && !scope.isValidate()) {
          data = {};
