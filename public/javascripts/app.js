...
=======
      $scope.passwordInfo = {
        ...
        validationMessage: "PASSWORD_VALIDATION_WRONG_LENGTH",
        field: "",
>>>>>>> f3ec89485f332c5c2828561823d36154c5e298b1
        hideIsValidIcon: true,
        focus: function() {
          return true;
        }
...
<<<<<<< HEAD
      $scope.typeKey = {
        inputName: 'typeKey',
        field: (_ref = $scope.action.typeKey) != null ? _ref : "1",
        fieldTitle: "REDUCTION_ACTION_TYPE_FIELD_TITLE"
      };
      $scope.statusKey = {
        inputName: 'statusKey',
        field: (_ref2 = $scope.action.statusKey) != null ? _ref2 : "1",
        fieldTitle: "REDUCTION_ACTION_STATUS_FIELD_TITLE"
      };
      $scope.scopeTypeKey = {
        inputName: 'scopeTypeKey',
        field: (_ref3 = $scope.action.scopeTypeKey) != null ? _ref3 : "1",
      ...
      $scope.ghgBenefitUnitKey = (_ref4 = $scope.action.ghgBenefitUnitKey) != null ? _ref4 : "U5335";
      ...
      $scope.dueDate = {
        inputName: 'dueDate',
        field: (_ref5 = $scope.action.dueDate) != null ? _ref5 : $scope.getDefaultDueDate(),
...
>>>>>>> f3ec89485f332c5c2828561823d36154c5e298b1
...
});angular.module('app.directives').directive("mmAwacModalCreateReductionAction", function(directiveService, downloadService, translationService, messageFlash, $filter) {
  return {
    restrict: "E",
    scope: directiveService.autoScope({
      ngParams: '='
  ...
  $scope.markAsDone = function(action) {
    $scope.isLoading = true;
    action.statusKey = "2";
    action.completionDate = new Date();
    return downloadService.postJson('/awac/actions/save', action, function(result) {
      $scope.isLoading = false;
      if (result.success) {
  ...
  $scope.getScopeName = function(scopeTypeKey, scopeId) {
    if (scopeTypeKey === "1") {
      ...
      return _.findWhere($scope.$root.mySites, {
        id: scopeId
      }).name;
    }
  };
...
>>>>>>> f3ec89485f332c5c2828561823d36154c5e298b1
  ...
  $scope.consultEvent = function() {
    ...
    return modalService.show(modalService.CONSULT_EVENT);
  };
