...
angular.module('app.directives').directive('mmPatternValidator', function(){
    ...
    compile: function() {
      return {
        pre: function(scope, element) {
          return element.attr('ng-repetition-map', 'itLevel');
        },
        post: function(scope, element) {
          ...
          scope.getAnswerToCompare = function() {
          ...
          scope.getAnswer = function(forDataToCompare) {
            ...
            if (scope.getQuestionCode() === 'A16') {
              console.log("je suis A16 et ma repetition map : ");
              console.log(scope.getRepetitionMap());
            }
            if (forDataToCompare) {
              return scope.$parent.getAnswerToCompare(scope.getQuestionCode(), scope.getRepetitionMap());
            } else {
          ...
          scope.getStatusClass = function() {
            ...
            if (answer.value !== null && (answer.$valid === null || answer.value.$valid === void 0 || answer.value.$valid === true)) {
          ...
          scope.copyDataToCompare = function() {
            if (scope.getAnswerToCompare() !== null) {
              scope.getAnswer().value = scope.getAnswerToCompare().value;
              return scope.getAnswer().wasEdited = true;
            }
          };
          return scope.logQuestionCode = function() {
            return console.log(scope.getQuestionCode());
          };
        }
      };
    }
  ...
  */
  ...
  downloadService.getJson("answer/getByForm/" + $scope.formIdentifier + "/" + $scope.$parent.period + "/" + $scope.$parent.scopeId, function(data) {
    ...
    $scope.storeAnswers = function() {
      var answerSave, qSet, _i, _len, _ref, _results;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        qSet = _ref[_i];
        _results.push($scope.loopRepetition(qSet));
      }
      return _results;
    };
  ...
  $scope.$on('SAVE', function() {
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      answer = _ref[_i];
      if (answer.value !== null && answer !== void 0) {
...
});angular.module('app.controllers').controller("FormCtrl", function($scope, downloadService, $http, messageFlash, modalService, formIdentifier, $timeout) {
  ...
  */
  ...
  $scope.save = function(argToNav) {
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      answer = _ref[_i];
      if (answer.wasEdited !== void 0 && answer.wasEdited === true) {
        if (answer.value === null || answer.value.$valid === null || answer.value.$valid === void 0 || answer.value.$valid === true) {
  ...
  */
  ...
  $scope.loadFormProgress = function() {
    var promise;
    if ($scope.scopeId !== void 0 && $scope.scopeId !== null && $scope.period !== null && $scope.period !== void 0) {
      promise = $http({
        method: "GET",
  ...
  return $scope.$on("REFRESH_LAST_SAVE_TIME", function(event, args) {
...
});angular.module('app.controllers').controller("UserDataCtrl", function($scope) {});angular.module('app.controllers').controller("Form6Ctrl", function($scope, downloadService, $http) {
...
});angular.module('app.controllers').controller("SiteManagerCtrl", function($scope, translationService) {});angular.module('app.controllers').controller("Form2Ctrl", function($scope, downloadService, $http) {
