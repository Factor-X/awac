...
angular.module('app').run(function($rootScope, $location, downloadService, messageFlash, $timeout, translationService, tmhDynamicLocale, $routeParams, $route, modalService) {
  ...
  $rootScope.logout = function() {
    console.log('logout !! ');
    $location.path('/login');
    return $timeout($rootScope.currentPerson = null, $rootScope.periodSelectedKey = null, $rootScope.scopeSelectedId = null, $rootScope.mySites = null, $rootScope.currentPerson = null, $rootScope.organizationName = null, downloadService.postJson('/awac/logout', null, function(result) {}), 1);
  };
  ...
  $rootScope.nav = function(loc, confirmed) {
    var canBeContinue, params, result, route, routeWithScopeAndPeriod, _base, _i, _len, _ref, _ref2;
    if (confirmed == null) {
      confirmed = false;
    }
    console.log("NAV : " + loc);
    ...
    if (canBeContinue) {
      console.log("TEST UNLOCKABLE : " + (((_ref = $rootScope.getMainScope()) != null ? _ref.formIdentifier : void 0) != null) + "/" + ($rootScope.currentPerson != null));
      if ((((_ref2 = $rootScope.getMainScope()) != null ? _ref2.formIdentifier : void 0) != null) && ($rootScope.currentPerson != null)) {
