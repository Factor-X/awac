...
=======
  ...
  return;
>>>>>>> 14ad8d185a35d28b6ad4443c6ccb338f019eb7c4
...
<<<<<<< HEAD
  ...
  return $scope.downloadAsXls = function() {
...
=======
  return $rootScope.refreshNotifications();
});angular.module('app.controllers').controller("ResultsCtrl", function($scope, downloadService, displayFormMenu) {
  $scope.displayFormMenu = displayFormMenu;
  $scope.graphs = {};
  return downloadService.getJson("/awac/result/getReport/" + $scope.$parent.periodKey + "/" + $scope.$parent.scopeId, function(result) {
    var data, rl, totalOutOfScope, totalScope1, totalScope2, totalScope3, _i, _j, _k, _l, _len, _len2, _len3, _len4, _len5, _m, _ref, _ref2, _ref3, _ref4, _ref5;
    if (result.success) {
      $scope.o = result.data;
      totalOutOfScope = 0;
