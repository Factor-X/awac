...
=======
  ...
  return;
>>>>>>> 92dba7e668062dcfe03959ecd0af5fca8ce3c3c5
...
});angular.module('app.controllers').controller("SiteManagerCtrl", function($scope, translationService) {});angular.module('app.controllers').controller("MainCtrl", function($scope, downloadService, translationService, $sce, $location, $route, $routeParams, modalService, tmhDynamicLocale) {
...
angular.module('app').run(function($rootScope, $location, downloadService, messageFlash, $timeout) {
  if (!$rootScope.currentPerson) {
    $location.path('/login');
  }
  $rootScope.isLogin = function() {
...
});angular.module('app.controllers').controller("UserManagerCtrl", function($scope, translationService, modalService, downloadService) {
  $scope.title = translationService.get('USER_MANAGER_TITLE');
  $scope.isLoading = {};
  $scope.isLoading['admin'] = {};
  $scope.isLoading['isActive'] = {};
...
});angular.module('app.controllers').controller("LoginCtrl", function($scope, downloadService, $location, messageFlash, $compile, $timeout, modalService) {
  $scope.loading = false;
  $scope.loginInfo = {
    fieldTitle: "LOGIN_FORM_LOGIN_FIELD_TITLE",
    fieldType: "text",
