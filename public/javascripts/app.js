...
});angular.module('app.controllers').controller("UserDataCtrl", function($scope) {});angular.module('app.controllers').controller("ResultsCtrl", function($scope, downloadService, $http) {
