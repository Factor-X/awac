...
>>>>>>> c2c3ab7c88669af9ade66cfe69ad16d6b9376d3f
      ...
      return $scope.registration = function() {
        ...
        downloadService.postJson('/enterprise/registration', data, function(result) {
          if (result.success) {
            ...
            return messageFlash.displaySuccess("You are now connected");
          } else {
...
});angular.module('app.controllers').controller("LoginCtrl", function($scope, downloadService, $location, messageFlash, $compile, $timeout) {
  $scope.loginInfo = {
