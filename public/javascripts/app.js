...
});angular.module('app.controllers').controller("ActionsCtrl", function($scope, displayFormMenu, modalService, downloadService, $filter, messageFlash, translationService) {
