...
angular.module('app.controllers').config(function($routeProvider) {
  ...
  return;
});angular.module('app.services').service("regexService", function() {
  this.USER_IDENTIFIER = /^\S{5,20\}$/;
  this.USER_PASSWORD = /^\S{5,20}$/;
  this.USER_LAST_NAME = /^.{1,255}$/;
  this.USER_FIRST_NAME = /^.{1,255}$/;
  this.USER_EMAIL = /(?:[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*|"(?:[\x01-\x08\x0b\x0c\x0e-\x1f\x21\x23-\x5b\x5d-\x7f]|\\[\x01-\x09\x0b\x0c\x0e-\x7f])*")@(?:(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?|\[(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?|[a-z0-9-]*[a-z0-9]:(?:[\x01-\x08\x0b\x0c\x0e-\x1f\x21-\x5a\x53-\x7f]|\\[\x01-\x09\x0b\x0c\x0e-\x7f])+)\])/;
  return this.applyRegExp(function(text, regexp) {
...
});angular.module('app.filters').filter("matchRegexp", function() {
  this.USER_IDENTIFIER = /^\S{5,20}$/g;
  this.USER_PASSWORD = /^\S{5,20}$/g;
  this.USER_LAST_NAME = /^.{1,255}$/g;
  this.USER_FIRST_NAME = /^.{1,255}$/g;
  return function(input, regexp) {
