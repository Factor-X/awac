...
angular.module('app.directives').directive('mmSizeValidator', function(){
  ...
  return {
    ...
    link: function(scope) {
      ...
      return scope.getUnitsByQuestionCode = function(code) {
        var q, uc, unitCategoryId, _i, _j, _len, _len2, _ref, _ref2;
        if (scope.ngObject) {
          unitCategoryId = null;
          _ref = scope.ngObject.questions;
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            q = _ref[_i];
          ...
          _ref2 = scope.ngObject.unitCategories;
  ...
  return {
    ...
    link: function(scope) {
      ...
      return scope.getOptionsByQuestionCode = function(code) {
        ...
        if (scope.ngObject) {
          ...
          _ref2 = scope.ngObject.codeLists;
          for (_j = 0, _len2 = _ref2.length; _j < _len2; _j++) {
            cl = _ref2[_j];
  ...
  downloadService.getJson("answer/getByForm/" + $scope.formIdentifier + "/" + $scope.$parent.period + "/" + $scope.$parent.scopeId, function(data) {
    ...
    $scope.storeAnswers = function() {
      ...
      console.log($scope.answerList);
      return $scope.answerList[0] = {
        'questionKey': 'A2',
        'value': 34
      };
    };
    return $scope.storeAnswers();
  });
  /*
  ...
  */
  ...
  $scope.getQuestion = function(code) {
