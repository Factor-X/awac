...
});angular.module('app.directives').directive("mmAwacDocumentQuestion", function(directiveService, translationService, $upload) {
  return {
    restrict: "E",
    scope: directiveService.autoScope({
      ngQuestionCode: '=',
